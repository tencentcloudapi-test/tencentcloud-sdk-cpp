...
#ifndef TENCENTCLOUD_CDC_V20201214_MODEL_DESCRIBESITESDETAILREQUEST_H_
#define TENCENTCLOUD_CDC_V20201214_MODEL_DESCRIBESITESDETAILREQUEST_H_
    ...
    namespace Cdc
    {
        namespace V20201214
        {
            namespace Model
            {
                ...
                */
                class DescribeSitesDetailRequest : public AbstractModel
                {
                public:
                    DescribeSitesDetailRequest();
                    ~DescribeSitesDetailRequest() = default;
...
#endif // !TENCENTCLOUD_CDC_V20201214_MODEL_DESCRIBESITESDETAILREQUEST_H_
