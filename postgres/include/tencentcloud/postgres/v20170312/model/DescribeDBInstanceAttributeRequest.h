...
#ifndef TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEDBINSTANCEATTRIBUTEREQUEST_H_
#define TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEDBINSTANCEATTRIBUTEREQUEST_H_
    ...
    namespace Postgres
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeDBInstanceAttributeRequest : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEDBINSTANCEATTRIBUTEREQUEST_H_
