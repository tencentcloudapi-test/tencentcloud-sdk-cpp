...
#ifndef TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEPARAMSEVENTREQUEST_H_
#define TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEPARAMSEVENTREQUEST_H_
    ...
    namespace Postgres
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeParamsEventRequest : public AbstractModel
                {
                public:
                    DescribeParamsEventRequest();
                    ~DescribeParamsEventRequest() = default;
...
#endif // !TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEPARAMSEVENTREQUEST_H_
