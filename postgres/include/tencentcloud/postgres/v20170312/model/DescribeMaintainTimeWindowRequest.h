...
#ifndef TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEMAINTAINTIMEWINDOWREQUEST_H_
#define TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEMAINTAINTIMEWINDOWREQUEST_H_
    ...
    namespace Postgres
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeMaintainTimeWindowRequest : public AbstractModel
                {
                public:
                    DescribeMaintainTimeWindowRequest();
                    ~DescribeMaintainTimeWindowRequest() = default;
...
#endif // !TENCENTCLOUD_POSTGRES_V20170312_MODEL_DESCRIBEMAINTAINTIMEWINDOWREQUEST_H_
