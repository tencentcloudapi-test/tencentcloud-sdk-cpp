...
#ifndef TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTMODIFYNAMEFRONT_H_
#define TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTMODIFYNAMEFRONT_H_
    ...
    namespace Rce
    {
        namespace V20201103
        {
            namespace Model
            {
                ...
                * 修改黑白名单出参
                */
                class OutputModifyNameFront : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTMODIFYNAMEFRONT_H_
