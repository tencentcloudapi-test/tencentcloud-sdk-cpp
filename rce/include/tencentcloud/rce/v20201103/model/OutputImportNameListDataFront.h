...
#ifndef TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTIMPORTNAMELISTDATAFRONT_H_
#define TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTIMPORTNAMELISTDATAFRONT_H_
    ...
    namespace Rce
    {
        namespace V20201103
        {
            namespace Model
            {
                ...
                * 添加黑白名单数据出参
                */
                class OutputImportNameListDataFront : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTIMPORTNAMELISTDATAFRONT_H_
