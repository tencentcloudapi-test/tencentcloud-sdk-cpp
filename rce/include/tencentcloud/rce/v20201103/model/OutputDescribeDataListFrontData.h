...
#ifndef TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTDESCRIBEDATALISTFRONTDATA_H_
#define TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTDESCRIBEDATALISTFRONTDATA_H_
...
namespace TencentCloud
{
    namespace Rce
    {
        namespace V20201103
        {
            namespace Model
            {
                class OuntputDescribeDataListInfo;

                /**
                * 查询黑白名单数据出参
                */
                class OutputDescribeDataListFrontData : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTDESCRIBEDATALISTFRONTDATA_H_
