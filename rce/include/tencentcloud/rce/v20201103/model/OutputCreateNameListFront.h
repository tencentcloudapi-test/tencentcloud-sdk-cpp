...
#ifndef TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTCREATENAMELISTFRONT_H_
#define TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTCREATENAMELISTFRONT_H_
    ...
    namespace Rce
    {
        namespace V20201103
        {
            namespace Model
            {
                ...
                * 创建黑白名单出参
                */
                class OutputCreateNameListFront : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_RCE_V20201103_MODEL_OUTPUTCREATENAMELISTFRONT_H_
