...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_USERKAFKAMETA_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_USERKAFKAMETA_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                * 用户kafka扩展信息
                */
                class UserKafkaMeta : public AbstractModel
                {
                public:
                    UserKafkaMeta();
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_USERKAFKAMETA_H_
