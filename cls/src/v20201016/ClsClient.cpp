...
void ClsClient::CreateDlcDeliverAsync(const CreateDlcDeliverRequest& request, const CreateDlcDeliverAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->CreateDlcDeliver(request), context);
    };
...
{
    auto task = std::make_shared<std::packaged_task<CreateDlcDeliverOutcome()>>(
        [this, request]()
        {
            return this->CreateDlcDeliver(request);
        }
    );
...
void ClsClient::DeleteDlcDeliverAsync(const DeleteDlcDeliverRequest& request, const DeleteDlcDeliverAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->DeleteDlcDeliver(request), context);
    };
...
{
    auto task = std::make_shared<std::packaged_task<DeleteDlcDeliverOutcome()>>(
        [this, request]()
        {
            return this->DeleteDlcDeliver(request);
        }
    );
...
void ClsClient::DescribeDlcDeliversAsync(const DescribeDlcDeliversRequest& request, const DescribeDlcDeliversAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->DescribeDlcDelivers(request), context);
    };
...
{
    auto task = std::make_shared<std::packaged_task<DescribeDlcDeliversOutcome()>>(
        [this, request]()
        {
            return this->DescribeDlcDelivers(request);
        }
    );
...
void ClsClient::ModifyDlcDeliverAsync(const ModifyDlcDeliverRequest& request, const ModifyDlcDeliverAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    auto fn = [this, request, handler, context]()
    {
        handler(this, request, this->ModifyDlcDeliver(request), context);
    };
...
{
    auto task = std::make_shared<std::packaged_task<ModifyDlcDeliverOutcome()>>(
        [this, request]()
        {
            return this->ModifyDlcDeliver(request);
        }
    );
