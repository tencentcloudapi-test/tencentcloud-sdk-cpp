...
#ifndef TENCENTCLOUD_SMH_V20210712_MODEL_CREATEUSERLIFECYCLERESPONSE_H_
#define TENCENTCLOUD_SMH_V20210712_MODEL_CREATEUSERLIFECYCLERESPONSE_H_
    ...
    namespace Smh
    {
        namespace V20210712
        {
            namespace Model
            {
                ...
                */
                class CreateUserLifecycleResponse : public AbstractModel
                {
                public:
                    CreateUserLifecycleResponse();
                    ~CreateUserLifecycleResponse() = default;
...
#endif // !TENCENTCLOUD_SMH_V20210712_MODEL_CREATEUSERLIFECYCLERESPONSE_H_
