...
#ifndef TENCENTCLOUD_DRM_V20181115_MODEL_DESCRIBEDRMLICENSEREQUEST_H_
#define TENCENTCLOUD_DRM_V20181115_MODEL_DESCRIBEDRMLICENSEREQUEST_H_
    ...
    namespace Drm
    {
        namespace V20181115
        {
            namespace Model
            {
                ...
                */
                class DescribeDRMLicenseRequest : public AbstractModel
                {
                public:
                    DescribeDRMLicenseRequest();
                    ~DescribeDRMLicenseRequest() = default;
...
#endif // !TENCENTCLOUD_DRM_V20181115_MODEL_DESCRIBEDRMLICENSEREQUEST_H_
