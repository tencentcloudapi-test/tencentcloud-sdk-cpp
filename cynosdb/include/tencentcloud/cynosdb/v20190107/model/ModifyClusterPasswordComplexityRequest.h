...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_MODIFYCLUSTERPASSWORDCOMPLEXITYREQUEST_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_MODIFYCLUSTERPASSWORDCOMPLEXITYREQUEST_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class ModifyClusterPasswordComplexityRequest : public AbstractModel
                {
                public:
                    ModifyClusterPasswordComplexityRequest();
                    ~ModifyClusterPasswordComplexityRequest() = default;
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_MODIFYCLUSTERPASSWORDCOMPLEXITYREQUEST_H_
