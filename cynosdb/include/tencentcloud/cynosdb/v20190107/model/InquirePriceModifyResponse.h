...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_INQUIREPRICEMODIFYRESPONSE_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_INQUIREPRICEMODIFYRESPONSE_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class InquirePriceModifyResponse : public AbstractModel
                {
                public:
                    InquirePriceModifyResponse();
                    ~InquirePriceModifyResponse() = default;
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_INQUIREPRICEMODIFYRESPONSE_H_
