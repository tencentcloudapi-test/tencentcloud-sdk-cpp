...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_STARTCLSDELIVERYREQUEST_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_STARTCLSDELIVERYREQUEST_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class StartCLSDeliveryRequest : public AbstractModel
                {
                public:
                    StartCLSDeliveryRequest();
                    ~StartCLSDeliveryRequest() = default;
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_STARTCLSDELIVERYREQUEST_H_
