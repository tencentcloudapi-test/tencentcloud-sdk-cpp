...
#ifndef TENCENTCLOUD_THPC_V20220401_MODEL_LOGINNODE_H_
#define TENCENTCLOUD_THPC_V20220401_MODEL_LOGINNODE_H_
    ...
    namespace Thpc
    {
        namespace V20220401
        {
            namespace Model
            {
                ...
                * 登录节点信息。
                */
                class LoginNode : public AbstractModel
                {
                public:
                    LoginNode();
                     ...
                     * 
                     */
                    std::vector<InternetAccessible> GetInternetAccessible() const;
                     ...
                     * 
                     */
                    void SetInternetAccessible(const std::vector<InternetAccessible>& _internetAccessible);
                    ...
                    /**
                     * 获取节点显示名称。<br><li> 不指定节点显示名称则默认显示‘未命名’。 最多支持60个字符。</li>	
                     * @return InstanceName 节点显示名称。<br><li> 不指定节点显示名称则默认显示‘未命名’。 最多支持60个字符。</li>	
                     * 
                     */
                    std::string GetInstanceName() const;

                    /**
                     * 设置节点显示名称。<br><li> 不指定节点显示名称则默认显示‘未命名’。 最多支持60个字符。</li>	
                ...
                private:
                     ...
                     */
                    std::vector<InternetAccessible> m_internetAccessible;
...
#endif // !TENCENTCLOUD_THPC_V20220401_MODEL_LOGINNODE_H_
