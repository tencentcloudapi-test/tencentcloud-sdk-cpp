...
#ifndef TENCENTCLOUD_THPC_V20230321_MODEL_GOOSEFSXOPTION_H_
#define TENCENTCLOUD_THPC_V20230321_MODEL_GOOSEFSXOPTION_H_
    ...
    namespace Thpc
    {
        namespace V20230321
        {
            namespace Model
            {
                ...
                * 描述GooseFSx挂载信息
                */
                class GooseFSxOption : public AbstractModel
                {
                public:
                    GooseFSxOption();
...
#endif // !TENCENTCLOUD_THPC_V20230321_MODEL_GOOSEFSXOPTION_H_
