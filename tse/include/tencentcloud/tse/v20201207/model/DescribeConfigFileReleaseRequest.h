...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBECONFIGFILERELEASEREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBECONFIGFILERELEASEREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class DescribeConfigFileReleaseRequest : public AbstractModel
                {
                public:
                    DescribeConfigFileReleaseRequest();
                    ~DescribeConfigFileReleaseRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBECONFIGFILERELEASEREQUEST_H_
