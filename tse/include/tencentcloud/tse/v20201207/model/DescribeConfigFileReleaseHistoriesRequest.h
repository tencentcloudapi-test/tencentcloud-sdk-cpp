...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBECONFIGFILERELEASEHISTORIESREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBECONFIGFILERELEASEHISTORIESREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class DescribeConfigFileReleaseHistoriesRequest : public AbstractModel
                {
                public:
                    DescribeConfigFileReleaseHistoriesRequest();
                    ~DescribeConfigFileReleaseHistoriesRequest() = default;
                    ...
                    /**
                     * 获取发布历史记录id，用于分页优化，一般指定 EndId，就不用指定 Offset，否则分页可能不连续
                     * @return EndId 发布历史记录id，用于分页优化，一般指定 EndId，就不用指定 Offset，否则分页可能不连续
                     * 
                     */
                    uint64_t GetEndId() const;

                    /**
                     * 设置发布历史记录id，用于分页优化，一般指定 EndId，就不用指定 Offset，否则分页可能不连续
                     * @param _endId 发布历史记录id，用于分页优化，一般指定 EndId，就不用指定 Offset，否则分页可能不连续
                     * 
                     */
                    void SetEndId(const uint64_t& _endId);
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBECONFIGFILERELEASEHISTORIESREQUEST_H_
