...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBECONFIGFILESRESPONSE_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBECONFIGFILESRESPONSE_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class DescribeConfigFilesResponse : public AbstractModel
                {
                public:
                    DescribeConfigFilesResponse();
                    ~DescribeConfigFilesResponse() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBECONFIGFILESRESPONSE_H_
