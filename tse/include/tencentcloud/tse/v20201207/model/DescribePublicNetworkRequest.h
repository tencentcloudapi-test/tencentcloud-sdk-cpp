...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBEPUBLICNETWORKREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBEPUBLICNETWORKREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class DescribePublicNetworkRequest : public AbstractModel
                {
                public:
                    DescribePublicNetworkRequest();
                    ~DescribePublicNetworkRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_DESCRIBEPUBLICNETWORKREQUEST_H_
