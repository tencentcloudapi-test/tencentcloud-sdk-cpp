...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_CREATECLOUDNATIVEAPIGATEWAYSERVICERATELIMITREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_CREATECLOUDNATIVEAPIGATEWAYSERVICERATELIMITREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class CreateCloudNativeAPIGatewayServiceRateLimitRequest : public AbstractModel
                {
                public:
                    CreateCloudNativeAPIGatewayServiceRateLimitRequest();
                    ~CreateCloudNativeAPIGatewayServiceRateLimitRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_CREATECLOUDNATIVEAPIGATEWAYSERVICERATELIMITREQUEST_H_
