...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_DELETEGOVERNANCEINSTANCESREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_DELETEGOVERNANCEINSTANCESREQUEST_H_
    ...
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                ...
                */
                class DeleteGovernanceInstancesRequest : public AbstractModel
                {
                public:
                    DeleteGovernanceInstancesRequest();
                    ~DeleteGovernanceInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_DELETEGOVERNANCEINSTANCESREQUEST_H_
