...
#ifndef TENCENTCLOUD_TSE_V20201207_MODEL_CREATEGOVERNANCENAMESPACESREQUEST_H_
#define TENCENTCLOUD_TSE_V20201207_MODEL_CREATEGOVERNANCENAMESPACESREQUEST_H_
...
namespace TencentCloud
{
    namespace Tse
    {
        namespace V20201207
        {
            namespace Model
            {
                class GovernanceNamespaceInput;

                /**
                * CreateGovernanceNamespaces请求参数结构体
                */
                class CreateGovernanceNamespacesRequest : public AbstractModel
                {
                public:
                    CreateGovernanceNamespacesRequest();
                    ~CreateGovernanceNamespacesRequest() = default;
...
#endif // !TENCENTCLOUD_TSE_V20201207_MODEL_CREATEGOVERNANCENAMESPACESREQUEST_H_
