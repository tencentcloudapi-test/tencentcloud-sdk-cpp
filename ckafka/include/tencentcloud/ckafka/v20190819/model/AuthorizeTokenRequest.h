...
#ifndef TENCENTCLOUD_CKAFKA_V20190819_MODEL_AUTHORIZETOKENREQUEST_H_
#define TENCENTCLOUD_CKAFKA_V20190819_MODEL_AUTHORIZETOKENREQUEST_H_
    ...
    namespace Ckafka
    {
        namespace V20190819
        {
            namespace Model
            {
                ...
                */
                class AuthorizeTokenRequest : public AbstractModel
                {
                public:
                    AuthorizeTokenRequest();
                    ~AuthorizeTokenRequest() = default;
...
#endif // !TENCENTCLOUD_CKAFKA_V20190819_MODEL_AUTHORIZETOKENREQUEST_H_
