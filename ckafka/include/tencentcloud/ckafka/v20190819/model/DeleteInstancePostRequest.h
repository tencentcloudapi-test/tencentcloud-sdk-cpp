...
#ifndef TENCENTCLOUD_CKAFKA_V20190819_MODEL_DELETEINSTANCEPOSTREQUEST_H_
#define TENCENTCLOUD_CKAFKA_V20190819_MODEL_DELETEINSTANCEPOSTREQUEST_H_
    ...
    namespace Ckafka
    {
        namespace V20190819
        {
            namespace Model
            {
                ...
                */
                class DeleteInstancePostRequest : public AbstractModel
                {
                public:
                    DeleteInstancePostRequest();
                    ~DeleteInstancePostRequest() = default;
...
#endif // !TENCENTCLOUD_CKAFKA_V20190819_MODEL_DELETEINSTANCEPOSTREQUEST_H_
