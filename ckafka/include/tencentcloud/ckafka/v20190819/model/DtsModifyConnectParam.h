...
#ifndef TENCENTCLOUD_CKAFKA_V20190819_MODEL_DTSMODIFYCONNECTPARAM_H_
#define TENCENTCLOUD_CKAFKA_V20190819_MODEL_DTSMODIFYCONNECTPARAM_H_
    ...
    namespace Ckafka
    {
        namespace V20190819
        {
            namespace Model
            {
                ...
                * Dts修改连接源参数
                */
                class DtsModifyConnectParam : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_CKAFKA_V20190819_MODEL_DTSMODIFYCONNECTPARAM_H_
