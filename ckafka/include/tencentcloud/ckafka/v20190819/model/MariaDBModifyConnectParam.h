...
#ifndef TENCENTCLOUD_CKAFKA_V20190819_MODEL_MARIADBMODIFYCONNECTPARAM_H_
#define TENCENTCLOUD_CKAFKA_V20190819_MODEL_MARIADBMODIFYCONNECTPARAM_H_
    ...
    namespace Ckafka
    {
        namespace V20190819
        {
            namespace Model
            {
                ...
                * MariaDB连接源参数
                */
                class MariaDBModifyConnectParam : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_CKAFKA_V20190819_MODEL_MARIADBMODIFYCONNECTPARAM_H_
