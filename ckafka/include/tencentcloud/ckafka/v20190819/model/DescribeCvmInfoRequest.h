...
#ifndef TENCENTCLOUD_CKAFKA_V20190819_MODEL_DESCRIBECVMINFOREQUEST_H_
#define TENCENTCLOUD_CKAFKA_V20190819_MODEL_DESCRIBECVMINFOREQUEST_H_
    ...
    namespace Ckafka
    {
        namespace V20190819
        {
            namespace Model
            {
                ...
                */
                class DescribeCvmInfoRequest : public AbstractModel
                {
                public:
                    DescribeCvmInfoRequest();
                    ~DescribeCvmInfoRequest() = default;
...
#endif // !TENCENTCLOUD_CKAFKA_V20190819_MODEL_DESCRIBECVMINFOREQUEST_H_
