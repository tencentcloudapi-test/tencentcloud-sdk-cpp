...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODELSET_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODELSET_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                * 模型列表查询结果
                */
                class ModelSet : public AbstractModel
                {
                public:
                    ModelSet();
                     ...
                     * 
                     */
                    std::vector<ModelInfo> GetSet() const;
                     ...
                     * 
                     */
                    void SetSet(const std::vector<ModelInfo>& _set);
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODELSET_H_
