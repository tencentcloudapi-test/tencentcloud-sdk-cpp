...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEBUILDINGPROFILEREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEBUILDINGPROFILEREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class DescribeBuildingProfileRequest : public AbstractModel
                {
                public:
                    DescribeBuildingProfileRequest();
                    ~DescribeBuildingProfileRequest() = default;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEBUILDINGPROFILEREQUEST_H_
