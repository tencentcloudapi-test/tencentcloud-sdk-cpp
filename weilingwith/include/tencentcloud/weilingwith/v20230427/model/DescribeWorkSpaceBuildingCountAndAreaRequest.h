...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEWORKSPACEBUILDINGCOUNTANDAREAREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEWORKSPACEBUILDINGCOUNTANDAREAREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class DescribeWorkSpaceBuildingCountAndAreaRequest : public AbstractModel
                {
                public:
                    DescribeWorkSpaceBuildingCountAndAreaRequest();
                    ~DescribeWorkSpaceBuildingCountAndAreaRequest() = default;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEWORKSPACEBUILDINGCOUNTANDAREAREQUEST_H_
