...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODIFYDEVICENAMEREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODIFYDEVICENAMEREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class ModifyDeviceNameRequest : public AbstractModel
                {
                public:
                    ModifyDeviceNameRequest();
                    ~ModifyDeviceNameRequest() = default;
                     ...
                     * 
                     */
                    std::vector<DeviceModifyInfo> GetSet() const;
                     ...
                     * 
                     */
                    void SetSet(const std::vector<DeviceModifyInfo>& _set);
                ...
                private:
                     ...
                     * 设备修改信息集合
                     */
                    std::vector<DeviceModifyInfo> m_set;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODIFYDEVICENAMEREQUEST_H_
