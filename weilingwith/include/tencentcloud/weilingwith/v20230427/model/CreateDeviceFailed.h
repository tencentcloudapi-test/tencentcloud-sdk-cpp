...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_CREATEDEVICEFAILED_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_CREATEDEVICEFAILED_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                * 导入失败设备信息
                */
                class CreateDeviceFailed : public AbstractModel
                {
                public:
                    CreateDeviceFailed();
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_CREATEDEVICEFAILED_H_
