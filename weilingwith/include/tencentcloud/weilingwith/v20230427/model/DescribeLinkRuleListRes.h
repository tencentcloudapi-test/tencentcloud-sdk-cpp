...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBELINKRULELISTRES_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBELINKRULELISTRES_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                * 联动规则列表查询结果
                */
                class DescribeLinkRuleListRes : public AbstractModel
                {
                public:
                     ...
                     * 
                     */
                    std::vector<LinkRuleInfo> GetLinkRuleSet() const;
                     ...
                     * 
                     */
                    void SetLinkRuleSet(const std::vector<LinkRuleInfo>& _linkRuleSet);
                ...
                private:
                     ...
                     * 联动规则列表
                     */
                    std::vector<LinkRuleInfo> m_linkRuleSet;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBELINKRULELISTRES_H_
