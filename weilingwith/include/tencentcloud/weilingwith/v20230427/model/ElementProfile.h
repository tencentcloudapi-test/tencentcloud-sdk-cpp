...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_ELEMENTPROFILE_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_ELEMENTPROFILE_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                * 构件概要信息
                */
                class ElementProfile : public AbstractModel
                {
                public:
                    ElementProfile();
                    ...
                    /**
                     * 判断参数 SpacePoiId 是否已赋值
                     * @return SpacePoiId 是否已赋值
                     * 
                     */
                    bool SpacePoiIdHasBeenSet() const;
                    ...
                    /**
                     * 判断参数 ElementDesc 是否已赋值
                     * @return ElementDesc 是否已赋值
                     * 
                     */
                    bool ElementDescHasBeenSet() const;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_ELEMENTPROFILE_H_
