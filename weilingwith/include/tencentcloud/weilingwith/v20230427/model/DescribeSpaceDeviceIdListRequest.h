...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESPACEDEVICEIDLISTREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESPACEDEVICEIDLISTREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class DescribeSpaceDeviceIdListRequest : public AbstractModel
                {
                public:
                    DescribeSpaceDeviceIdListRequest();
                    ~DescribeSpaceDeviceIdListRequest() = default;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESPACEDEVICEIDLISTREQUEST_H_
