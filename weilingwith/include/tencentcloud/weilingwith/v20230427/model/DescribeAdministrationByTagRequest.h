...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEADMINISTRATIONBYTAGREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEADMINISTRATIONBYTAGREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class DescribeAdministrationByTagRequest : public AbstractModel
                {
                public:
                    DescribeAdministrationByTagRequest();
                    ~DescribeAdministrationByTagRequest() = default;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEADMINISTRATIONBYTAGREQUEST_H_
