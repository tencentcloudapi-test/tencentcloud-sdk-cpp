...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESCENELISTREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESCENELISTREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class DescribeSceneListRequest : public AbstractModel
                {
                public:
                    DescribeSceneListRequest();
                    ~DescribeSceneListRequest() = default;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBESCENELISTREQUEST_H_
