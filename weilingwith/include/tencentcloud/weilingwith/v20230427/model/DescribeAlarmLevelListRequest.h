...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEALARMLEVELLISTREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEALARMLEVELLISTREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class DescribeAlarmLevelListRequest : public AbstractModel
                {
                public:
                    DescribeAlarmLevelListRequest();
                    ~DescribeAlarmLevelListRequest() = default;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEALARMLEVELLISTREQUEST_H_
