...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODIFYDEVICEFIELDREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODIFYDEVICEFIELDREQUEST_H_
...
namespace TencentCloud
{
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                class ModifyDeviceFieldInfo;

                /**
                * ModifyDeviceField请求参数结构体
                */
                class ModifyDeviceFieldRequest : public AbstractModel
                {
                public:
                    ModifyDeviceFieldRequest();
                    ~ModifyDeviceFieldRequest() = default;
                     ...
                     * 
                     */
                    std::vector<ModifyDeviceFieldInfo> GetSet() const;
                     ...
                     * 
                     */
                    void SetSet(const std::vector<ModifyDeviceFieldInfo>& _set);
                ...
                private:
                     ...
                     * 设备自定义字段修改信息集合
                     */
                    std::vector<ModifyDeviceFieldInfo> m_set;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODIFYDEVICEFIELDREQUEST_H_
