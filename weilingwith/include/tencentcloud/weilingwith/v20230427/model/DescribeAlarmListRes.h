...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEALARMLISTRES_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEALARMLISTRES_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                * 告警列表回包
                */
                class DescribeAlarmListRes : public AbstractModel
                {
                public:
                    ...
                    /**
                     * 判断参数 AlarmInfoSet 是否已赋值
                     * @return AlarmInfoSet 是否已赋值
                     * 
                     */
                    bool AlarmInfoSetHasBeenSet() const;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEALARMLISTRES_H_
