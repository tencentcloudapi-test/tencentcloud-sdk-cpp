...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODIFYDEVICETAGREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODIFYDEVICETAGREQUEST_H_
...
namespace TencentCloud
{
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                class ModifyDeviceTagInfo;

                /**
                * ModifyDeviceTag请求参数结构体
                */
                class ModifyDeviceTagRequest : public AbstractModel
                {
                public:
                    ModifyDeviceTagRequest();
                    ~ModifyDeviceTagRequest() = default;
                    ...
                    /**
                     * 获取设备标签修改信息集合
                     * @return Set 设备标签修改信息集合
                     * 
                     */
                    std::vector<ModifyDeviceTagInfo> GetSet() const;
                     ...
                     * 
                     */
                    void SetSet(const std::vector<ModifyDeviceTagInfo>& _set);
                ...
                private:
                     ...
                     * 设备标签修改信息集合
                     */
                    std::vector<ModifyDeviceTagInfo> m_set;
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_MODIFYDEVICETAGREQUEST_H_
