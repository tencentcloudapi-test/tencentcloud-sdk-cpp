...
#ifndef TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEACTIONLISTREQUEST_H_
#define TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEACTIONLISTREQUEST_H_
    ...
    namespace Weilingwith
    {
        namespace V20230427
        {
            namespace Model
            {
                ...
                */
                class DescribeActionListRequest : public AbstractModel
                {
                public:
                    DescribeActionListRequest();
                    ~DescribeActionListRequest() = default;
                    ...
                    /**
                     * 获取动作类型，（app,device,toAlarm,toNotification）
                     * @return ActionType 动作类型，（app,device,toAlarm,toNotification）
                     * 
                     */
                    std::string GetActionType() const;

                    /**
                     * 设置动作类型，（app,device,toAlarm,toNotification）
...
#endif // !TENCENTCLOUD_WEILINGWITH_V20230427_MODEL_DESCRIBEACTIONLISTREQUEST_H_
