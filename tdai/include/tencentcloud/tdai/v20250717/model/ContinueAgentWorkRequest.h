...
#ifndef TENCENTCLOUD_TDAI_V20250717_MODEL_CONTINUEAGENTWORKREQUEST_H_
#define TENCENTCLOUD_TDAI_V20250717_MODEL_CONTINUEAGENTWORKREQUEST_H_
    ...
    namespace Tdai
    {
        namespace V20250717
        {
            namespace Model
            {
                ...
                */
                class ContinueAgentWorkRequest : public AbstractModel
                {
                public:
                    ContinueAgentWorkRequest();
                    ~ContinueAgentWorkRequest() = default;
...
#endif // !TENCENTCLOUD_TDAI_V20250717_MODEL_CONTINUEAGENTWORKREQUEST_H_
