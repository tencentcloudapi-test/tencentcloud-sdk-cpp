...
#ifndef TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_MODIFYDEVICEPROPERTYREQUEST_H_
#define TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_MODIFYDEVICEPROPERTYREQUEST_H_
    ...
    namespace Iotvideo
    {
        namespace V20191126
        {
            namespace Model
            {
                ...
                */
                class ModifyDevicePropertyRequest : public AbstractModel
                {
                public:
                    ModifyDevicePropertyRequest();
                    ~ModifyDevicePropertyRequest() = default;
                    ...
                    /**
                     * 获取Value字段是否为数值（float、int）
                     * @return IsNum Value字段是否为数值（float、int）
                     * 
                     */
                    bool GetIsNum() const;

                    /**
                     * 设置Value字段是否为数值（float、int）
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_MODIFYDEVICEPROPERTYREQUEST_H_
