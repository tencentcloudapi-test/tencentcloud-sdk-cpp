...
#ifndef TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_CREATESTORAGESERVICERESPONSE_H_
#define TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_CREATESTORAGESERVICERESPONSE_H_
    ...
    namespace Iotvideo
    {
        namespace V20191126
        {
            namespace Model
            {
                ...
                */
                class CreateStorageServiceResponse : public AbstractModel
                {
                public:
                    CreateStorageServiceResponse();
                    ~CreateStorageServiceResponse() = default;
                     ...
                     * 
                     */
                    bool GetIsRenew() const;

                    /**
                     * 判断参数 IsRenew 是否已赋值
                     * @return IsRenew 是否已赋值
                     * 
                     */
                    bool IsRenewHasBeenSet() const;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_CREATESTORAGESERVICERESPONSE_H_
