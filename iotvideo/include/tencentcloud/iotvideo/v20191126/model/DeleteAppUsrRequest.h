...
#ifndef TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_DELETEAPPUSRREQUEST_H_
#define TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_DELETEAPPUSRREQUEST_H_
    ...
    namespace Iotvideo
    {
        namespace V20191126
        {
            namespace Model
            {
                ...
                * DeleteAppUsr请求参数结构体
                */
                class DeleteAppUsrRequest : public AbstractModel
                {
                public:
                    DeleteAppUsrRequest();
                    ~DeleteAppUsrRequest() = default;
...
#endif // !TENCENTCLOUD_IOTVIDEO_V20191126_MODEL_DELETEAPPUSRREQUEST_H_
