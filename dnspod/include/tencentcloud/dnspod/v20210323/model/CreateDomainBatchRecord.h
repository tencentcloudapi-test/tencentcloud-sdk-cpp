...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATEDOMAINBATCHRECORD_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATEDOMAINBATCHRECORD_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                * 批量添加域名任务中的记录信息
                */
                class CreateDomainBatchRecord : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATEDOMAINBATCHRECORD_H_
