...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_CHECKSNAPSHOTROLLBACKREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_CHECKSNAPSHOTROLLBACKREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class CheckSnapshotRollbackRequest : public AbstractModel
                {
                public:
                    CheckSnapshotRollbackRequest();
                    ~CheckSnapshotRollbackRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_CHECKSNAPSHOTROLLBACKREQUEST_H_
