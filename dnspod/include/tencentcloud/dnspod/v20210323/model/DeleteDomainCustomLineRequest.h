...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DELETEDOMAINCUSTOMLINEREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DELETEDOMAINCUSTOMLINEREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DeleteDomainCustomLineRequest : public AbstractModel
                {
                public:
                    DeleteDomainCustomLineRequest();
                    ~DeleteDomainCustomLineRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DELETEDOMAINCUSTOMLINEREQUEST_H_
