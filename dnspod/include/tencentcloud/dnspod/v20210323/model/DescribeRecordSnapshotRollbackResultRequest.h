...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBERECORDSNAPSHOTROLLBACKRESULTREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBERECORDSNAPSHOTROLLBACKRESULTREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DescribeRecordSnapshotRollbackResultRequest : public AbstractModel
                {
                public:
                    DescribeRecordSnapshotRollbackResultRequest();
                    ~DescribeRecordSnapshotRollbackResultRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBERECORDSNAPSHOTROLLBACKRESULTREQUEST_H_
