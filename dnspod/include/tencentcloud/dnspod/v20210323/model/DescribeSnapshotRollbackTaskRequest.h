...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBESNAPSHOTROLLBACKTASKREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBESNAPSHOTROLLBACKTASKREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DescribeSnapshotRollbackTaskRequest : public AbstractModel
                {
                public:
                    DescribeSnapshotRollbackTaskRequest();
                    ~DescribeSnapshotRollbackTaskRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBESNAPSHOTROLLBACKTASKREQUEST_H_
