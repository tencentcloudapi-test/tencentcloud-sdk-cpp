...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DOWNLOADSNAPSHOTREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DOWNLOADSNAPSHOTREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DownloadSnapshotRequest : public AbstractModel
                {
                public:
                    DownloadSnapshotRequest();
                    ~DownloadSnapshotRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DOWNLOADSNAPSHOTREQUEST_H_
