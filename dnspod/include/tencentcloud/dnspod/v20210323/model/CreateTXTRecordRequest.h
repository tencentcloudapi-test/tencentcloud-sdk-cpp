...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATETXTRECORDREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATETXTRECORDREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class CreateTXTRecordRequest : public AbstractModel
                {
                public:
                    CreateTXTRecordRequest();
                    ~CreateTXTRecordRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_CREATETXTRECORDREQUEST_H_
