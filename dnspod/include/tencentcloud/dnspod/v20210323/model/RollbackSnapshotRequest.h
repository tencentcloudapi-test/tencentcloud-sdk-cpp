...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_ROLLBACKSNAPSHOTREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_ROLLBACKSNAPSHOTREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class RollbackSnapshotRequest : public AbstractModel
                {
                public:
                    RollbackSnapshotRequest();
                    ~RollbackSnapshotRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_ROLLBACKSNAPSHOTREQUEST_H_
