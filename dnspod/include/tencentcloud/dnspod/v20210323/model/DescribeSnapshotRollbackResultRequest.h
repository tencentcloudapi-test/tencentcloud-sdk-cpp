...
#ifndef TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBESNAPSHOTROLLBACKRESULTREQUEST_H_
#define TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBESNAPSHOTROLLBACKRESULTREQUEST_H_
    ...
    namespace Dnspod
    {
        namespace V20210323
        {
            namespace Model
            {
                ...
                */
                class DescribeSnapshotRollbackResultRequest : public AbstractModel
                {
                public:
                    DescribeSnapshotRollbackResultRequest();
                    ~DescribeSnapshotRollbackResultRequest() = default;
...
#endif // !TENCENTCLOUD_DNSPOD_V20210323_MODEL_DESCRIBESNAPSHOTROLLBACKRESULTREQUEST_H_
