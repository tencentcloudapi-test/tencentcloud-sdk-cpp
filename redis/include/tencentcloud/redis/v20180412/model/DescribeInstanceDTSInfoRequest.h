...
#ifndef TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEDTSINFOREQUEST_H_
#define TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEDTSINFOREQUEST_H_
    ...
    namespace Redis
    {
        namespace V20180412
        {
            namespace Model
            {
                ...
                */
                class DescribeInstanceDTSInfoRequest : public AbstractModel
                {
                public:
                    DescribeInstanceDTSInfoRequest();
                    ~DescribeInstanceDTSInfoRequest() = default;
...
#endif // !TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEDTSINFOREQUEST_H_
