...
#ifndef TENCENTCLOUD_REDIS_V20180412_MODEL_DISABLEREPLICAREADONLYREQUEST_H_
#define TENCENTCLOUD_REDIS_V20180412_MODEL_DISABLEREPLICAREADONLYREQUEST_H_
    ...
    namespace Redis
    {
        namespace V20180412
        {
            namespace Model
            {
                ...
                */
                class DisableReplicaReadonlyRequest : public AbstractModel
                {
                public:
                    DisableReplicaReadonlyRequest();
                    ~DisableReplicaReadonlyRequest() = default;
...
#endif // !TENCENTCLOUD_REDIS_V20180412_MODEL_DISABLEREPLICAREADONLYREQUEST_H_
