            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取慢查询阈值。取值为大于0 的正整数。单位：毫秒。
                     * @return MinQueryTime 慢查询阈值。取值为大于0 的正整数。单位：毫秒。
                     * 
                     */
                    int64_t GetMinQueryTime() const;

                    /**
                     * 设置慢查询阈值。取值为大于0 的正整数。单位：毫秒。
                    ...
                    /**
                     * 获取每页输出的任务列表大小。默认值为20，最小值为1，最大值为100。
                     * @return Limit 每页输出的任务列表大小。默认值为20，最小值为1，最大值为100。
                     * 
                     */
                    int64_t GetLimit() const;

                    /**
                     * 设置每页输出的任务列表大小。默认值为20，最小值为1，最大值为100。
