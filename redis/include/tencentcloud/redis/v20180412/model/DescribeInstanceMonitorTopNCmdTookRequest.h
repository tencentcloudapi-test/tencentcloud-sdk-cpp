...
#ifndef TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEMONITORTOPNCMDTOOKREQUEST_H_
#define TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEMONITORTOPNCMDTOOKREQUEST_H_
    ...
    namespace Redis
    {
        namespace V20180412
        {
            namespace Model
            {
                ...
                */
                class DescribeInstanceMonitorTopNCmdTookRequest : public AbstractModel
                {
                public:
                    DescribeInstanceMonitorTopNCmdTookRequest();
                    ~DescribeInstanceMonitorTopNCmdTookRequest() = default;
...
#endif // !TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEINSTANCEMONITORTOPNCMDTOOKREQUEST_H_
