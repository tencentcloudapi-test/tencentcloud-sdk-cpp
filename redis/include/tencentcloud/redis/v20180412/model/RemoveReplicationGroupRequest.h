...
#ifndef TENCENTCLOUD_REDIS_V20180412_MODEL_REMOVEREPLICATIONGROUPREQUEST_H_
#define TENCENTCLOUD_REDIS_V20180412_MODEL_REMOVEREPLICATIONGROUPREQUEST_H_
    ...
    namespace Redis
    {
        namespace V20180412
        {
            namespace Model
            {
                ...
                */
                class RemoveReplicationGroupRequest : public AbstractModel
                {
                public:
                    RemoveReplicationGroupRequest();
                    ~RemoveReplicationGroupRequest() = default;
...
#endif // !TENCENTCLOUD_REDIS_V20180412_MODEL_REMOVEREPLICATIONGROUPREQUEST_H_
