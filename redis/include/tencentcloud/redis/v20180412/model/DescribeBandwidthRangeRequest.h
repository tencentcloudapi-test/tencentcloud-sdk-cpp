...
#ifndef TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEBANDWIDTHRANGEREQUEST_H_
#define TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEBANDWIDTHRANGEREQUEST_H_
    ...
    namespace Redis
    {
        namespace V20180412
        {
            namespace Model
            {
                ...
                */
                class DescribeBandwidthRangeRequest : public AbstractModel
                {
                public:
                    DescribeBandwidthRangeRequest();
                    ~DescribeBandwidthRangeRequest() = default;
...
#endif // !TENCENTCLOUD_REDIS_V20180412_MODEL_DESCRIBEBANDWIDTHRANGEREQUEST_H_
