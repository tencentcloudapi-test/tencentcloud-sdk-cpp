...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_CREATECLUSTERRELEASEREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_CREATECLUSTERRELEASEREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class CreateClusterReleaseRequest : public AbstractModel
                {
                public:
                    CreateClusterReleaseRequest();
                    ~CreateClusterReleaseRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_CREATECLUSTERRELEASEREQUEST_H_
