...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_AVAILABLEEXTRAARGS_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_AVAILABLEEXTRAARGS_H_
...
#include <tencentcloud/tke/v20180525/model/Flag.h>
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                * 集群可用的自定义参数
                */
                class AvailableExtraArgs : public AbstractModel
                {
                public:
                    AvailableExtraArgs();
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<Flag> GetKubeAPIServer() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetKubeAPIServer(const std::vector<Flag>& _kubeAPIServer);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<Flag> GetKubeControllerManager() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetKubeControllerManager(const std::vector<Flag>& _kubeControllerManager);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<Flag> GetKubeScheduler() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetKubeScheduler(const std::vector<Flag>& _kubeScheduler);
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<Flag> GetKubelet() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetKubelet(const std::vector<Flag>& _kubelet);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<Flag> m_kubeAPIServer;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<Flag> m_kubeControllerManager;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<Flag> m_kubeScheduler;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_AVAILABLEEXTRAARGS_H_
