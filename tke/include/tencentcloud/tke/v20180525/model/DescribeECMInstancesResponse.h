...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEECMINSTANCESRESPONSE_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEECMINSTANCESRESPONSE_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class DescribeECMInstancesResponse : public AbstractModel
                {
                public:
                    DescribeECMInstancesResponse();
                    ~DescribeECMInstancesResponse() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEECMINSTANCESRESPONSE_H_
