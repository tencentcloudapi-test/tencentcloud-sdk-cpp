...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_SYNCPROMETHEUSTEMPLATEREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_SYNCPROMETHEUSTEMPLATEREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class SyncPrometheusTemplateRequest : public AbstractModel
                {
                public:
                    SyncPrometheusTemplateRequest();
                    ~SyncPrometheusTemplateRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_SYNCPROMETHEUSTEMPLATEREQUEST_H_
