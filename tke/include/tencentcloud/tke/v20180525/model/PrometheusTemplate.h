...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_PROMETHEUSTEMPLATE_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_PROMETHEUSTEMPLATE_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                * 模板实例
                */
                class PrometheusTemplate : public AbstractModel
                {
                public:
                    PrometheusTemplate();
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_PROMETHEUSTEMPLATE_H_
