...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEIPAMDREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEIPAMDREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class DescribeIPAMDRequest : public AbstractModel
                {
                public:
                    DescribeIPAMDRequest();
                    ~DescribeIPAMDRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEIPAMDREQUEST_H_
