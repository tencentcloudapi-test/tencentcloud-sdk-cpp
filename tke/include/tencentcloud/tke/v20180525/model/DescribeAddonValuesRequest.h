...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEADDONVALUESREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEADDONVALUESREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class DescribeAddonValuesRequest : public AbstractModel
                {
                public:
                    DescribeAddonValuesRequest();
                    ~DescribeAddonValuesRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_DESCRIBEADDONVALUESREQUEST_H_
