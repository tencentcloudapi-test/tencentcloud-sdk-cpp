...
#ifndef TENCENTCLOUD_TKE_V20180525_MODEL_DELETEPROMETHEUSTEMPLATESYNCREQUEST_H_
#define TENCENTCLOUD_TKE_V20180525_MODEL_DELETEPROMETHEUSTEMPLATESYNCREQUEST_H_
    ...
    namespace Tke
    {
        namespace V20180525
        {
            namespace Model
            {
                ...
                */
                class DeletePrometheusTemplateSyncRequest : public AbstractModel
                {
                public:
                    DeletePrometheusTemplateSyncRequest();
                    ~DeletePrometheusTemplateSyncRequest() = default;
...
#endif // !TENCENTCLOUD_TKE_V20180525_MODEL_DELETEPROMETHEUSTEMPLATESYNCREQUEST_H_
