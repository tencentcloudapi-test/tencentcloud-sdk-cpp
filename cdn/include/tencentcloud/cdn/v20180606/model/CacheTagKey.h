...
#ifndef TENCENTCLOUD_CDN_V20180606_MODEL_CACHETAGKEY_H_
#define TENCENTCLOUD_CDN_V20180606_MODEL_CACHETAGKEY_H_
    ...
    namespace Cdn
    {
        namespace V20180606
        {
            namespace Model
            {
                ...
                * 组成CacheKey的一部分
                */
                class CacheTagKey : public AbstractModel
                {
                public:
                    CacheTagKey();
...
#endif // !TENCENTCLOUD_CDN_V20180606_MODEL_CACHETAGKEY_H_
