...
#ifndef TENCENTCLOUD_AS_V20180419_MODEL_CREATENOTIFICATIONCONFIGURATIONRESPONSE_H_
#define TENCENTCLOUD_AS_V20180419_MODEL_CREATENOTIFICATIONCONFIGURATIONRESPONSE_H_
    ...
    namespace As
    {
        namespace V20180419
        {
            namespace Model
            {
                ...
                */
                class CreateNotificationConfigurationResponse : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_AS_V20180419_MODEL_CREATENOTIFICATIONCONFIGURATIONRESPONSE_H_
