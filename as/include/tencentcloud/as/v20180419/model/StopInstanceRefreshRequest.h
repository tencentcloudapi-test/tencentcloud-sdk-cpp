...
#ifndef TENCENTCLOUD_AS_V20180419_MODEL_STOPINSTANCEREFRESHREQUEST_H_
#define TENCENTCLOUD_AS_V20180419_MODEL_STOPINSTANCEREFRESHREQUEST_H_
    ...
    namespace As
    {
        namespace V20180419
        {
            namespace Model
            {
                ...
                */
                class StopInstanceRefreshRequest : public AbstractModel
                {
                public:
                    StopInstanceRefreshRequest();
                    ~StopInstanceRefreshRequest() = default;
...
#endif // !TENCENTCLOUD_AS_V20180419_MODEL_STOPINSTANCEREFRESHREQUEST_H_
