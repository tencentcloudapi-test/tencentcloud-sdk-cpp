...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_ADDCASTERMARKWORDINFOREQUEST_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_ADDCASTERMARKWORDINFOREQUEST_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class AddCasterMarkWordInfoRequest : public AbstractModel
                {
                public:
                    AddCasterMarkWordInfoRequest();
                    ~AddCasterMarkWordInfoRequest() = default;
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_ADDCASTERMARKWORDINFOREQUEST_H_
