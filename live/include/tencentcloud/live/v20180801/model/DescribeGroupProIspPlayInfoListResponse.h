...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_DESCRIBEGROUPPROISPPLAYINFOLISTRESPONSE_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_DESCRIBEGROUPPROISPPLAYINFOLISTRESPONSE_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class DescribeGroupProIspPlayInfoListResponse : public AbstractModel
                {
                public:
                ...
                private:
                     ...
                     * 数据内容。
                     */
                    std::vector<GroupProIspDataInfo> m_dataInfoList;
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_DESCRIBEGROUPPROISPPLAYINFOLISTRESPONSE_H_
