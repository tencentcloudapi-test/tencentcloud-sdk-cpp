...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_MODIFYCASTERINPUTINFOREQUEST_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_MODIFYCASTERINPUTINFOREQUEST_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class ModifyCasterInputInfoRequest : public AbstractModel
                {
                public:
                    ModifyCasterInputInfoRequest();
                    ~ModifyCasterInputInfoRequest() = default;
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_MODIFYCASTERINPUTINFOREQUEST_H_
