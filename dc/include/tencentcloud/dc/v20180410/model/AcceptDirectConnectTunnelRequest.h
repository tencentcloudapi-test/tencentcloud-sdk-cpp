...
#ifndef TENCENTCLOUD_DC_V20180410_MODEL_ACCEPTDIRECTCONNECTTUNNELREQUEST_H_
#define TENCENTCLOUD_DC_V20180410_MODEL_ACCEPTDIRECTCONNECTTUNNELREQUEST_H_
    ...
    namespace Dc
    {
        namespace V20180410
        {
            namespace Model
            {
                ...
                */
                class AcceptDirectConnectTunnelRequest : public AbstractModel
                {
                public:
                    AcceptDirectConnectTunnelRequest();
                    ~AcceptDirectConnectTunnelRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取专用通道ID。可以通过[DescribeDirectConnectTunnels](https://cloud.tencent.com/document/product/216/19819)接口获取。
                    ...
                    /**
                     * 设置专用通道ID。可以通过[DescribeDirectConnectTunnels](https://cloud.tencent.com/document/product/216/19819)接口获取。
...
#endif // !TENCENTCLOUD_DC_V20180410_MODEL_ACCEPTDIRECTCONNECTTUNNELREQUEST_H_
