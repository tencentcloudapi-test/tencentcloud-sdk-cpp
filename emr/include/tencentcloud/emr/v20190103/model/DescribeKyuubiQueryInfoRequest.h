...
#ifndef TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEKYUUBIQUERYINFOREQUEST_H_
#define TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEKYUUBIQUERYINFOREQUEST_H_
    ...
    namespace Emr
    {
        namespace V20190103
        {
            namespace Model
            {
                ...
                */
                class DescribeKyuubiQueryInfoRequest : public AbstractModel
                {
                public:
                    DescribeKyuubiQueryInfoRequest();
                    ~DescribeKyuubiQueryInfoRequest() = default;
...
#endif // !TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEKYUUBIQUERYINFOREQUEST_H_
