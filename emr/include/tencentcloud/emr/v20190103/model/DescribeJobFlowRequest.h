...
#ifndef TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEJOBFLOWREQUEST_H_
#define TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEJOBFLOWREQUEST_H_
    ...
    namespace Emr
    {
        namespace V20190103
        {
            namespace Model
            {
                ...
                */
                class DescribeJobFlowRequest : public AbstractModel
                {
                public:
                    DescribeJobFlowRequest();
                    ~DescribeJobFlowRequest() = default;
...
#endif // !TENCENTCLOUD_EMR_V20190103_MODEL_DESCRIBEJOBFLOWREQUEST_H_
