...
#ifndef TENCENTCLOUD_FMU_V20191213_MODEL_STYLEIMAGERESPONSE_H_
#define TENCENTCLOUD_FMU_V20191213_MODEL_STYLEIMAGERESPONSE_H_
    ...
    namespace Fmu
    {
        namespace V20191213
        {
            namespace Model
            {
                ...
                * StyleImage返回参数结构体
                */
                class StyleImageResponse : public AbstractModel
                {
                public:
                    StyleImageResponse();
                    ~StyleImageResponse() = default;
...
#endif // !TENCENTCLOUD_FMU_V20191213_MODEL_STYLEIMAGERESPONSE_H_
