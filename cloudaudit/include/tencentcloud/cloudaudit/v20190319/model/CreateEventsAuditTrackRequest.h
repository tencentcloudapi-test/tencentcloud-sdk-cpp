...
#ifndef TENCENTCLOUD_CLOUDAUDIT_V20190319_MODEL_CREATEEVENTSAUDITTRACKREQUEST_H_
#define TENCENTCLOUD_CLOUDAUDIT_V20190319_MODEL_CREATEEVENTSAUDITTRACKREQUEST_H_
    ...
    namespace Cloudaudit
    {
        namespace V20190319
        {
            namespace Model
            {
                ...
                */
                class CreateEventsAuditTrackRequest : public AbstractModel
                {
                public:
                    CreateEventsAuditTrackRequest();
                    ~CreateEventsAuditTrackRequest() = default;
...
#endif // !TENCENTCLOUD_CLOUDAUDIT_V20190319_MODEL_CREATEEVENTSAUDITTRACKREQUEST_H_
