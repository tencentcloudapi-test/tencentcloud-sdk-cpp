...
#ifndef TENCENTCLOUD_CLOUDAUDIT_V20190319_MODEL_LISTCMQENABLEREGIONREQUEST_H_
#define TENCENTCLOUD_CLOUDAUDIT_V20190319_MODEL_LISTCMQENABLEREGIONREQUEST_H_
    ...
    namespace Cloudaudit
    {
        namespace V20190319
        {
            namespace Model
            {
                ...
                */
                class ListCmqEnableRegionRequest : public AbstractModel
                {
                public:
                    ListCmqEnableRegionRequest();
                    ~ListCmqEnableRegionRequest() = default;
...
#endif // !TENCENTCLOUD_CLOUDAUDIT_V20190319_MODEL_LISTCMQENABLEREGIONREQUEST_H_
