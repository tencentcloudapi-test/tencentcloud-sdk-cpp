...
#ifndef TENCENTCLOUD_DCDB_V20180411_MODEL_ISOLATEDCDBINSTANCERESPONSE_H_
#define TENCENTCLOUD_DCDB_V20180411_MODEL_ISOLATEDCDBINSTANCERESPONSE_H_
    ...
    namespace Dcdb
    {
        namespace V20180411
        {
            namespace Model
            {
                ...
                */
                class IsolateDCDBInstanceResponse : public AbstractModel
                {
                public:
                    IsolateDCDBInstanceResponse();
                    ~IsolateDCDBInstanceResponse() = default;
...
#endif // !TENCENTCLOUD_DCDB_V20180411_MODEL_ISOLATEDCDBINSTANCERESPONSE_H_
