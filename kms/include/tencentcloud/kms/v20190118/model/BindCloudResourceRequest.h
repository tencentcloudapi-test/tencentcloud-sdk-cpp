...
#ifndef TENCENTCLOUD_KMS_V20190118_MODEL_BINDCLOUDRESOURCEREQUEST_H_
#define TENCENTCLOUD_KMS_V20190118_MODEL_BINDCLOUDRESOURCEREQUEST_H_
    ...
    namespace Kms
    {
        namespace V20190118
        {
            namespace Model
            {
                ...
                */
                class BindCloudResourceRequest : public AbstractModel
                {
                public:
                    BindCloudResourceRequest();
                    ~BindCloudResourceRequest() = default;
...
#endif // !TENCENTCLOUD_KMS_V20190118_MODEL_BINDCLOUDRESOURCEREQUEST_H_
