...
#ifndef TENCENTCLOUD_KMS_V20190118_MODEL_CANCELDATAKEYDELETIONREQUEST_H_
#define TENCENTCLOUD_KMS_V20190118_MODEL_CANCELDATAKEYDELETIONREQUEST_H_
    ...
    namespace Kms
    {
        namespace V20190118
        {
            namespace Model
            {
                ...
                */
                class CancelDataKeyDeletionRequest : public AbstractModel
                {
                public:
                    CancelDataKeyDeletionRequest();
                    ~CancelDataKeyDeletionRequest() = default;
...
#endif // !TENCENTCLOUD_KMS_V20190118_MODEL_CANCELDATAKEYDELETIONREQUEST_H_
