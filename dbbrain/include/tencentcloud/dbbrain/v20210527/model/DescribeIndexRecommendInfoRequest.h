...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEINDEXRECOMMENDINFOREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEINDEXRECOMMENDINFOREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class DescribeIndexRecommendInfoRequest : public AbstractModel
                {
                public:
                    DescribeIndexRecommendInfoRequest();
                    ~DescribeIndexRecommendInfoRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEINDEXRECOMMENDINFOREQUEST_H_
