...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEHEALTHSCORETIMESERIESREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEHEALTHSCORETIMESERIESREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class DescribeHealthScoreTimeSeriesRequest : public AbstractModel
                {
                public:
                    DescribeHealthScoreTimeSeriesRequest();
                    ~DescribeHealthScoreTimeSeriesRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEHEALTHSCORETIMESERIESREQUEST_H_
