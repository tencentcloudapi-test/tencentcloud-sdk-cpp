...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEREDISCOMMANDCOSTSTATISTICSREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEREDISCOMMANDCOSTSTATISTICSREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class DescribeRedisCommandCostStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeRedisCommandCostStatisticsRequest();
                    ~DescribeRedisCommandCostStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_DESCRIBEREDISCOMMANDCOSTSTATISTICSREQUEST_H_
