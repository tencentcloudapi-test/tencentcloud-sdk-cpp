...
#ifndef TENCENTCLOUD_DBBRAIN_V20210527_MODEL_CANCELDBAUTONOMYACTIONREQUEST_H_
#define TENCENTCLOUD_DBBRAIN_V20210527_MODEL_CANCELDBAUTONOMYACTIONREQUEST_H_
    ...
    namespace Dbbrain
    {
        namespace V20210527
        {
            namespace Model
            {
                ...
                */
                class CancelDBAutonomyActionRequest : public AbstractModel
                {
                public:
                    CancelDBAutonomyActionRequest();
                    ~CancelDBAutonomyActionRequest() = default;
...
#endif // !TENCENTCLOUD_DBBRAIN_V20210527_MODEL_CANCELDBAUTONOMYACTIONREQUEST_H_
