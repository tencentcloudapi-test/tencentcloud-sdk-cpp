...
#ifndef TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTMISBEHAVIORREQUEST_H_
#define TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTMISBEHAVIORREQUEST_H_
    ...
    namespace Tiia
    {
        namespace V20190529
        {
            namespace Model
            {
                ...
                */
                class DetectMisbehaviorRequest : public AbstractModel
                {
                public:
                    DetectMisbehaviorRequest();
                    ~DetectMisbehaviorRequest() = default;
...
#endif // !TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTMISBEHAVIORREQUEST_H_
