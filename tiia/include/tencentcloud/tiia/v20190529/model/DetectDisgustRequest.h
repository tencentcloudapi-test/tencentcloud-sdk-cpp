...
#ifndef TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTDISGUSTREQUEST_H_
#define TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTDISGUSTREQUEST_H_
    ...
    namespace Tiia
    {
        namespace V20190529
        {
            namespace Model
            {
                ...
                */
                class DetectDisgustRequest : public AbstractModel
                {
                public:
                    DetectDisgustRequest();
                    ~DetectDisgustRequest() = default;
...
#endif // !TENCENTCLOUD_TIIA_V20190529_MODEL_DETECTDISGUSTREQUEST_H_
