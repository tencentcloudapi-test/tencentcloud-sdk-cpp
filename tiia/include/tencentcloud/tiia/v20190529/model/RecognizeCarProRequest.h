...
#ifndef TENCENTCLOUD_TIIA_V20190529_MODEL_RECOGNIZECARPROREQUEST_H_
#define TENCENTCLOUD_TIIA_V20190529_MODEL_RECOGNIZECARPROREQUEST_H_
    ...
    namespace Tiia
    {
        namespace V20190529
        {
            namespace Model
            {
                ...
                */
                class RecognizeCarProRequest : public AbstractModel
                {
                public:
                    RecognizeCarProRequest();
                    ~RecognizeCarProRequest() = default;
...
#endif // !TENCENTCLOUD_TIIA_V20190529_MODEL_RECOGNIZECARPROREQUEST_H_
