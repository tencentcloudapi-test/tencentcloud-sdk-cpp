...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBEMIGRATINGTOPICSTATSREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBEMIGRATINGTOPICSTATSREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DescribeMigratingTopicStatsRequest : public AbstractModel
                {
                public:
                    DescribeMigratingTopicStatsRequest();
                    ~DescribeMigratingTopicStatsRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBEMIGRATINGTOPICSTATSREQUEST_H_
