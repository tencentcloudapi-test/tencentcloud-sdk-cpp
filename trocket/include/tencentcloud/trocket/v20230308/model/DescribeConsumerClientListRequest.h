...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERCLIENTLISTREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERCLIENTLISTREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DescribeConsumerClientListRequest : public AbstractModel
                {
                public:
                    DescribeConsumerClientListRequest();
                    ~DescribeConsumerClientListRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBECONSUMERCLIENTLISTREQUEST_H_
