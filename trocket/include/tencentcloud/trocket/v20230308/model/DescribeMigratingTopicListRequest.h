...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBEMIGRATINGTOPICLISTREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBEMIGRATINGTOPICLISTREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DescribeMigratingTopicListRequest : public AbstractModel
                {
                public:
                    DescribeMigratingTopicListRequest();
                    ~DescribeMigratingTopicListRequest() = default;
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DESCRIBEMIGRATINGTOPICLISTREQUEST_H_
