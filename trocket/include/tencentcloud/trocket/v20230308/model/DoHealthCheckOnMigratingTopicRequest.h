...
#ifndef TENCENTCLOUD_TROCKET_V20230308_MODEL_DOHEALTHCHECKONMIGRATINGTOPICREQUEST_H_
#define TENCENTCLOUD_TROCKET_V20230308_MODEL_DOHEALTHCHECKONMIGRATINGTOPICREQUEST_H_
    ...
    namespace Trocket
    {
        namespace V20230308
        {
            namespace Model
            {
                ...
                */
                class DoHealthCheckOnMigratingTopicRequest : public AbstractModel
                {
                public:
                    DoHealthCheckOnMigratingTopicRequest();
                    ~DoHealthCheckOnMigratingTopicRequest() = default;
                    ...
                    /**
                     * 判断参数 IgnoreCheck 是否已赋值
                     * @return IgnoreCheck 是否已赋值
                     * 
                     */
...
#endif // !TENCENTCLOUD_TROCKET_V20230308_MODEL_DOHEALTHCHECKONMIGRATINGTOPICREQUEST_H_
