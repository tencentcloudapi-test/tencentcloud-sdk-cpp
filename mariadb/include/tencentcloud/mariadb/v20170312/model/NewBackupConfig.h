...
#ifndef TENCENTCLOUD_MARIADB_V20170312_MODEL_NEWBACKUPCONFIG_H_
#define TENCENTCLOUD_MARIADB_V20170312_MODEL_NEWBACKUPCONFIG_H_
    ...
    namespace Mariadb
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                * 数据库超期备份配置
                */
                class NewBackupConfig : public AbstractModel
                {
                public:
                    NewBackupConfig();
...
#endif // !TENCENTCLOUD_MARIADB_V20170312_MODEL_NEWBACKUPCONFIG_H_
