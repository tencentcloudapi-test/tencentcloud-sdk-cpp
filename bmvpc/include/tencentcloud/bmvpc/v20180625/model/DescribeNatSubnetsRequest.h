...
#ifndef TENCENTCLOUD_BMVPC_V20180625_MODEL_DESCRIBENATSUBNETSREQUEST_H_
#define TENCENTCLOUD_BMVPC_V20180625_MODEL_DESCRIBENATSUBNETSREQUEST_H_
    ...
    namespace Bmvpc
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class DescribeNatSubnetsRequest : public AbstractModel
                {
                public:
                    DescribeNatSubnetsRequest();
                    ~DescribeNatSubnetsRequest() = default;
...
#endif // !TENCENTCLOUD_BMVPC_V20180625_MODEL_DESCRIBENATSUBNETSREQUEST_H_
