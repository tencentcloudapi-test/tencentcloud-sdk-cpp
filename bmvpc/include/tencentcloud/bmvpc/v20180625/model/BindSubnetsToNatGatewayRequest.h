...
#ifndef TENCENTCLOUD_BMVPC_V20180625_MODEL_BINDSUBNETSTONATGATEWAYREQUEST_H_
#define TENCENTCLOUD_BMVPC_V20180625_MODEL_BINDSUBNETSTONATGATEWAYREQUEST_H_
    ...
    namespace Bmvpc
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class BindSubnetsToNatGatewayRequest : public AbstractModel
                {
                public:
                    BindSubnetsToNatGatewayRequest();
                    ~BindSubnetsToNatGatewayRequest() = default;
...
#endif // !TENCENTCLOUD_BMVPC_V20180625_MODEL_BINDSUBNETSTONATGATEWAYREQUEST_H_
