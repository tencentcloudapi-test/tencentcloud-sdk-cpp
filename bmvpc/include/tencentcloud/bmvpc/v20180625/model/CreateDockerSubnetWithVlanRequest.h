...
#ifndef TENCENTCLOUD_BMVPC_V20180625_MODEL_CREATEDOCKERSUBNETWITHVLANREQUEST_H_
#define TENCENTCLOUD_BMVPC_V20180625_MODEL_CREATEDOCKERSUBNETWITHVLANREQUEST_H_
    ...
    namespace Bmvpc
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class CreateDockerSubnetWithVlanRequest : public AbstractModel
                {
                public:
                    CreateDockerSubnetWithVlanRequest();
                    ~CreateDockerSubnetWithVlanRequest() = default;
...
#endif // !TENCENTCLOUD_BMVPC_V20180625_MODEL_CREATEDOCKERSUBNETWITHVLANREQUEST_H_
