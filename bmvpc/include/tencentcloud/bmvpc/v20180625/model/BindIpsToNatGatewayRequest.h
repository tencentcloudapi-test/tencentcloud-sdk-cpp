...
#ifndef TENCENTCLOUD_BMVPC_V20180625_MODEL_BINDIPSTONATGATEWAYREQUEST_H_
#define TENCENTCLOUD_BMVPC_V20180625_MODEL_BINDIPSTONATGATEWAYREQUEST_H_
    ...
    namespace Bmvpc
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class BindIpsToNatGatewayRequest : public AbstractModel
                {
                public:
                    BindIpsToNatGatewayRequest();
                    ~BindIpsToNatGatewayRequest() = default;
                    ...
                    /**
                     * 获取部分IP信息，子网下只有该部分IP将加入NAT，仅当网关转发模式为IP方式有效
                    ...
                    /**
                     * 设置部分IP信息，子网下只有该部分IP将加入NAT，仅当网关转发模式为IP方式有效
...
#endif // !TENCENTCLOUD_BMVPC_V20180625_MODEL_BINDIPSTONATGATEWAYREQUEST_H_
