...
#ifndef TENCENTCLOUD_BMVPC_V20180625_MODEL_CREATEVIRTUALSUBNETWITHVLANREQUEST_H_
#define TENCENTCLOUD_BMVPC_V20180625_MODEL_CREATEVIRTUALSUBNETWITHVLANREQUEST_H_
    ...
    namespace Bmvpc
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class CreateVirtualSubnetWithVlanRequest : public AbstractModel
                {
                public:
                    CreateVirtualSubnetWithVlanRequest();
                    ~CreateVirtualSubnetWithVlanRequest() = default;
...
#endif // !TENCENTCLOUD_BMVPC_V20180625_MODEL_CREATEVIRTUALSUBNETWITHVLANREQUEST_H_
