...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_GETTICKETSTATISTICSRESPONSE_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_GETTICKETSTATISTICSRESPONSE_H_
    ...
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class GetTicketStatisticsResponse : public AbstractModel
                {
                public:
                    GetTicketStatisticsResponse();
                    ~GetTicketStatisticsResponse() = default;
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_GETTICKETSTATISTICSRESPONSE_H_
