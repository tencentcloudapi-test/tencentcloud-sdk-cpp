...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHADATASUMREQUEST_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHADATASUMREQUEST_H_
    ...
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeCaptchaDataSumRequest : public AbstractModel
                {
                public:
                    DescribeCaptchaDataSumRequest();
                    ~DescribeCaptchaDataSumRequest() = default;
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHADATASUMREQUEST_H_
