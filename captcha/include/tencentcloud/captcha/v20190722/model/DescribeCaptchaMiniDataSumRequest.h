...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHAMINIDATASUMREQUEST_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHAMINIDATASUMREQUEST_H_
    ...
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeCaptchaMiniDataSumRequest : public AbstractModel
                {
                public:
                    DescribeCaptchaMiniDataSumRequest();
                    ~DescribeCaptchaMiniDataSumRequest() = default;
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHAMINIDATASUMREQUEST_H_
