...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_TICKETAMOUNTUNIT_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_TICKETAMOUNTUNIT_H_
    ...
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class TicketAmountUnit : public AbstractModel
                {
                public:
                    TicketAmountUnit();
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_TICKETAMOUNTUNIT_H_
