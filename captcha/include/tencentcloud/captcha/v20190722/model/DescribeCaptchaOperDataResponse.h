...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHAOPERDATARESPONSE_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHAOPERDATARESPONSE_H_
...
namespace TencentCloud
{
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                class CaptchaOperDataRes;

                /**
                * DescribeCaptchaOperData返回参数结构体
                */
                class DescribeCaptchaOperDataResponse : public AbstractModel
                {
                public:
                    DescribeCaptchaOperDataResponse();
                    ~DescribeCaptchaOperDataResponse() = default;
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHAOPERDATARESPONSE_H_
