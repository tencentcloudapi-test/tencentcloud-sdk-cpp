...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHARCERESULTRESPONSE_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHARCERESULTRESPONSE_H_
    ...
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeCaptchaRceResultResponse : public AbstractModel
                {
                public:
                    DescribeCaptchaRceResultResponse();
                    ~DescribeCaptchaRceResultResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 判断参数 RceResult 是否已赋值
                     * @return RceResult 是否已赋值
                     * 
                     */
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHARCERESULTRESPONSE_H_
