...
#ifndef TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHADATASUMRESPONSE_H_
#define TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHADATASUMRESPONSE_H_
    ...
    namespace Captcha
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeCaptchaDataSumResponse : public AbstractModel
                {
                public:
                    DescribeCaptchaDataSumResponse();
                    ~DescribeCaptchaDataSumResponse() = default;
...
#endif // !TENCENTCLOUD_CAPTCHA_V20190722_MODEL_DESCRIBECAPTCHADATASUMRESPONSE_H_
