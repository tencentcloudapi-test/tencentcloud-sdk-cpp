...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEACCESSKEYRISKREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEACCESSKEYRISKREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeAccessKeyRiskRequest : public AbstractModel
                {
                public:
                    DescribeAccessKeyRiskRequest();
                    ~DescribeAccessKeyRiskRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEACCESSKEYRISKREQUEST_H_
