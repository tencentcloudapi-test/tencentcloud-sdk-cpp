...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBESUBNETASSETSRESPONSE_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBESUBNETASSETSRESPONSE_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeSubnetAssetsResponse : public AbstractModel
                {
                public:
                    DescribeSubnetAssetsResponse();
                    ~DescribeSubnetAssetsResponse() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBESUBNETASSETSRESPONSE_H_
