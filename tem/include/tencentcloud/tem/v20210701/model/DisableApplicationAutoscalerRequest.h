...
#ifndef TENCENTCLOUD_TEM_V20210701_MODEL_DISABLEAPPLICATIONAUTOSCALERREQUEST_H_
#define TENCENTCLOUD_TEM_V20210701_MODEL_DISABLEAPPLICATIONAUTOSCALERREQUEST_H_
    ...
    namespace Tem
    {
        namespace V20210701
        {
            namespace Model
            {
                ...
                */
                class DisableApplicationAutoscalerRequest : public AbstractModel
                {
                public:
                    DisableApplicationAutoscalerRequest();
                    ~DisableApplicationAutoscalerRequest() = default;
...
#endif // !TENCENTCLOUD_TEM_V20210701_MODEL_DISABLEAPPLICATIONAUTOSCALERREQUEST_H_
