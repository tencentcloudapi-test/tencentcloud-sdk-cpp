...
#ifndef TENCENTCLOUD_TEM_V20210701_MODEL_MODIFYAPPLICATIONAUTOSCALERREQUEST_H_
#define TENCENTCLOUD_TEM_V20210701_MODEL_MODIFYAPPLICATIONAUTOSCALERREQUEST_H_
    ...
    namespace Tem
    {
        namespace V20210701
        {
            namespace Model
            {
                ...
                */
                class ModifyApplicationAutoscalerRequest : public AbstractModel
                {
                public:
                    ModifyApplicationAutoscalerRequest();
                    ~ModifyApplicationAutoscalerRequest() = default;
...
#endif // !TENCENTCLOUD_TEM_V20210701_MODEL_MODIFYAPPLICATIONAUTOSCALERREQUEST_H_
