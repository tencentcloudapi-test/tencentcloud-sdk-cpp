...
#ifndef TENCENTCLOUD_VM_V20201229_MODEL_RCBASR_H_
#define TENCENTCLOUD_VM_V20201229_MODEL_RCBASR_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取该字段用于返回音频文件识别出的对应文本内容，最大支持前1000个字符。
注意：此字段可能返回 null，表示取不到有效值。
                     * @return Text 该字段用于返回音频文件识别出的对应文本内容，最大支持前1000个字符。
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    ...
                    /**
                     * 设置该字段用于返回音频文件识别出的对应文本内容，最大支持前1000个字符。
注意：此字段可能返回 null，表示取不到有效值。
...
#endif // !TENCENTCLOUD_VM_V20201229_MODEL_RCBASR_H_
