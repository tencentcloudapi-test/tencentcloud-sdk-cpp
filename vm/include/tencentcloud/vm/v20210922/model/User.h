...
#ifndef TENCENTCLOUD_VM_V20210922_MODEL_USER_H_
#define TENCENTCLOUD_VM_V20210922_MODEL_USER_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取该字段表示业务用户ID对应的账号类型，取值：1-微信uin，2-QQ号，3-微信群uin，4-qq群号，5-微信openid，6-QQopenid，7-其它string。
...
该字段与账号ID参数（UserId）配合使用可确定唯一账号。
                    ...
                    /**
                     * 设置该字段表示业务用户ID对应的账号类型，取值：1-微信uin，2-QQ号，3-微信群uin，4-qq群号，5-微信openid，6-QQopenid，7-其它string。
该字段与账号ID参数（UserId）配合使用可确定唯一账号。
...
#endif // !TENCENTCLOUD_VM_V20210922_MODEL_USER_H_
