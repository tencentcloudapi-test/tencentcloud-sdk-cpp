...
#ifndef TENCENTCLOUD_AMS_V20200608_MODEL_IMAGERESULTSRESULTDETAIL_H_
#define TENCENTCLOUD_AMS_V20200608_MODEL_IMAGERESULTSRESULTDETAIL_H_
...
namespace TencentCloud
{
    namespace Ams
    {
        namespace V20200608
        {
            namespace Model
            {
                class ImageResultsResultDetailLocation;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ImageResultsResultDetailLocation> GetLocation() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetLocation(const std::vector<ImageResultsResultDetailLocation>& _location);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ImageResultsResultDetailLocation> m_location;
...
#endif // !TENCENTCLOUD_AMS_V20200608_MODEL_IMAGERESULTSRESULTDETAIL_H_
