...
#ifndef TENCENTCLOUD_AMS_V20201229_MODEL_LABELRESULTS_H_
#define TENCENTCLOUD_AMS_V20201229_MODEL_LABELRESULTS_H_
    ...
    namespace Ams
    {
        namespace V20201229
        {
            namespace Model
            {
                ...
                * 歌曲识别结果
                */
                class LabelResults : public AbstractModel
                {
                public:
                    LabelResults();
...
#endif // !TENCENTCLOUD_AMS_V20201229_MODEL_LABELRESULTS_H_
