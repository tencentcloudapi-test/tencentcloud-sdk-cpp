...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_CONTRACTORDERREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_CONTRACTORDERREQUEST_H_
...
namespace TencentCloud
{
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                class ContractOrderInSubOrder;

                /**
                * ContractOrder请求参数结构体
                */
                class ContractOrderRequest : public AbstractModel
                {
                public:
                    ContractOrderRequest();
                    ~ContractOrderRequest() = default;
                     ...
                     * 
                     */
                    std::string GetContractNotifyUrl() const;
                     ...
                     * 
                     */
                    void SetContractNotifyUrl(const std::string& _contractNotifyUrl);

                    /**
                     * 判断参数 ContractNotifyUrl 是否已赋值
                     * @return ContractNotifyUrl 是否已赋值
                     * 
                     */
                    bool ContractNotifyUrlHasBeenSet() const;
...
注：接入银行或其他支付渠道服务商模式下，必传
                     * 
                     */
                    std::vector<ContractOrderInSubOrder> GetSubOrderList() const;
...
注：接入银行或其他支付渠道服务商模式下，必传
                     * 
                     */
                    void SetSubOrderList(const std::vector<ContractOrderInSubOrder>& _subOrderList);
...
缺省: release
                    ...
                    /**
                     * 获取传入调用方在Midas注册签约信息时获得的ContractSceneId。若未在Midas注册签约信息，则传入ExternalContractData。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
                    ...
                    /**
                     * 设置传入调用方在Midas注册签约信息时获得的ContractSceneId。若未在Midas注册签约信息，则传入ExternalContractData。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
                    ...
                    /**
                     * 获取需要按照各个渠道的扩展签约信息规范组装好该字段。若未在Midas注册签约信息，则传入该字段。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
                    ...
                    /**
                     * 设置需要按照各个渠道的扩展签约信息规范组装好该字段。若未在Midas注册签约信息，则传入该字段。注意：ContractSceneId与ExternalContractData必须二选一传入其中一个
                    ...
                    /**
                     * 获取外部签约协议号，唯一标记一个签约关系。仅支持数字、字母、下划线（_）、横杠字符（-）、点（.）的组合
                    ...
                    /**
                     * 设置外部签约协议号，唯一标记一个签约关系。仅支持数字、字母、下划线（_）、横杠字符（-）、点（.）的组合
                     ...
                     * 
                     */
                    std::string GetAttachData() const;
                     ...
                     * 
                     */
                    void SetAttachData(const std::string& _attachData);

                    /**
                     * 判断参数 AttachData 是否已赋值
                     * @return AttachData 是否已赋值
                     * 
                     */
                    bool AttachDataHasBeenSet() const;

                    /**
                     * 获取展示用的签约用户名称，若不传入时，默认取UserId
                     * @return ContractDisplayName 展示用的签约用户名称，若不传入时，默认取UserId
                     * 
                     */
                    std::string GetContractDisplayName() const;

                    /**
                     * 设置展示用的签约用户名称，若不传入时，默认取UserId
                     * @param _contractDisplayName 展示用的签约用户名称，若不传入时，默认取UserId
                     * 
                     */
                    void SetContractDisplayName(const std::string& _contractDisplayName);

                    /**
                     * 判断参数 ContractDisplayName 是否已赋值
                     * @return ContractDisplayName 是否已赋值
                     * 
                     */
                    bool ContractDisplayNameHasBeenSet() const;
                ...
                private:
                     ...
                     * 签约通知地址
                     */
                    std::string m_contractNotifyUrl;
                    bool m_contractNotifyUrlHasBeenSet;
...
注：接入银行或其他支付渠道服务商模式下，必传
                     */
                    std::vector<ContractOrderInSubOrder> m_subOrderList;
...
缺省: release
                     ...
                     * 透传给第三方渠道的附加数据
                     */
                    std::string m_attachData;
                    bool m_attachDataHasBeenSet;

                    /**
                     * 展示用的签约用户名称，若不传入时，默认取UserId
                     */
                    std::string m_contractDisplayName;
                    bool m_contractDisplayNameHasBeenSet;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_CONTRACTORDERREQUEST_H_
