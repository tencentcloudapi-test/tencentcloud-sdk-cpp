...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYFLEXPAYMENTORDERLISTREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYFLEXPAYMENTORDERLISTREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryFlexPaymentOrderListRequest : public AbstractModel
                {
                public:
                    QueryFlexPaymentOrderListRequest();
                    ~QueryFlexPaymentOrderListRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYFLEXPAYMENTORDERLISTREQUEST_H_
