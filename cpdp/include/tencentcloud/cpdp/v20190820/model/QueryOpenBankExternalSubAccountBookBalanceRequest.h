...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKEXTERNALSUBACCOUNTBOOKBALANCEREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKEXTERNALSUBACCOUNTBOOKBALANCEREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryOpenBankExternalSubAccountBookBalanceRequest : public AbstractModel
                {
                public:
                    QueryOpenBankExternalSubAccountBookBalanceRequest();
                    ~QueryOpenBankExternalSubAccountBookBalanceRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKEXTERNALSUBACCOUNTBOOKBALANCEREQUEST_H_
