...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEOPENBANKUNIFIEDORDERRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEOPENBANKUNIFIEDORDERRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class CreateOpenBankUnifiedOrderResponse : public AbstractModel
                {
                public:
                    CreateOpenBankUnifiedOrderResponse();
                    ~CreateOpenBankUnifiedOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEOPENBANKUNIFIEDORDERRESPONSE_H_
