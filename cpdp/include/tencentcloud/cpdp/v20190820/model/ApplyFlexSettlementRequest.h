...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_APPLYFLEXSETTLEMENTREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_APPLYFLEXSETTLEMENTREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class ApplyFlexSettlementRequest : public AbstractModel
                {
                public:
                    ApplyFlexSettlementRequest();
                    ~ApplyFlexSettlementRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_APPLYFLEXSETTLEMENTREQUEST_H_
