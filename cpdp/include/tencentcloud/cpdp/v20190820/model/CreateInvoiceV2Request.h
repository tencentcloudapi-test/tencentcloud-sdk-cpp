...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEINVOICEV2REQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEINVOICEV2REQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class CreateInvoiceV2Request : public AbstractModel
                {
                public:
                    CreateInvoiceV2Request();
                    ~CreateInvoiceV2Request() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEINVOICEV2REQUEST_H_
