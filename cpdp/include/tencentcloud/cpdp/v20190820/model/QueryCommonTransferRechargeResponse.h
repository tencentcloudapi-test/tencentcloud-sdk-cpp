...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCOMMONTRANSFERRECHARGERESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCOMMONTRANSFERRECHARGERESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryCommonTransferRechargeResponse : public AbstractModel
                {
                public:
                    QueryCommonTransferRechargeResponse();
                    ~QueryCommonTransferRechargeResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TransferItem> GetTranItemArray() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TransferItem> m_tranItemArray;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCOMMONTRANSFERRECHARGERESPONSE_H_
