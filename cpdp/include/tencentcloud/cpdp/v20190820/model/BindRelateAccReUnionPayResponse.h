...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_BINDRELATEACCREUNIONPAYRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_BINDRELATEACCREUNIONPAYRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class BindRelateAccReUnionPayResponse : public AbstractModel
                {
                public:
                    BindRelateAccReUnionPayResponse();
                    ~BindRelateAccReUnionPayResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_BINDRELATEACCREUNIONPAYRESPONSE_H_
