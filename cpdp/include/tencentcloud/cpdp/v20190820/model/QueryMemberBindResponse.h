...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMEMBERBINDRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMEMBERBINDRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryMemberBindResponse : public AbstractModel
                {
                public:
                    QueryMemberBindResponse();
                    ~QueryMemberBindResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TranItem> GetTranItemArray() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TranItem> m_tranItemArray;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYMEMBERBINDRESPONSE_H_
