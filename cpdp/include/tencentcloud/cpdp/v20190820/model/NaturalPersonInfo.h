...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_NATURALPERSONINFO_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_NATURALPERSONINFO_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * 自然人信息
                */
                class NaturalPersonInfo : public AbstractModel
                {
                public:
                    NaturalPersonInfo();
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_NATURALPERSONINFO_H_
