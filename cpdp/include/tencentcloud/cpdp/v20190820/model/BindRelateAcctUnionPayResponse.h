...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_BINDRELATEACCTUNIONPAYRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_BINDRELATEACCTUNIONPAYRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class BindRelateAcctUnionPayResponse : public AbstractModel
                {
                public:
                    BindRelateAcctUnionPayResponse();
                    ~BindRelateAcctUnionPayResponse() = default;
                    CoreInternalOutcome Deserialize(const std::string &payload);
                    std::string ToJsonString() const;


                    /**
                     * 获取STRING(1027)，保留域（在同名子账户绑定的场景下，若返回"VERIFIED"则说明无需验证直接绑定成功）
注意：此字段可能返回 null，表示取不到有效值。
                     * @return ReservedMsg STRING(1027)，保留域（在同名子账户绑定的场景下，若返回"VERIFIED"则说明无需验证直接绑定成功）
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_BINDRELATEACCTUNIONPAYRESPONSE_H_
