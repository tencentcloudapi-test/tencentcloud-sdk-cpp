...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTPAYFEEREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTPAYFEEREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryContractPayFeeRequest : public AbstractModel
                {
                public:
                    QueryContractPayFeeRequest();
                    ~QueryContractPayFeeRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTPAYFEEREQUEST_H_
