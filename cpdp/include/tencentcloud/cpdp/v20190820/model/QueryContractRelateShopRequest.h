...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTRELATESHOPREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTRELATESHOPREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryContractRelateShopRequest : public AbstractModel
                {
                public:
                    QueryContractRelateShopRequest();
                    ~QueryContractRelateShopRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTRELATESHOPREQUEST_H_
