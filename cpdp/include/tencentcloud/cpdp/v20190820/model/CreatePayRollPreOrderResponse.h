...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEPAYROLLPREORDERRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEPAYROLLPREORDERRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class CreatePayRollPreOrderResponse : public AbstractModel
                {
                public:
                    CreatePayRollPreOrderResponse();
                    ~CreatePayRollPreOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEPAYROLLPREORDERRESPONSE_H_
