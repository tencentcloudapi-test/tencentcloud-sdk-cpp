...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_REVISEMBRPROPERTYRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_REVISEMBRPROPERTYRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class ReviseMbrPropertyResponse : public AbstractModel
                {
                public:
                    ReviseMbrPropertyResponse();
                    ~ReviseMbrPropertyResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_REVISEMBRPROPERTYRESPONSE_H_
