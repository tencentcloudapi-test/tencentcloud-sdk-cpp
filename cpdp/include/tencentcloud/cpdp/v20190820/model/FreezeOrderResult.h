...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_FREEZEORDERRESULT_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_FREEZEORDERRESULT_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * 冻结单结果
                */
                class FreezeOrderResult : public AbstractModel
                {
                public:
                    FreezeOrderResult();
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_FREEZEORDERRESULT_H_
