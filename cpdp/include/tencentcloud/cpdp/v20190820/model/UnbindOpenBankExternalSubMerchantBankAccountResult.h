...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_UNBINDOPENBANKEXTERNALSUBMERCHANTBANKACCOUNTRESULT_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_UNBINDOPENBANKEXTERNALSUBMERCHANTBANKACCOUNTRESULT_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * 第三方子商户银行卡解绑返回结果
                */
                class UnbindOpenBankExternalSubMerchantBankAccountResult : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_UNBINDOPENBANKEXTERNALSUBMERCHANTBANKACCOUNTRESULT_H_
