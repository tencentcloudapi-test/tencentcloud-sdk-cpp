...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_CHECKAMOUNTRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_CHECKAMOUNTRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * CheckAmount返回参数结构体
                */
                class CheckAmountResponse : public AbstractModel
                {
                public:
                    CheckAmountResponse();
                    ~CheckAmountResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_CHECKAMOUNTRESPONSE_H_
