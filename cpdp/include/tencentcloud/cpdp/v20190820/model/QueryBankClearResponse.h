...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKCLEARRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKCLEARRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryBankClearResponse : public AbstractModel
                {
                public:
                    QueryBankClearResponse();
                    ~QueryBankClearResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ClearItem> GetTranItemArray() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ClearItem> m_tranItemArray;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYBANKCLEARRESPONSE_H_
