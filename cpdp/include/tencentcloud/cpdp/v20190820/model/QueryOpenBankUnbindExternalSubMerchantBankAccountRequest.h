...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKUNBINDEXTERNALSUBMERCHANTBANKACCOUNTREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKUNBINDEXTERNALSUBMERCHANTBANKACCOUNTREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryOpenBankUnbindExternalSubMerchantBankAccountRequest : public AbstractModel
                {
                public:
                    QueryOpenBankUnbindExternalSubMerchantBankAccountRequest();
                    ~QueryOpenBankUnbindExternalSubMerchantBankAccountRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKUNBINDEXTERNALSUBMERCHANTBANKACCOUNTREQUEST_H_
