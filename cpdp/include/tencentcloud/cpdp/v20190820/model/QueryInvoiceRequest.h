...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYINVOICEREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYINVOICEREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * QueryInvoice请求参数结构体
                */
                class QueryInvoiceRequest : public AbstractModel
                {
                public:
                    QueryInvoiceRequest();
                    ~QueryInvoiceRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYINVOICEREQUEST_H_
