...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_MODIFYMNTMBRBINDRELATEACCTBANKCODERESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_MODIFYMNTMBRBINDRELATEACCTBANKCODERESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class ModifyMntMbrBindRelateAcctBankCodeResponse : public AbstractModel
                {
                public:
                    ModifyMntMbrBindRelateAcctBankCodeResponse();
                    ~ModifyMntMbrBindRelateAcctBankCodeResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_MODIFYMNTMBRBINDRELATEACCTBANKCODERESPONSE_H_
