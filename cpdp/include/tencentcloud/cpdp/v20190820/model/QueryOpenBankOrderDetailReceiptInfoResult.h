...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKORDERDETAILRECEIPTINFORESULT_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKORDERDETAILRECEIPTINFORESULT_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                * 单笔交易回单申请结果查询
                */
                class QueryOpenBankOrderDetailReceiptInfoResult : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYOPENBANKORDERDETAILRECEIPTINFORESULT_H_
