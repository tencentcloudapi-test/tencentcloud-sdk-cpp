...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEPAYROLLTOKENRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEPAYROLLTOKENRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class CreatePayRollTokenResponse : public AbstractModel
                {
                public:
                    CreatePayRollTokenResponse();
                    ~CreatePayRollTokenResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEPAYROLLTOKENRESPONSE_H_
