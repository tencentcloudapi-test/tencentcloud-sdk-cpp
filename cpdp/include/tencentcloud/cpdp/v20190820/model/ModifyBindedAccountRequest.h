...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_MODIFYBINDEDACCOUNTREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_MODIFYBINDEDACCOUNTREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class ModifyBindedAccountRequest : public AbstractModel
                {
                public:
                    ModifyBindedAccountRequest();
                    ~ModifyBindedAccountRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_MODIFYBINDEDACCOUNTREQUEST_H_
