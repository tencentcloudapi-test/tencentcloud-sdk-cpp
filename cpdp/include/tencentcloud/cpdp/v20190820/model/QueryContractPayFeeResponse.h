...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTPAYFEERESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTPAYFEERESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryContractPayFeeResponse : public AbstractModel
                {
                public:
                    QueryContractPayFeeResponse();
                    ~QueryContractPayFeeResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    /**
                     * 获取查询支付方式费率及自定义表单项响应对象
注意：此字段可能返回 null，表示取不到有效值。
                     * @return Result 查询支付方式费率及自定义表单项响应对象
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    QueryContractPayFeeResult GetResult() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    QueryContractPayFeeResult m_result;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYCONTRACTPAYFEERESPONSE_H_
