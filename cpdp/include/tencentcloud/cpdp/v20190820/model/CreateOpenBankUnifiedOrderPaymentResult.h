...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEOPENBANKUNIFIEDORDERPAYMENTRESULT_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEOPENBANKUNIFIEDORDERPAYMENTRESULT_H_
...
namespace TencentCloud
{
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                class OpenBankOrderRedirectInfo;

                /**
                * 云企付-支付下单返回响应
                */
                class CreateOpenBankUnifiedOrderPaymentResult : public AbstractModel
                {
                public:
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    OpenBankOrderRedirectInfo m_redirectInfo;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_CREATEOPENBANKUNIFIEDORDERPAYMENTRESULT_H_
