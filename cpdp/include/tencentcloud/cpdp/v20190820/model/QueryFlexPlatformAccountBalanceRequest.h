...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYFLEXPLATFORMACCOUNTBALANCEREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYFLEXPLATFORMACCOUNTBALANCEREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class QueryFlexPlatformAccountBalanceRequest : public AbstractModel
                {
                public:
                    QueryFlexPlatformAccountBalanceRequest();
                    ~QueryFlexPlatformAccountBalanceRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_QUERYFLEXPLATFORMACCOUNTBALANCEREQUEST_H_
