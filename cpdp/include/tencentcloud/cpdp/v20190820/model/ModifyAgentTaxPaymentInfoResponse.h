...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_MODIFYAGENTTAXPAYMENTINFORESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_MODIFYAGENTTAXPAYMENTINFORESPONSE_H_
...
namespace TencentCloud
{
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                class AgentTaxPaymentBatch;

                /**
                * ModifyAgentTaxPaymentInfo返回参数结构体
                */
                class ModifyAgentTaxPaymentInfoResponse : public AbstractModel
                {
                public:
                    ModifyAgentTaxPaymentInfoResponse();
                    ~ModifyAgentTaxPaymentInfoResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_MODIFYAGENTTAXPAYMENTINFORESPONSE_H_
