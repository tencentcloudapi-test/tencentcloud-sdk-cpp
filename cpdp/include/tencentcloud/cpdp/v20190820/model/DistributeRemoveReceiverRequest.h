...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_DISTRIBUTEREMOVERECEIVERREQUEST_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_DISTRIBUTEREMOVERECEIVERREQUEST_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class DistributeRemoveReceiverRequest : public AbstractModel
                {
                public:
                    DistributeRemoveReceiverRequest();
                    ~DistributeRemoveReceiverRequest() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_DISTRIBUTEREMOVERECEIVERREQUEST_H_
