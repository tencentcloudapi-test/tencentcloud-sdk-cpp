...
#ifndef TENCENTCLOUD_CPDP_V20190820_MODEL_REVOKEMEMBERRECHARGETHIRDPAYRESPONSE_H_
#define TENCENTCLOUD_CPDP_V20190820_MODEL_REVOKEMEMBERRECHARGETHIRDPAYRESPONSE_H_
    ...
    namespace Cpdp
    {
        namespace V20190820
        {
            namespace Model
            {
                ...
                */
                class RevokeMemberRechargeThirdPayResponse : public AbstractModel
                {
                public:
                    RevokeMemberRechargeThirdPayResponse();
                    ~RevokeMemberRechargeThirdPayResponse() = default;
...
#endif // !TENCENTCLOUD_CPDP_V20190820_MODEL_REVOKEMEMBERRECHARGETHIRDPAYRESPONSE_H_
