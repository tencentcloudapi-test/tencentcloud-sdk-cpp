...
#ifndef TENCENTCLOUD_CCC_V20200210_MODEL_CREATECOMPANYAPPLYREQUEST_H_
#define TENCENTCLOUD_CCC_V20200210_MODEL_CREATECOMPANYAPPLYREQUEST_H_
...
namespace TencentCloud
{
    namespace Ccc
    {
        namespace V20200210
        {
            namespace Model
            {
                class CompanyApplyInfo;

                /**
                * CreateCompanyApply请求参数结构体
                */
                class CreateCompanyApplyRequest : public AbstractModel
                {
                public:
                    CreateCompanyApplyRequest();
                    ~CreateCompanyApplyRequest() = default;
...
#endif // !TENCENTCLOUD_CCC_V20200210_MODEL_CREATECOMPANYAPPLYREQUEST_H_
