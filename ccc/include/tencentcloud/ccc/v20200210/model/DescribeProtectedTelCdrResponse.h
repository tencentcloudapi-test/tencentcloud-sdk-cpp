...
#ifndef TENCENTCLOUD_CCC_V20200210_MODEL_DESCRIBEPROTECTEDTELCDRRESPONSE_H_
#define TENCENTCLOUD_CCC_V20200210_MODEL_DESCRIBEPROTECTEDTELCDRRESPONSE_H_
    ...
    namespace Ccc
    {
        namespace V20200210
        {
            namespace Model
            {
                ...
                */
                class DescribeProtectedTelCdrResponse : public AbstractModel
                {
                public:
                    DescribeProtectedTelCdrResponse();
                    ~DescribeProtectedTelCdrResponse() = default;
...
#endif // !TENCENTCLOUD_CCC_V20200210_MODEL_DESCRIBEPROTECTEDTELCDRRESPONSE_H_
