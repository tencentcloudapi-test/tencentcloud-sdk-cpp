...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBECLIENTLISTRESPONSE_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBECLIENTLISTRESPONSE_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DescribeClientListResponse : public AbstractModel
                {
                public:
                    DescribeClientListResponse();
                    ~DescribeClientListResponse() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBECLIENTLISTRESPONSE_H_
