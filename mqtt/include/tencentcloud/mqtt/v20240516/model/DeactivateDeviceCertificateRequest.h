...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DEACTIVATEDEVICECERTIFICATEREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DEACTIVATEDEVICECERTIFICATEREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DeactivateDeviceCertificateRequest : public AbstractModel
                {
                public:
                    DeactivateDeviceCertificateRequest();
                    ~DeactivateDeviceCertificateRequest() = default;
                    ...
                    /**
                     * 获取设备证书的SN序列号，可以从 [DescribeDeviceCertificates](https://cloud.tencent.com/document/api/1778/116206)接口、控制台、设备证书文件中获得。
                     * @return DeviceCertificateSn 设备证书的SN序列号，可以从 [DescribeDeviceCertificates](https://cloud.tencent.com/document/api/1778/116206)接口、控制台、设备证书文件中获得。
                     * 
                     */
                    std::string GetDeviceCertificateSn() const;

                    /**
                     * 设置设备证书的SN序列号，可以从 [DescribeDeviceCertificates](https://cloud.tencent.com/document/api/1778/116206)接口、控制台、设备证书文件中获得。
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DEACTIVATEDEVICECERTIFICATEREQUEST_H_
