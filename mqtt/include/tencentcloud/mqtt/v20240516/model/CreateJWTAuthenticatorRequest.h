...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_CREATEJWTAUTHENTICATORREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_CREATEJWTAUTHENTICATORREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class CreateJWTAuthenticatorRequest : public AbstractModel
                {
                public:
                    CreateJWTAuthenticatorRequest();
                    ~CreateJWTAuthenticatorRequest() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_CREATEJWTAUTHENTICATORREQUEST_H_
