...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEINSPUBLICENDPOINTSRESPONSE_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEINSPUBLICENDPOINTSRESPONSE_H_
...
namespace TencentCloud
{
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                class MQTTEndpointItem;
                class PublicAccessRule;

                /**
                * DescribeInsPublicEndpoints返回参数结构体
                */
                class DescribeInsPublicEndpointsResponse : public AbstractModel
                {
                public:
                    DescribeInsPublicEndpointsResponse();
                    ~DescribeInsPublicEndpointsResponse() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBEINSPUBLICENDPOINTSRESPONSE_H_
