...
#ifndef TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBECLIENTLISTREQUEST_H_
#define TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBECLIENTLISTREQUEST_H_
    ...
    namespace Mqtt
    {
        namespace V20240516
        {
            namespace Model
            {
                ...
                */
                class DescribeClientListRequest : public AbstractModel
                {
                public:
                    DescribeClientListRequest();
                    ~DescribeClientListRequest() = default;
...
#endif // !TENCENTCLOUD_MQTT_V20240516_MODEL_DESCRIBECLIENTLISTREQUEST_H_
