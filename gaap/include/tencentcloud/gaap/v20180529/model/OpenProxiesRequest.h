...
#ifndef TENCENTCLOUD_GAAP_V20180529_MODEL_OPENPROXIESREQUEST_H_
#define TENCENTCLOUD_GAAP_V20180529_MODEL_OPENPROXIESREQUEST_H_
    ...
    namespace Gaap
    {
        namespace V20180529
        {
            namespace Model
            {
                ...
                * OpenProxies请求参数结构体
                */
                class OpenProxiesRequest : public AbstractModel
                {
                public:
                    OpenProxiesRequest();
                    ~OpenProxiesRequest() = default;
...
#endif // !TENCENTCLOUD_GAAP_V20180529_MODEL_OPENPROXIESREQUEST_H_
