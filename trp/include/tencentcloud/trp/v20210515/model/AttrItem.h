...
#ifndef TENCENTCLOUD_TRP_V20210515_MODEL_ATTRITEM_H_
#define TENCENTCLOUD_TRP_V20210515_MODEL_ATTRITEM_H_
...
- Type: "mp" 小程序类型, 对应配置 Values: ["WXAPPID", "WXAPP_PATH", "跳转说明"]
                */
                class AttrItem : public AbstractModel
                {
                public:
                    AttrItem();
...
#endif // !TENCENTCLOUD_TRP_V20210515_MODEL_ATTRITEM_H_
