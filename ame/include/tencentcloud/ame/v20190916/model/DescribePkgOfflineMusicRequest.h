...
#ifndef TENCENTCLOUD_AME_V20190916_MODEL_DESCRIBEPKGOFFLINEMUSICREQUEST_H_
#define TENCENTCLOUD_AME_V20190916_MODEL_DESCRIBEPKGOFFLINEMUSICREQUEST_H_
    ...
    namespace Ame
    {
        namespace V20190916
        {
            namespace Model
            {
                ...
                */
                class DescribePkgOfflineMusicRequest : public AbstractModel
                {
                public:
                    DescribePkgOfflineMusicRequest();
                    ~DescribePkgOfflineMusicRequest() = default;
                ...
                private:
                     ...
                     * 订单id
                     */
                    std::string m_packageOrderId;
                    bool m_packageOrderIdHasBeenSet;
...
#endif // !TENCENTCLOUD_AME_V20190916_MODEL_DESCRIBEPKGOFFLINEMUSICREQUEST_H_
