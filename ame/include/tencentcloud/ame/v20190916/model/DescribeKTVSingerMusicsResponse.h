...
#ifndef TENCENTCLOUD_AME_V20190916_MODEL_DESCRIBEKTVSINGERMUSICSRESPONSE_H_
#define TENCENTCLOUD_AME_V20190916_MODEL_DESCRIBEKTVSINGERMUSICSRESPONSE_H_
    ...
    namespace Ame
    {
        namespace V20190916
        {
            namespace Model
            {
                ...
                */
                class DescribeKTVSingerMusicsResponse : public AbstractModel
                {
                public:
                    DescribeKTVSingerMusicsResponse();
                    ~DescribeKTVSingerMusicsResponse() = default;
...
#endif // !TENCENTCLOUD_AME_V20190916_MODEL_DESCRIBEKTVSINGERMUSICSRESPONSE_H_
