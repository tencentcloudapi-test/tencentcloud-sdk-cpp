...
#ifndef TENCENTCLOUD_AME_V20190916_MODEL_DESCRIBEITEMSRESPONSE_H_
#define TENCENTCLOUD_AME_V20190916_MODEL_DESCRIBEITEMSRESPONSE_H_
    ...
    namespace Ame
    {
        namespace V20190916
        {
            namespace Model
            {
                ...
                */
                class DescribeItemsResponse : public AbstractModel
                {
                public:
                    DescribeItemsResponse();
                    ~DescribeItemsResponse() = default;
...
#endif // !TENCENTCLOUD_AME_V20190916_MODEL_DESCRIBEITEMSRESPONSE_H_
