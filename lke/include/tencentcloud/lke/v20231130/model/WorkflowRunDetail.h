...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_WORKFLOWRUNDETAIL_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_WORKFLOWRUNDETAIL_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                * 工作流运行实例详情
                */
                class WorkflowRunDetail : public AbstractModel
                {
                public:
                    WorkflowRunDetail();
                    ...
                    /**
                     * 获取主模型名称
                     * @return MainModelName 主模型名称
                     * 
                     */
                    std::string GetMainModelName() const;
                     ...
                     * 
                     */
                    void SetMainModelName(const std::string& _mainModelName);

                    /**
                     * 判断参数 MainModelName 是否已赋值
                     * @return MainModelName 是否已赋值
                     * 
                     */
                    bool MainModelNameHasBeenSet() const;
                ...
                private:
                     ...
                     * 工作流画布Json
                     */
                    std::string m_dialogJson;
                    bool m_dialogJsonHasBeenSet;
                    ...
                    bool m_mainModelNameHasBeenSet;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_WORKFLOWRUNDETAIL_H_
