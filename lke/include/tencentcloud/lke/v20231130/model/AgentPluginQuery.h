...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_AGENTPLUGINQUERY_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_AGENTPLUGINQUERY_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                * 应用配置MCP插件query信息
                */
                class AgentPluginQuery : public AbstractModel
                {
                public:
                    AgentPluginQuery();
                    ...
                    /**
                     * 获取query参数配置是否隐藏不可见，true-隐藏不可见，false-可见
                    ...
                    /**
                     * 设置query参数配置是否隐藏不可见，true-隐藏不可见，false-可见
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_AGENTPLUGINQUERY_H_
