...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_QACATE_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_QACATE_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                * 获取QA分类分组
                */
                class QACate : public AbstractModel
                {
                public:
                    QACate();
                    ~QACate() = default;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_QACATE_H_
