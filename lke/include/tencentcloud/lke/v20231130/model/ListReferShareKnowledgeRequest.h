...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_LISTREFERSHAREKNOWLEDGEREQUEST_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_LISTREFERSHAREKNOWLEDGEREQUEST_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                */
                class ListReferShareKnowledgeRequest : public AbstractModel
                {
                public:
                    ListReferShareKnowledgeRequest();
                    ~ListReferShareKnowledgeRequest() = default;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_LISTREFERSHAREKNOWLEDGEREQUEST_H_
