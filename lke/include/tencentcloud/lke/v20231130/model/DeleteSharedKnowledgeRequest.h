...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_DELETESHAREDKNOWLEDGEREQUEST_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_DELETESHAREDKNOWLEDGEREQUEST_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                */
                class DeleteSharedKnowledgeRequest : public AbstractModel
                {
                public:
                    DeleteSharedKnowledgeRequest();
                    ~DeleteSharedKnowledgeRequest() = default;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_DELETESHAREDKNOWLEDGEREQUEST_H_
