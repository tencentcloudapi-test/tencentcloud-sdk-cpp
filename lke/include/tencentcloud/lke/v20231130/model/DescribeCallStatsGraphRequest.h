...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_DESCRIBECALLSTATSGRAPHREQUEST_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_DESCRIBECALLSTATSGRAPHREQUEST_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                */
                class DescribeCallStatsGraphRequest : public AbstractModel
                {
                public:
                    DescribeCallStatsGraphRequest();
                    ~DescribeCallStatsGraphRequest() = default;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_DESCRIBECALLSTATSGRAPHREQUEST_H_
