...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_DELETEDOCCATEREQUEST_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_DELETEDOCCATEREQUEST_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                */
                class DeleteDocCateRequest : public AbstractModel
                {
                public:
                    DeleteDocCateRequest();
                    ~DeleteDocCateRequest() = default;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_DELETEDOCCATEREQUEST_H_
