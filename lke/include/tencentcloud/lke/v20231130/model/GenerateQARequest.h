...
#ifndef TENCENTCLOUD_LKE_V20231130_MODEL_GENERATEQAREQUEST_H_
#define TENCENTCLOUD_LKE_V20231130_MODEL_GENERATEQAREQUEST_H_
    ...
    namespace Lke
    {
        namespace V20231130
        {
            namespace Model
            {
                ...
                * GenerateQA请求参数结构体
                */
                class GenerateQARequest : public AbstractModel
                {
                public:
                    GenerateQARequest();
                    ~GenerateQARequest() = default;
...
#endif // !TENCENTCLOUD_LKE_V20231130_MODEL_GENERATEQAREQUEST_H_
