...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DELETEHTTPSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DELETEHTTPSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                * DeleteHttps请求参数结构体
                */
                class DeleteHttpsRequest : public AbstractModel
                {
                public:
                    DeleteHttpsRequest();
                    ~DeleteHttpsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DELETEHTTPSREQUEST_H_
