...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEWECHATAPPLETSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEWECHATAPPLETSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeWechatAppletsRequest : public AbstractModel
                {
                public:
                    DescribeWechatAppletsRequest();
                    ~DescribeWechatAppletsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEWECHATAPPLETSREQUEST_H_
