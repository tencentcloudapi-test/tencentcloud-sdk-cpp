...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEAPISECSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEAPISECSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeApiSecsRequest : public AbstractModel
                {
                public:
                    DescribeApiSecsRequest();
                    ~DescribeApiSecsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEAPISECSREQUEST_H_
