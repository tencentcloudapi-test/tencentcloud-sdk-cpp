...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DELETEPORTSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DELETEPORTSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                * DeletePorts请求参数结构体
                */
                class DeletePortsRequest : public AbstractModel
                {
                public:
                    DeletePortsRequest();
                    ~DeletePortsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DELETEPORTSREQUEST_H_
