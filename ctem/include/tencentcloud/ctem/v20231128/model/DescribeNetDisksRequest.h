...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBENETDISKSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBENETDISKSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeNetDisksRequest : public AbstractModel
                {
                public:
                    DescribeNetDisksRequest();
                    ~DescribeNetDisksRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBENETDISKSREQUEST_H_
