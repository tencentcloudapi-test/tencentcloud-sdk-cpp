...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBESUBDOMAINSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBESUBDOMAINSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeSubDomainsRequest : public AbstractModel
                {
                public:
                    DescribeSubDomainsRequest();
                    ~DescribeSubDomainsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBESUBDOMAINSREQUEST_H_
