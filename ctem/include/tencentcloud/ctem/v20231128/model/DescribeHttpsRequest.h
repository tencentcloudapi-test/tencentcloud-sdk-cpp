...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEHTTPSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEHTTPSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeHttpsRequest : public AbstractModel
                {
                public:
                    DescribeHttpsRequest();
                    ~DescribeHttpsRequest() = default;
                    ...
                    /**
                     * 获取是否显示变更
                     * @return IsShowChange 是否显示变更
                     * 
                     */
                    bool GetIsShowChange() const;
                     ...
                     * 
                     */
                    void SetIsShowChange(const bool& _isShowChange);

                    /**
                     * 判断参数 IsShowChange 是否已赋值
                     * @return IsShowChange 是否已赋值
                     * 
                     */
                    bool IsShowChangeHasBeenSet() const;

                    /**
                     * 获取是否仅显示过期风险资产
                     * @return HasExpirationRisk 是否仅显示过期风险资产
                     * 
                     */
                    bool GetHasExpirationRisk() const;
                     ...
                     * 
                     */
                    void SetHasExpirationRisk(const bool& _hasExpirationRisk);

                    /**
                     * 判断参数 HasExpirationRisk 是否已赋值
                     * @return HasExpirationRisk 是否已赋值
                     * 
                     */
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEHTTPSREQUEST_H_
