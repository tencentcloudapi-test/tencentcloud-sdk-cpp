...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBELEAKAGEEMAILSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBELEAKAGEEMAILSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeLeakageEmailsRequest : public AbstractModel
                {
                public:
                    DescribeLeakageEmailsRequest();
                    ~DescribeLeakageEmailsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBELEAKAGEEMAILSREQUEST_H_
