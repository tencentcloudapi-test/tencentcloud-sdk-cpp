...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEWEAKPASSWORDSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEWEAKPASSWORDSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeWeakPasswordsRequest : public AbstractModel
                {
                public:
                    DescribeWeakPasswordsRequest();
                    ~DescribeWeakPasswordsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEWEAKPASSWORDSREQUEST_H_
