...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DISPLAYFAKEWEBSITE_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DISPLAYFAKEWEBSITE_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                * 仿冒网站详情
                */
                class DisplayFakeWebsite : public AbstractModel
                {
                public:
                    DisplayFakeWebsite();
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DISPLAYFAKEWEBSITE_H_
