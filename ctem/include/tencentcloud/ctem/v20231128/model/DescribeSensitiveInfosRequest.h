...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBESENSITIVEINFOSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBESENSITIVEINFOSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeSensitiveInfosRequest : public AbstractModel
                {
                public:
                    DescribeSensitiveInfosRequest();
                    ~DescribeSensitiveInfosRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBESENSITIVEINFOSREQUEST_H_
