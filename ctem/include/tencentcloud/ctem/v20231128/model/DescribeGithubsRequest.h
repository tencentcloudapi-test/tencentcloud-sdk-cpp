...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEGITHUBSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEGITHUBSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeGithubsRequest : public AbstractModel
                {
                public:
                    DescribeGithubsRequest();
                    ~DescribeGithubsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEGITHUBSREQUEST_H_
