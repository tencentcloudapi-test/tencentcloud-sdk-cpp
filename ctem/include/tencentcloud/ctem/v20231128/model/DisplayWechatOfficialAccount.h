...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DISPLAYWECHATOFFICIALACCOUNT_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DISPLAYWECHATOFFICIALACCOUNT_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                * 微信公众号详情
                */
                class DisplayWechatOfficialAccount : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DISPLAYWECHATOFFICIALACCOUNT_H_
