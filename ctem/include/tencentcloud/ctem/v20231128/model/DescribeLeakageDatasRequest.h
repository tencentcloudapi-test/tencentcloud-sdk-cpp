...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBELEAKAGEDATASREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBELEAKAGEDATASREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeLeakageDatasRequest : public AbstractModel
                {
                public:
                    DescribeLeakageDatasRequest();
                    ~DescribeLeakageDatasRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBELEAKAGEDATASREQUEST_H_
