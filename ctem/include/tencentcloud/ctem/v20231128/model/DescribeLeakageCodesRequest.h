...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBELEAKAGECODESREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBELEAKAGECODESREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeLeakageCodesRequest : public AbstractModel
                {
                public:
                    DescribeLeakageCodesRequest();
                    ~DescribeLeakageCodesRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBELEAKAGECODESREQUEST_H_
