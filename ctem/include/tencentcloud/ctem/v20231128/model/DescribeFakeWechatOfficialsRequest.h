...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEFAKEWECHATOFFICIALSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEFAKEWECHATOFFICIALSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DescribeFakeWechatOfficialsRequest : public AbstractModel
                {
                public:
                    DescribeFakeWechatOfficialsRequest();
                    ~DescribeFakeWechatOfficialsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DESCRIBEFAKEWECHATOFFICIALSREQUEST_H_
