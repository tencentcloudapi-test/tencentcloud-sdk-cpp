...
#ifndef TENCENTCLOUD_CTEM_V20231128_MODEL_DELETESUBDOMAINSREQUEST_H_
#define TENCENTCLOUD_CTEM_V20231128_MODEL_DELETESUBDOMAINSREQUEST_H_
    ...
    namespace Ctem
    {
        namespace V20231128
        {
            namespace Model
            {
                ...
                */
                class DeleteSubDomainsRequest : public AbstractModel
                {
                public:
                    DeleteSubDomainsRequest();
                    ~DeleteSubDomainsRequest() = default;
...
#endif // !TENCENTCLOUD_CTEM_V20231128_MODEL_DELETESUBDOMAINSREQUEST_H_
