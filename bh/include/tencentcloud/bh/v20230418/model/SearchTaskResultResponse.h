...
#ifndef TENCENTCLOUD_BH_V20230418_MODEL_SEARCHTASKRESULTRESPONSE_H_
#define TENCENTCLOUD_BH_V20230418_MODEL_SEARCHTASKRESULTRESPONSE_H_
    ...
    namespace Bh
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class SearchTaskResultResponse : public AbstractModel
                {
                public:
                    SearchTaskResultResponse();
                    ~SearchTaskResultResponse() = default;
...
#endif // !TENCENTCLOUD_BH_V20230418_MODEL_SEARCHTASKRESULTRESPONSE_H_
