...
#ifndef TENCENTCLOUD_BH_V20230418_MODEL_CREATEOPERATIONTASKREQUEST_H_
#define TENCENTCLOUD_BH_V20230418_MODEL_CREATEOPERATIONTASKREQUEST_H_
    ...
    namespace Bh
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreateOperationTaskRequest : public AbstractModel
                {
                public:
                    CreateOperationTaskRequest();
                    ~CreateOperationTaskRequest() = default;
...
#endif // !TENCENTCLOUD_BH_V20230418_MODEL_CREATEOPERATIONTASKREQUEST_H_
