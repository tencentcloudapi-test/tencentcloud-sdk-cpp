...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBECONTAINERGROUPDEPLOYINFOREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBECONTAINERGROUPDEPLOYINFOREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DescribeContainerGroupDeployInfoRequest : public AbstractModel
                {
                public:
                    DescribeContainerGroupDeployInfoRequest();
                    ~DescribeContainerGroupDeployInfoRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBECONTAINERGROUPDEPLOYINFOREQUEST_H_
