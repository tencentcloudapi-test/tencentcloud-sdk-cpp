...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_STARTCONTAINERGROUPREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_STARTCONTAINERGROUPREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class StartContainerGroupRequest : public AbstractModel
                {
                public:
                    StartContainerGroupRequest();
                    ~StartContainerGroupRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_STARTCONTAINERGROUPREQUEST_H_
