...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DISABLETASKREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DISABLETASKREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                * DisableTask请求参数结构体
                */
                class DisableTaskRequest : public AbstractModel
                {
                public:
                    DisableTaskRequest();
                    ~DisableTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DISABLETASKREQUEST_H_
