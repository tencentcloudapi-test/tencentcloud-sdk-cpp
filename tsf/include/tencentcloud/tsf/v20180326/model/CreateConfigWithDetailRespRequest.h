...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_CREATECONFIGWITHDETAILRESPREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_CREATECONFIGWITHDETAILRESPREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class CreateConfigWithDetailRespRequest : public AbstractModel
                {
                public:
                    CreateConfigWithDetailRespRequest();
                    ~CreateConfigWithDetailRespRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_CREATECONFIGWITHDETAILRESPREQUEST_H_
