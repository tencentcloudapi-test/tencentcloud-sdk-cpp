...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_MODIFYGROUPLANEREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_MODIFYGROUPLANEREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class ModifyGroupLaneRequest : public AbstractModel
                {
                public:
                    ModifyGroupLaneRequest();
                    ~ModifyGroupLaneRequest() = default;
                    ...
                    /**
                     * 获取泳道部署组列表。
                     * @return LaneList 泳道部署组列表。
                     * 
                     */
                    std::vector<LaneGroup> GetLaneList() const;
                     ...
                     * 
                     */
                    void SetLaneList(const std::vector<LaneGroup>& _laneList);

                    /**
                     * 判断参数 LaneList 是否已赋值
                     * @return LaneList 是否已赋值
                     * 
                     */
                    bool LaneListHasBeenSet() const;
                ...
                private:
                     ...
                     * 泳道部署组列表。
                     */
                    std::vector<LaneGroup> m_laneList;
                    bool m_laneListHasBeenSet;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_MODIFYGROUPLANEREQUEST_H_
