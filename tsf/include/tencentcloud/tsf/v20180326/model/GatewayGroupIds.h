...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_GATEWAYGROUPIDS_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_GATEWAYGROUPIDS_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                * 网关部署组ID和网关API分组ID元组
                */
                class GatewayGroupIds : public AbstractModel
                {
                public:
                    GatewayGroupIds();
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_GATEWAYGROUPIDS_H_
