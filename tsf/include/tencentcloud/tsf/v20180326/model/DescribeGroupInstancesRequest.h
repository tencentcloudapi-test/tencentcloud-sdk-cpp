...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEGROUPINSTANCESREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEGROUPINSTANCESREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DescribeGroupInstancesRequest : public AbstractModel
                {
                public:
                    DescribeGroupInstancesRequest();
                    ~DescribeGroupInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEGROUPINSTANCESREQUEST_H_
