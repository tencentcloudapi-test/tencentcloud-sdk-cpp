...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_FORCESCHEDULE_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_FORCESCHEDULE_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                * 强制调度配置
                */
                class ForceSchedule : public AbstractModel
                {
                public:
                    ForceSchedule();
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_FORCESCHEDULE_H_
