...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_CREATEMICROSERVICEWITHDETAILRESPREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_CREATEMICROSERVICEWITHDETAILRESPREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class CreateMicroserviceWithDetailRespRequest : public AbstractModel
                {
                public:
                    CreateMicroserviceWithDetailRespRequest();
                    ~CreateMicroserviceWithDetailRespRequest() = default;
                    ...
                    /**
                     * 获取微服务名称，最多支持128个字符。
                     * @return MicroserviceName 微服务名称，最多支持128个字符。
                     * 
                     */
                    ...
                    /**
                     * 获取微服务描述信息，最多支持200个字符。
                     * @return MicroserviceDesc 微服务描述信息，最多支持200个字符。
                     * 
                     */
                    std::string GetMicroserviceDesc() const;

                    /**
                     * 设置微服务描述信息，最多支持200个字符。
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_CREATEMICROSERVICEWITHDETAILRESPREQUEST_H_
