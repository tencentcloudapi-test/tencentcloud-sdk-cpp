...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEENABLEDUNITRULEREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEENABLEDUNITRULEREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DescribeEnabledUnitRuleRequest : public AbstractModel
                {
                public:
                    DescribeEnabledUnitRuleRequest();
                    ~DescribeEnabledUnitRuleRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEENABLEDUNITRULEREQUEST_H_
