...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_CREATEUNITRULEREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_CREATEUNITRULEREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class CreateUnitRuleRequest : public AbstractModel
                {
                public:
                    CreateUnitRuleRequest();
                    ~CreateUnitRuleRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_CREATEUNITRULEREQUEST_H_
