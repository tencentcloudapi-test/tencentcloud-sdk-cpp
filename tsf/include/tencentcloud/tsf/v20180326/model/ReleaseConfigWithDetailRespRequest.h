...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_RELEASECONFIGWITHDETAILRESPREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_RELEASECONFIGWITHDETAILRESPREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class ReleaseConfigWithDetailRespRequest : public AbstractModel
                {
                public:
                    ReleaseConfigWithDetailRespRequest();
                    ~ReleaseConfigWithDetailRespRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_RELEASECONFIGWITHDETAILRESPREQUEST_H_
