...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DELETEPUBLICCONFIGREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DELETEPUBLICCONFIGREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DeletePublicConfigRequest : public AbstractModel
                {
                public:
                    DeletePublicConfigRequest();
                    ~DeletePublicConfigRequest() = default;
                     ...
                     * @param _configId 配置ID。该参数可以通过调用 [DescribePublicConfigs](https://cloud.tencent.com/document/product/649/38335) 的返回值中的 ConfigId 字段来获取或通过登录[控制台](https://console.cloud.tencent.com/tse/tsf-consul?subTab=public)配置详情-配置版本页查看；也可以调用[CreatePublicConfig](https://cloud.tencent.com/document/product/649/38347)创建新的配置。
                     * 
                     */
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DELETEPUBLICCONFIGREQUEST_H_
