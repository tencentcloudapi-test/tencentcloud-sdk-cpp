...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEIMAGEREPOSITORYREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEIMAGEREPOSITORYREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DescribeImageRepositoryRequest : public AbstractModel
                {
                public:
                    DescribeImageRepositoryRequest();
                    ~DescribeImageRepositoryRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEIMAGEREPOSITORYREQUEST_H_
