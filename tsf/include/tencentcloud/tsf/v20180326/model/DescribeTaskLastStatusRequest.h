...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBETASKLASTSTATUSREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBETASKLASTSTATUSREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DescribeTaskLastStatusRequest : public AbstractModel
                {
                public:
                    DescribeTaskLastStatusRequest();
                    ~DescribeTaskLastStatusRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBETASKLASTSTATUSREQUEST_H_
