...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DISABLELANERULEREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DISABLELANERULEREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DisableLaneRuleRequest : public AbstractModel
                {
                public:
                    DisableLaneRuleRequest();
                    ~DisableLaneRuleRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DISABLELANERULEREQUEST_H_
