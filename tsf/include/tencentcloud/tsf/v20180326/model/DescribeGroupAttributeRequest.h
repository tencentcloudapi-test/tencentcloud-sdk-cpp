...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEGROUPATTRIBUTEREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEGROUPATTRIBUTEREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DescribeGroupAttributeRequest : public AbstractModel
                {
                public:
                    DescribeGroupAttributeRequest();
                    ~DescribeGroupAttributeRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEGROUPATTRIBUTEREQUEST_H_
