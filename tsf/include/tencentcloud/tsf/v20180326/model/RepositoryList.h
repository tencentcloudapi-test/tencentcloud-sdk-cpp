...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_REPOSITORYLIST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_REPOSITORYLIST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                * 仓库列表
                */
                class RepositoryList : public AbstractModel
                {
                public:
                    RepositoryList();
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_REPOSITORYLIST_H_
