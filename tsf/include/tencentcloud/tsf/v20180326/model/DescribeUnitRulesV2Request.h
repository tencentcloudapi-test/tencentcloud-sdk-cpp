...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEUNITRULESV2REQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEUNITRULESV2REQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class DescribeUnitRulesV2Request : public AbstractModel
                {
                public:
                    DescribeUnitRulesV2Request();
                    ~DescribeUnitRulesV2Request() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_DESCRIBEUNITRULESV2REQUEST_H_
