...
#ifndef TENCENTCLOUD_TSF_V20180326_MODEL_RELEASEFILECONFIGREQUEST_H_
#define TENCENTCLOUD_TSF_V20180326_MODEL_RELEASEFILECONFIGREQUEST_H_
    ...
    namespace Tsf
    {
        namespace V20180326
        {
            namespace Model
            {
                ...
                */
                class ReleaseFileConfigRequest : public AbstractModel
                {
                public:
                    ReleaseFileConfigRequest();
                    ~ReleaseFileConfigRequest() = default;
...
#endif // !TENCENTCLOUD_TSF_V20180326_MODEL_RELEASEFILECONFIGREQUEST_H_
