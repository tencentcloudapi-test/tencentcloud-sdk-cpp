...
#ifndef TENCENTCLOUD_TDID_V20210519_MODEL_CREATETDIDBYPUBKEYRESPONSE_H_
#define TENCENTCLOUD_TDID_V20210519_MODEL_CREATETDIDBYPUBKEYRESPONSE_H_
    ...
    namespace Tdid
    {
        namespace V20210519
        {
            namespace Model
            {
                ...
                */
                class CreateTDidByPubKeyResponse : public AbstractModel
                {
                public:
                    CreateTDidByPubKeyResponse();
                    ~CreateTDidByPubKeyResponse() = default;
...
#endif // !TENCENTCLOUD_TDID_V20210519_MODEL_CREATETDIDBYPUBKEYRESPONSE_H_
