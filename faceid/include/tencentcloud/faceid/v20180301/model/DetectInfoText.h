...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetLivenessActionSequence(const std::string& _livenessActionSequence);

                    /**
                     * 判断参数 LivenessActionSequence 是否已赋值
                     * @return LivenessActionSequence 是否已赋值
                     * 
                     */
                    bool LivenessActionSequenceHasBeenSet() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                    ...
                    bool m_livenessActionSequenceHasBeenSet;
