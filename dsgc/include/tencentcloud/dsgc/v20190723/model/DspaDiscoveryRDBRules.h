...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DSPADISCOVERYRDBRULES_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DSPADISCOVERYRDBRULES_H_
...
namespace TencentCloud
{
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                class DspaDiscoveryDataRules;

                /**
                * 分类分级任务RDB数据规则
                */
                class DspaDiscoveryRDBRules : public AbstractModel
                {
                public:
                     ...
                     * 
                     */
                    DspaDiscoveryDataRules GetMetaRule() const;
                     ...
                     * 
                     */
                    void SetMetaRule(const DspaDiscoveryDataRules& _metaRule);
                     ...
                     * 
                     */
                    DspaDiscoveryDataRules GetContentRule() const;
                     ...
                     * 
                     */
                    void SetContentRule(const DspaDiscoveryDataRules& _contentRule);
                ...
                private:
                     ...
                     * 字段名包含规则，最大支持选择9项
                     */
                    DspaDiscoveryDataRules m_metaRule;
                    bool m_metaRuleHasBeenSet;

                    /**
                     * 内容包含规则，最大支持选择9项
                     */
                    DspaDiscoveryDataRules m_contentRule;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DSPADISCOVERYRDBRULES_H_
