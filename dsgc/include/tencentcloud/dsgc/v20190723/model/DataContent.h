...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DATACONTENT_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DATACONTENT_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                * 扫描规则内容
                */
                class DataContent : public AbstractModel
                {
                public:
                    DataContent();
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DATACONTENT_H_
