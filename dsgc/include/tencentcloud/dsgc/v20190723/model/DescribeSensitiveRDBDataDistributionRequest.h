...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBESENSITIVERDBDATADISTRIBUTIONREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBESENSITIVERDBDATADISTRIBUTIONREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeSensitiveRDBDataDistributionRequest : public AbstractModel
                {
                public:
                    DescribeSensitiveRDBDataDistributionRequest();
                    ~DescribeSensitiveRDBDataDistributionRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取dspa-实例id
                     * @return DspaId dspa-实例id
                     * 
                     */
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBESENSITIVERDBDATADISTRIBUTIONREQUEST_H_
