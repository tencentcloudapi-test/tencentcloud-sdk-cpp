...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACOSDISCOVERYTASKSREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACOSDISCOVERYTASKSREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeDSPACOSDiscoveryTasksRequest : public AbstractModel
                {
                public:
                    DescribeDSPACOSDiscoveryTasksRequest();
                    ~DescribeDSPACOSDiscoveryTasksRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACOSDISCOVERYTASKSREQUEST_H_
