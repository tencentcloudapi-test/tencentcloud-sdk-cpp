...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEREPORTTASKSREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEREPORTTASKSREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeReportTasksRequest : public AbstractModel
                {
                public:
                    DescribeReportTasksRequest();
                    ~DescribeReportTasksRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEREPORTTASKSREQUEST_H_
