...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEEXPORTTASKRESULTREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEEXPORTTASKRESULTREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeExportTaskResultRequest : public AbstractModel
                {
                public:
                    DescribeExportTaskResultRequest();
                    ~DescribeExportTaskResultRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEEXPORTTASKRESULTREQUEST_H_
