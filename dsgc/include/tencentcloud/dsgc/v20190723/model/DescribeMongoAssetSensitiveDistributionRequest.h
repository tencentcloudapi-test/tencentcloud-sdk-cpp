...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEMONGOASSETSENSITIVEDISTRIBUTIONREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEMONGOASSETSENSITIVEDISTRIBUTIONREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeMongoAssetSensitiveDistributionRequest : public AbstractModel
                {
                public:
                    DescribeMongoAssetSensitiveDistributionRequest();
                    ~DescribeMongoAssetSensitiveDistributionRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEMONGOASSETSENSITIVEDISTRIBUTIONREQUEST_H_
