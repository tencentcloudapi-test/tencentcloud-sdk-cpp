...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DELETEDSPAASSESSMENTTASKREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DELETEDSPAASSESSMENTTASKREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DeleteDSPAAssessmentTaskRequest : public AbstractModel
                {
                public:
                    DeleteDSPAAssessmentTaskRequest();
                    ~DeleteDSPAAssessmentTaskRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DELETEDSPAASSESSMENTTASKREQUEST_H_
