...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEESASSETSENSITIVEDISTRIBUTIONREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEESASSETSENSITIVEDISTRIBUTIONREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeESAssetSensitiveDistributionRequest : public AbstractModel
                {
                public:
                    DescribeESAssetSensitiveDistributionRequest();
                    ~DescribeESAssetSensitiveDistributionRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEESASSETSENSITIVEDISTRIBUTIONREQUEST_H_
