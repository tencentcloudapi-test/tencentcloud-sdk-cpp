...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPAASSESSMENTRISKTEMPLATEREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPAASSESSMENTRISKTEMPLATEREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class CreateDSPAAssessmentRiskTemplateRequest : public AbstractModel
                {
                public:
                    CreateDSPAAssessmentRiskTemplateRequest();
                    ~CreateDSPAAssessmentRiskTemplateRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPAASSESSMENTRISKTEMPLATEREQUEST_H_
