...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DBTASKRESULT_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DBTASKRESULT_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                * database批量操作返回结果结构体
                */
                class DbTaskResult : public AbstractModel
                {
                public:
                    DbTaskResult();
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DBTASKRESULT_H_
