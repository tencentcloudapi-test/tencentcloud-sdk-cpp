...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DATARULE_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DATARULE_H_
...
namespace TencentCloud
{
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                class DatagovRuleExtendParameter;

                /**
                * 敏感数据识别规则
                */
                class DataRule : public AbstractModel
                {
                public:
                    DataRule();
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DATARULE_H_
