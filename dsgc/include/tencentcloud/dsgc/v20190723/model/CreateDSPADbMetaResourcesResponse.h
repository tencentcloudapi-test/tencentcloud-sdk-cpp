...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPADBMETARESOURCESRESPONSE_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPADBMETARESOURCESRESPONSE_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class CreateDSPADbMetaResourcesResponse : public AbstractModel
                {
                public:
                    CreateDSPADbMetaResourcesResponse();
                    ~CreateDSPADbMetaResourcesResponse() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPADBMETARESOURCESRESPONSE_H_
