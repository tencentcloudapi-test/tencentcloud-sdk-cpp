...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACOSDISCOVERYTASKRESULTRESPONSE_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACOSDISCOVERYTASKRESULTRESPONSE_H_
...
namespace TencentCloud
{
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                class DspaCOSDiscoveryTaskResult;

                /**
                * DescribeDSPACOSDiscoveryTaskResult返回参数结构体
                */
                class DescribeDSPACOSDiscoveryTaskResultResponse : public AbstractModel
                {
                public:
                    DescribeDSPACOSDiscoveryTaskResultResponse();
                    ~DescribeDSPACOSDiscoveryTaskResultResponse() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACOSDISCOVERYTASKRESULTRESPONSE_H_
