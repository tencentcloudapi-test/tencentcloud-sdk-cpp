...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPADISCOVERYTASKRESULTRESPONSE_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPADISCOVERYTASKRESULTRESPONSE_H_
...
namespace TencentCloud
{
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                class DspaDiscoveryTaskDbResult;

                /**
                * DescribeDSPADiscoveryTaskResult返回参数结构体
                */
                class DescribeDSPADiscoveryTaskResultResponse : public AbstractModel
                {
                public:
                    DescribeDSPADiscoveryTaskResultResponse();
                    ~DescribeDSPADiscoveryTaskResultResponse() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPADISCOVERYTASKRESULTRESPONSE_H_
