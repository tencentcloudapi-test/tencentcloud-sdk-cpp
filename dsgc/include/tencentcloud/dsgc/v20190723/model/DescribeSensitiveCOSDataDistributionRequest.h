...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBESENSITIVECOSDATADISTRIBUTIONREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBESENSITIVECOSDATADISTRIBUTIONREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeSensitiveCOSDataDistributionRequest : public AbstractModel
                {
                public:
                    DescribeSensitiveCOSDataDistributionRequest();
                    ~DescribeSensitiveCOSDataDistributionRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBESENSITIVECOSDATADISTRIBUTIONREQUEST_H_
