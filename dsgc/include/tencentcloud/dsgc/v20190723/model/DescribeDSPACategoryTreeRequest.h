...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACATEGORYTREEREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACATEGORYTREEREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class DescribeDSPACategoryTreeRequest : public AbstractModel
                {
                public:
                    DescribeDSPACategoryTreeRequest();
                    ~DescribeDSPACategoryTreeRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DESCRIBEDSPACATEGORYTREEREQUEST_H_
