...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPACOSDISCOVERYTASKREQUEST_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPACOSDISCOVERYTASKREQUEST_H_
    ...
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                ...
                */
                class CreateDSPACOSDiscoveryTaskRequest : public AbstractModel
                {
                public:
                    CreateDSPACOSDiscoveryTaskRequest();
                    ~CreateDSPACOSDiscoveryTaskRequest() = default;
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_CREATEDSPACOSDISCOVERYTASKREQUEST_H_
