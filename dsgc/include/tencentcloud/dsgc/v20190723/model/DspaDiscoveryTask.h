...
#ifndef TENCENTCLOUD_DSGC_V20190723_MODEL_DSPADISCOVERYTASK_H_
#define TENCENTCLOUD_DSGC_V20190723_MODEL_DSPADISCOVERYTASK_H_
...
namespace TencentCloud
{
    namespace Dsgc
    {
        namespace V20190723
        {
            namespace Model
            {
                class DspaDiscoveryTaskDataSource;
                class ScanTaskResult;

                /**
                * 分类分级任务相关信息
                */
                class DspaDiscoveryTask : public AbstractModel
                {
                public:
                    DspaDiscoveryTask();
...
#endif // !TENCENTCLOUD_DSGC_V20190723_MODEL_DSPADISCOVERYTASK_H_
