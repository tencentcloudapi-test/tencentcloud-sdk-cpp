...
#ifndef TENCENTCLOUD_TCCATALOG_V20241024_MODEL_TCCCATALOGSET_H_
#define TENCENTCLOUD_TCCATALOG_V20241024_MODEL_TCCCATALOGSET_H_
    ...
    namespace Tccatalog
    {
        namespace V20241024
        {
            namespace Model
            {
                ...
                * Tcc数据目录信息集合
                */
                class TccCatalogSet : public AbstractModel
                {
                public:
                    TccCatalogSet();
...
#endif // !TENCENTCLOUD_TCCATALOG_V20241024_MODEL_TCCCATALOGSET_H_
