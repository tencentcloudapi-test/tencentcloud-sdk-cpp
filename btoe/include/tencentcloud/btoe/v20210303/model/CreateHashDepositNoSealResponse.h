...
#ifndef TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEHASHDEPOSITNOSEALRESPONSE_H_
#define TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEHASHDEPOSITNOSEALRESPONSE_H_
    ...
    namespace Btoe
    {
        namespace V20210303
        {
            namespace Model
            {
                ...
                */
                class CreateHashDepositNoSealResponse : public AbstractModel
                {
                public:
                    CreateHashDepositNoSealResponse();
                    ~CreateHashDepositNoSealResponse() = default;
...
#endif // !TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEHASHDEPOSITNOSEALRESPONSE_H_
