...
#ifndef TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEIMAGEDEPOSITREQUEST_H_
#define TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEIMAGEDEPOSITREQUEST_H_
    ...
    namespace Btoe
    {
        namespace V20210303
        {
            namespace Model
            {
                ...
                */
                class CreateImageDepositRequest : public AbstractModel
                {
                public:
                    CreateImageDepositRequest();
                    ~CreateImageDepositRequest() = default;
...
#endif // !TENCENTCLOUD_BTOE_V20210303_MODEL_CREATEIMAGEDEPOSITREQUEST_H_
