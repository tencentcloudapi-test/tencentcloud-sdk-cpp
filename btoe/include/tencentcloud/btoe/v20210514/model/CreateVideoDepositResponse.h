...
#ifndef TENCENTCLOUD_BTOE_V20210514_MODEL_CREATEVIDEODEPOSITRESPONSE_H_
#define TENCENTCLOUD_BTOE_V20210514_MODEL_CREATEVIDEODEPOSITRESPONSE_H_
    ...
    namespace Btoe
    {
        namespace V20210514
        {
            namespace Model
            {
                ...
                */
                class CreateVideoDepositResponse : public AbstractModel
                {
                public:
                    CreateVideoDepositResponse();
                    ~CreateVideoDepositResponse() = default;
...
#endif // !TENCENTCLOUD_BTOE_V20210514_MODEL_CREATEVIDEODEPOSITRESPONSE_H_
