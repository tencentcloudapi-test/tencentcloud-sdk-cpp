...
#ifndef TENCENTCLOUD_BTOE_V20210514_MODEL_CREATEAUDIODEPOSITRESPONSE_H_
#define TENCENTCLOUD_BTOE_V20210514_MODEL_CREATEAUDIODEPOSITRESPONSE_H_
    ...
    namespace Btoe
    {
        namespace V20210514
        {
            namespace Model
            {
                ...
                */
                class CreateAudioDepositResponse : public AbstractModel
                {
                public:
                    CreateAudioDepositResponse();
                    ~CreateAudioDepositResponse() = default;
...
#endif // !TENCENTCLOUD_BTOE_V20210514_MODEL_CREATEAUDIODEPOSITRESPONSE_H_
