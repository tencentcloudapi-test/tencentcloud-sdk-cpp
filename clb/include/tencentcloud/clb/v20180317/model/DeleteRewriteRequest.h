...
#ifndef TENCENTCLOUD_CLB_V20180317_MODEL_DELETEREWRITEREQUEST_H_
#define TENCENTCLOUD_CLB_V20180317_MODEL_DELETEREWRITEREQUEST_H_
    ...
    namespace Clb
    {
        namespace V20180317
        {
            namespace Model
            {
                ...
                */
                class DeleteRewriteRequest : public AbstractModel
                {
                public:
                    DeleteRewriteRequest();
                    ~DeleteRewriteRequest() = default;
...
#endif // !TENCENTCLOUD_CLB_V20180317_MODEL_DELETEREWRITEREQUEST_H_
