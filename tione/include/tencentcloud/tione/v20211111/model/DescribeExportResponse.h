...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEEXPORTRESPONSE_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEEXPORTRESPONSE_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                */
                class DescribeExportResponse : public AbstractModel
                {
                public:
                    DescribeExportResponse();
                    ~DescribeExportResponse() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEEXPORTRESPONSE_H_
