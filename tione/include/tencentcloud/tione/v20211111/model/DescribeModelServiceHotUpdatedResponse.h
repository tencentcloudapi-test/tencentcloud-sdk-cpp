...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEMODELSERVICEHOTUPDATEDRESPONSE_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEMODELSERVICEHOTUPDATEDRESPONSE_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                */
                class DescribeModelServiceHotUpdatedResponse : public AbstractModel
                {
                public:
                    DescribeModelServiceHotUpdatedResponse();
                    ~DescribeModelServiceHotUpdatedResponse() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEMODELSERVICEHOTUPDATEDRESPONSE_H_
