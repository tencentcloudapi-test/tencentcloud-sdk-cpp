...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBETRAININGMODELVERSIONSRESPONSE_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBETRAININGMODELVERSIONSRESPONSE_H_
...
namespace TencentCloud
{
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                class TrainingModelVersionDTO;

                /**
                * DescribeTrainingModelVersions返回参数结构体
                */
                class DescribeTrainingModelVersionsResponse : public AbstractModel
                {
                public:
                    DescribeTrainingModelVersionsResponse();
                    ~DescribeTrainingModelVersionsResponse() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBETRAININGMODELVERSIONSRESPONSE_H_
