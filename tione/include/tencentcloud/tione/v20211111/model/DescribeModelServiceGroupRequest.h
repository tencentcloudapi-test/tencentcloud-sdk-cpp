...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEMODELSERVICEGROUPREQUEST_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEMODELSERVICEGROUPREQUEST_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                */
                class DescribeModelServiceGroupRequest : public AbstractModel
                {
                public:
                    DescribeModelServiceGroupRequest();
                    ~DescribeModelServiceGroupRequest() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_DESCRIBEMODELSERVICEGROUPREQUEST_H_
