...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_STOPMODELACCELERATETASKREQUEST_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_STOPMODELACCELERATETASKREQUEST_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                */
                class StopModelAccelerateTaskRequest : public AbstractModel
                {
                public:
                    StopModelAccelerateTaskRequest();
                    ~StopModelAccelerateTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_STOPMODELACCELERATETASKREQUEST_H_
