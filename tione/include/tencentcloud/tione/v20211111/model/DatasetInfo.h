...
#ifndef TENCENTCLOUD_TIONE_V20211111_MODEL_DATASETINFO_H_
#define TENCENTCLOUD_TIONE_V20211111_MODEL_DATASETINFO_H_
    ...
    namespace Tione
    {
        namespace V20211111
        {
            namespace Model
            {
                ...
                * 数据集详情
                */
                class DatasetInfo : public AbstractModel
                {
                public:
                    DatasetInfo();
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取数据集对应标注任务名称
注意：此字段可能返回 null，表示取不到有效值。
                     * @return DatasetAnnotationTaskName 数据集对应标注任务名称
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取数据集对应标注任务ID
注意：此字段可能返回 null，表示取不到有效值。
                     * @return DatasetAnnotationTaskId 数据集对应标注任务ID
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取外部任务类型
注意：此字段可能返回 null，表示取不到有效值。
                     * @return ExternalTaskType 外部任务类型
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取数据集源cos 路径
注意：此字段可能返回 null，表示取不到有效值。
                     * @return StorageDataPath 数据集源cos 路径
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取数据集输出cos路径
注意：此字段可能返回 null，表示取不到有效值。
                     * @return StorageLabelPath 数据集输出cos路径
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
...
#endif // !TENCENTCLOUD_TIONE_V20211111_MODEL_DATASETINFO_H_
