...
#ifndef TENCENTCLOUD_TIONE_V20191022_MODEL_DELETECODEREPOSITORYREQUEST_H_
#define TENCENTCLOUD_TIONE_V20191022_MODEL_DELETECODEREPOSITORYREQUEST_H_
    ...
    namespace Tione
    {
        namespace V20191022
        {
            namespace Model
            {
                ...
                */
                class DeleteCodeRepositoryRequest : public AbstractModel
                {
                public:
                    DeleteCodeRepositoryRequest();
                    ~DeleteCodeRepositoryRequest() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20191022_MODEL_DELETECODEREPOSITORYREQUEST_H_
