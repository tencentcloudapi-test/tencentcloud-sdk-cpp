...
#ifndef TENCENTCLOUD_TIONE_V20191022_MODEL_DESCRIBETRAININGJOBREQUEST_H_
#define TENCENTCLOUD_TIONE_V20191022_MODEL_DESCRIBETRAININGJOBREQUEST_H_
    ...
    namespace Tione
    {
        namespace V20191022
        {
            namespace Model
            {
                ...
                */
                class DescribeTrainingJobRequest : public AbstractModel
                {
                public:
                    DescribeTrainingJobRequest();
                    ~DescribeTrainingJobRequest() = default;
...
#endif // !TENCENTCLOUD_TIONE_V20191022_MODEL_DESCRIBETRAININGJOBREQUEST_H_
