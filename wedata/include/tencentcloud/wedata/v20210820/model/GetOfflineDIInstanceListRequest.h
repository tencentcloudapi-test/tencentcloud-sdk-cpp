...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_GETOFFLINEDIINSTANCELISTREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_GETOFFLINEDIINSTANCELISTREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class GetOfflineDIInstanceListRequest : public AbstractModel
                {
                public:
                    GetOfflineDIInstanceListRequest();
                    ~GetOfflineDIInstanceListRequest() = default;
                     ...
                     * 
                     */
                    SearchConditionNew GetSearchCondition() const;
                     ...
                     * 
                     */
                    void SetSearchCondition(const SearchConditionNew& _searchCondition);
                ...
                private:
                     ...
                     * 无
                     */
                    SearchConditionNew m_searchCondition;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_GETOFFLINEDIINSTANCELISTREQUEST_H_
