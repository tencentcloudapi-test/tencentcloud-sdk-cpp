...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BINDPROJECTEXECUTORRESOURCEREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BINDPROJECTEXECUTORRESOURCEREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BindProjectExecutorResourceRequest : public AbstractModel
                {
                public:
                    BindProjectExecutorResourceRequest();
                    ~BindProjectExecutorResourceRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BINDPROJECTEXECUTORRESOURCEREQUEST_H_
