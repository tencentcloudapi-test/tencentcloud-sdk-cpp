...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHRESUMEINTEGRATIONTASKSRESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHRESUMEINTEGRATIONTASKSRESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BatchResumeIntegrationTasksResponse : public AbstractModel
                {
                public:
                    BatchResumeIntegrationTasksResponse();
                    ~BatchResumeIntegrationTasksResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHRESUMEINTEGRATIONTASKSRESPONSE_H_
