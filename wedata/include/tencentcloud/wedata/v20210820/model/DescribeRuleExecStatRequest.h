...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBERULEEXECSTATREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBERULEEXECSTATREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeRuleExecStatRequest : public AbstractModel
                {
                public:
                    DescribeRuleExecStatRequest();
                    ~DescribeRuleExecStatRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBERULEEXECSTATREQUEST_H_
