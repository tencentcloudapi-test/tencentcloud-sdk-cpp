...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINTEGRATIONSTATISTICSTASKSTATUSTRENDREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINTEGRATIONSTATISTICSTASKSTATUSTRENDREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeIntegrationStatisticsTaskStatusTrendRequest : public AbstractModel
                {
                public:
                    DescribeIntegrationStatisticsTaskStatusTrendRequest();
                    ~DescribeIntegrationStatisticsTaskStatusTrendRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEINTEGRATIONSTATISTICSTASKSTATUSTRENDREQUEST_H_
