...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_SCHEDULERTASKINSTANCEINFO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_SCHEDULERTASKINSTANCEINFO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 集成离线任务实例信息
                */
                class SchedulerTaskInstanceInfo : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_SCHEDULERTASKINSTANCEINFO_H_
