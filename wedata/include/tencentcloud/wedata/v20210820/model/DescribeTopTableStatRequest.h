...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETOPTABLESTATREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETOPTABLESTATREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeTopTableStatRequest : public AbstractModel
                {
                public:
                    DescribeTopTableStatRequest();
                    ~DescribeTopTableStatRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBETOPTABLESTATREQUEST_H_
