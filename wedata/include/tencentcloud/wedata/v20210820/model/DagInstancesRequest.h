...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DAGINSTANCESREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DAGINSTANCESREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * DagInstances请求参数结构体
                */
                class DagInstancesRequest : public AbstractModel
                {
                public:
                    DagInstancesRequest();
                    ~DagInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DAGINSTANCESREQUEST_H_
