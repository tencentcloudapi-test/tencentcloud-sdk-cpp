...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBERULEDIMSTATREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBERULEDIMSTATREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeRuleDimStatRequest : public AbstractModel
                {
                public:
                    DescribeRuleDimStatRequest();
                    ~DescribeRuleDimStatRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBERULEDIMSTATREQUEST_H_
