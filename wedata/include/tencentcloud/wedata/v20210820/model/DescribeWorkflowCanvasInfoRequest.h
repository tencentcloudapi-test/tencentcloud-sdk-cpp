...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEWORKFLOWCANVASINFOREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEWORKFLOWCANVASINFOREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class DescribeWorkflowCanvasInfoRequest : public AbstractModel
                {
                public:
                    DescribeWorkflowCanvasInfoRequest();
                    ~DescribeWorkflowCanvasInfoRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_DESCRIBEWORKFLOWCANVASINFOREQUEST_H_
