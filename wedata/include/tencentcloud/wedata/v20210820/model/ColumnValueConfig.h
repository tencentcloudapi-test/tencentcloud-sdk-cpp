...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_COLUMNVALUECONFIG_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_COLUMNVALUECONFIG_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 字段值变量
                */
                class ColumnValueConfig : public AbstractModel
                {
                public:
                    ColumnValueConfig();
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_COLUMNVALUECONFIG_H_
