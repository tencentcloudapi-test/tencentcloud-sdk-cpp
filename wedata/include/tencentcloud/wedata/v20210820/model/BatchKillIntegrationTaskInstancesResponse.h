...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHKILLINTEGRATIONTASKINSTANCESRESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHKILLINTEGRATIONTASKINSTANCESRESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BatchKillIntegrationTaskInstancesResponse : public AbstractModel
                {
                public:
                    BatchKillIntegrationTaskInstancesResponse();
                    ~BatchKillIntegrationTaskInstancesResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHKILLINTEGRATIONTASKINSTANCESRESPONSE_H_
