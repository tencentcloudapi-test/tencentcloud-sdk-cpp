...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHSUSPENDINTEGRATIONTASKSRESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHSUSPENDINTEGRATIONTASKSRESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BatchSuspendIntegrationTasksResponse : public AbstractModel
                {
                public:
                    BatchSuspendIntegrationTasksResponse();
                    ~BatchSuspendIntegrationTasksResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHSUSPENDINTEGRATIONTASKSRESPONSE_H_
