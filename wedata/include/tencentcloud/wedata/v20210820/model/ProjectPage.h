...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_PROJECTPAGE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_PROJECTPAGE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 查询数据源分页列表
                */
                class ProjectPage : public AbstractModel
                {
                public:
                    ProjectPage();
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<Project> GetRows() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetRows(const std::vector<Project>& _rows);
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_PROJECTPAGE_H_
