...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONFOLDEROPSDTO_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONFOLDEROPSDTO_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                * 文件夹列表
                */
                class CollectionFolderOpsDto : public AbstractModel
                {
                public:
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<FolderOpsDto> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<FolderOpsDto>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<FolderOpsDto> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_COLLECTIONFOLDEROPSDTO_H_
