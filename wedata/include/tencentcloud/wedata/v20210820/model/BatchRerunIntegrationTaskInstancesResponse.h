...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHRERUNINTEGRATIONTASKINSTANCESRESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHRERUNINTEGRATIONTASKINSTANCESRESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BatchRerunIntegrationTaskInstancesResponse : public AbstractModel
                {
                public:
                    BatchRerunIntegrationTaskInstancesResponse();
                    ~BatchRerunIntegrationTaskInstancesResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHRERUNINTEGRATIONTASKINSTANCESRESPONSE_H_
