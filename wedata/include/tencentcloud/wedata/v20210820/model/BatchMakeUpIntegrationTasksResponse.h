...
#ifndef TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHMAKEUPINTEGRATIONTASKSRESPONSE_H_
#define TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHMAKEUPINTEGRATIONTASKSRESPONSE_H_
    ...
    namespace Wedata
    {
        namespace V20210820
        {
            namespace Model
            {
                ...
                */
                class BatchMakeUpIntegrationTasksResponse : public AbstractModel
                {
                public:
                    BatchMakeUpIntegrationTasksResponse();
                    ~BatchMakeUpIntegrationTasksResponse() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20210820_MODEL_BATCHMAKEUPINTEGRATIONTASKSRESPONSE_H_
