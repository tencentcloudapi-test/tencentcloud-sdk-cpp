...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTLINEAGEPAGE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTLINEAGEPAGE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * ListLineagePage
                */
                class ListLineagePage : public AbstractModel
                {
                public:
                    ListLineagePage();
                     ...
                     * 
                     */
                    std::vector<LineageNodeInfo> GetItems() const;
                     ...
                     * 
                     */
                    void SetItems(const std::vector<LineageNodeInfo>& _items);
                ...
                private:
                     ...
                     * 血缘记录列表
                     */
                    std::vector<LineageNodeInfo> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTLINEAGEPAGE_H_
