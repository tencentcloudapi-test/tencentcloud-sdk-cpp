...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_LINEAGERESOUCE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_LINEAGERESOUCE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 血缘资源实体
                */
                class LineageResouce : public AbstractModel
                {
                public:
                    LineageResouce();
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_LINEAGERESOUCE_H_
