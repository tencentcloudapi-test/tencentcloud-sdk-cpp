...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_PROJECTBRIEF_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_PROJECTBRIEF_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 查询数据源分页列表
                */
                class ProjectBrief : public AbstractModel
                {
                public:
                    ProjectBrief();
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<Project>& _items);
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_PROJECTBRIEF_H_
