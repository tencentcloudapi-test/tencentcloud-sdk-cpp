...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_STOPOPSTASKSASYNCREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_STOPOPSTASKSASYNCREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class StopOpsTasksAsyncRequest : public AbstractModel
                {
                public:
                    StopOpsTasksAsyncRequest();
                    ~StopOpsTasksAsyncRequest() = default;
                    ...
                    /**
                     * 获取是否终止已生成实例，默认false
                     * @return KillInstance 是否终止已生成实例，默认false
                     * 
                     */
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_STOPOPSTASKSASYNCREQUEST_H_
