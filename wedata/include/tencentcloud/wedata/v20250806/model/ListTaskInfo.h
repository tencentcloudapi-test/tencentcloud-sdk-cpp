...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTASKINFO_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTASKINFO_H_
...
namespace TencentCloud
{
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                class TaskBaseAttribute;

                /**
                * 查询任务信息分页
                */
                class ListTaskInfo : public AbstractModel
                {
                public:
                    ListTaskInfo();
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<TaskBaseAttribute> GetItems() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    void SetItems(const std::vector<TaskBaseAttribute>& _items);
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<TaskBaseAttribute> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTASKINFO_H_
