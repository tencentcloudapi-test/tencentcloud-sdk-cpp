...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_CHILDDEPENDENCYCONFIGPAGE_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_CHILDDEPENDENCYCONFIGPAGE_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * 任务下游依赖详情分页
                */
                class ChildDependencyConfigPage : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_CHILDDEPENDENCYCONFIGPAGE_H_
