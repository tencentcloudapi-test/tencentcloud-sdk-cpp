...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTABLEREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTABLEREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                * ListTable请求参数结构体
                */
                class ListTableRequest : public AbstractModel
                {
                public:
                    ListTableRequest();
                    ~ListTableRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTABLEREQUEST_H_
