...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_CANCELSHAREBLUEPRINTACROSSACCOUNTSREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_CANCELSHAREBLUEPRINTACROSSACCOUNTSREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class CancelShareBlueprintAcrossAccountsRequest : public AbstractModel
                {
                public:
                    CancelShareBlueprintAcrossAccountsRequest();
                    ~CancelShareBlueprintAcrossAccountsRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_CANCELSHAREBLUEPRINTACROSSACCOUNTSREQUEST_H_
