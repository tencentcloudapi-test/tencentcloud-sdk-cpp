...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEMCPSERVERTEMPLATESREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEMCPSERVERTEMPLATESREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class DescribeMcpServerTemplatesRequest : public AbstractModel
                {
                public:
                    DescribeMcpServerTemplatesRequest();
                    ~DescribeMcpServerTemplatesRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_DESCRIBEMCPSERVERTEMPLATESREQUEST_H_
