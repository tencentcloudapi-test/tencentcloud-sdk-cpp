...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_RESTARTMCPSERVERSREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_RESTARTMCPSERVERSREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class RestartMcpServersRequest : public AbstractModel
                {
                public:
                    RestartMcpServersRequest();
                    ~RestartMcpServersRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_RESTARTMCPSERVERSREQUEST_H_
