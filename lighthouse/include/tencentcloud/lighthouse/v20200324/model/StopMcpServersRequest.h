...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_STOPMCPSERVERSREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_STOPMCPSERVERSREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class StopMcpServersRequest : public AbstractModel
                {
                public:
                    StopMcpServersRequest();
                    ~StopMcpServersRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_STOPMCPSERVERSREQUEST_H_
