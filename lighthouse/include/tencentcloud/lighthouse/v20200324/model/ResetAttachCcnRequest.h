...
#ifndef TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_RESETATTACHCCNREQUEST_H_
#define TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_RESETATTACHCCNREQUEST_H_
    ...
    namespace Lighthouse
    {
        namespace V20200324
        {
            namespace Model
            {
                ...
                */
                class ResetAttachCcnRequest : public AbstractModel
                {
                public:
                    ResetAttachCcnRequest();
                    ~ResetAttachCcnRequest() = default;
...
#endif // !TENCENTCLOUD_LIGHTHOUSE_V20200324_MODEL_RESETATTACHCCNREQUEST_H_
