...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBESYSTEMVULLISTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBESYSTEMVULLISTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeSystemVulListRequest : public AbstractModel
                {
                public:
                    DescribeSystemVulListRequest();
                    ~DescribeSystemVulListRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBESYSTEMVULLISTREQUEST_H_
