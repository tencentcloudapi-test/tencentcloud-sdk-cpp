...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEREVERSESHELLWHITELISTSREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEREVERSESHELLWHITELISTSREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeReverseShellWhiteListsRequest : public AbstractModel
                {
                public:
                    DescribeReverseShellWhiteListsRequest();
                    ~DescribeReverseShellWhiteListsRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEREVERSESHELLWHITELISTSREQUEST_H_
