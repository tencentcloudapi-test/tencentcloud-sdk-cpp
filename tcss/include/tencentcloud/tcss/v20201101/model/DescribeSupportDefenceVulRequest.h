...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBESUPPORTDEFENCEVULREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBESUPPORTDEFENCEVULREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeSupportDefenceVulRequest : public AbstractModel
                {
                public:
                    DescribeSupportDefenceVulRequest();
                    ~DescribeSupportDefenceVulRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBESUPPORTDEFENCEVULREQUEST_H_
