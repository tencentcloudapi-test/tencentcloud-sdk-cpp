...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYVIRUSLISTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYVIRUSLISTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeAssetImageRegistryVirusListRequest : public AbstractModel
                {
                public:
                    DescribeAssetImageRegistryVirusListRequest();
                    ~DescribeAssetImageRegistryVirusListRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYVIRUSLISTREQUEST_H_
