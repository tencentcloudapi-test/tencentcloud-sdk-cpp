...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBENETWORKFIREWALLPODLABELSLISTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBENETWORKFIREWALLPODLABELSLISTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeNetworkFirewallPodLabelsListRequest : public AbstractModel
                {
                public:
                    DescribeNetworkFirewallPodLabelsListRequest();
                    ~DescribeNetworkFirewallPodLabelsListRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBENETWORKFIREWALLPODLABELSLISTREQUEST_H_
