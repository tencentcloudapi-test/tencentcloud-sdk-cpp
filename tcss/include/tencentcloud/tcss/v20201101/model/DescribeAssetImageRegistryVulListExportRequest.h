...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYVULLISTEXPORTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYVULLISTEXPORTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeAssetImageRegistryVulListExportRequest : public AbstractModel
                {
                public:
                    DescribeAssetImageRegistryVulListExportRequest();
                    ~DescribeAssetImageRegistryVulListExportRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEASSETIMAGEREGISTRYVULLISTEXPORTREQUEST_H_
