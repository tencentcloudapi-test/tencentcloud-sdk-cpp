...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEASSETIMAGEVIRUSEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEASSETIMAGEVIRUSEXPORTJOBREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class CreateAssetImageVirusExportJobRequest : public AbstractModel
                {
                public:
                    CreateAssetImageVirusExportJobRequest();
                    ~CreateAssetImageVirusExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEASSETIMAGEVIRUSEXPORTJOBREQUEST_H_
