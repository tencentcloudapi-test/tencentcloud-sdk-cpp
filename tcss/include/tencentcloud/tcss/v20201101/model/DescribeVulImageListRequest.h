...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEVULIMAGELISTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEVULIMAGELISTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeVulImageListRequest : public AbstractModel
                {
                public:
                    DescribeVulImageListRequest();
                    ~DescribeVulImageListRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEVULIMAGELISTREQUEST_H_
