...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEREVERSESHELLEVENTSEXPORTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEREVERSESHELLEVENTSEXPORTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeReverseShellEventsExportRequest : public AbstractModel
                {
                public:
                    DescribeReverseShellEventsExportRequest();
                    ~DescribeReverseShellEventsExportRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEREVERSESHELLEVENTSEXPORTREQUEST_H_
