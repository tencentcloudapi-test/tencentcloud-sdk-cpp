...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_MODIFYRISKSYSCALLSTATUSREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_MODIFYRISKSYSCALLSTATUSREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class ModifyRiskSyscallStatusRequest : public AbstractModel
                {
                public:
                    ModifyRiskSyscallStatusRequest();
                    ~ModifyRiskSyscallStatusRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_MODIFYRISKSYSCALLSTATUSREQUEST_H_
