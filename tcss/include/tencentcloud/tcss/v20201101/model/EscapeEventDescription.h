...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_ESCAPEEVENTDESCRIPTION_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_ESCAPEEVENTDESCRIPTION_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                * 运行时容器逃逸事件描述信息
                */
                class EscapeEventDescription : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_ESCAPEEVENTDESCRIPTION_H_
