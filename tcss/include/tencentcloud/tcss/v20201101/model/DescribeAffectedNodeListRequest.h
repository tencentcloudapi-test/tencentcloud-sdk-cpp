...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEAFFECTEDNODELISTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEAFFECTEDNODELISTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeAffectedNodeListRequest : public AbstractModel
                {
                public:
                    DescribeAffectedNodeListRequest();
                    ~DescribeAffectedNodeListRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEAFFECTEDNODELISTREQUEST_H_
