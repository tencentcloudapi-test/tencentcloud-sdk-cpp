...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEREVERSESHELLDETAILRESPONSE_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEREVERSESHELLDETAILRESPONSE_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeReverseShellDetailResponse : public AbstractModel
                {
                public:
                    DescribeReverseShellDetailResponse();
                    ~DescribeReverseShellDetailResponse() = default;
                ...
                private:
                     ...
                     * 事件描述
                     */
                    ReverseShellEventDescription m_eventDetail;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEREVERSESHELLDETAILRESPONSE_H_
