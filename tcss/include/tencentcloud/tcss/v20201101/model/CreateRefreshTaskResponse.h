...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEREFRESHTASKRESPONSE_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEREFRESHTASKRESPONSE_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class CreateRefreshTaskResponse : public AbstractModel
                {
                public:
                    CreateRefreshTaskResponse();
                    ~CreateRefreshTaskResponse() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEREFRESHTASKRESPONSE_H_
