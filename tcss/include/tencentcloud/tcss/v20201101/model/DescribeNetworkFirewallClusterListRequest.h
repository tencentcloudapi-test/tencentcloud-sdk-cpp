...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBENETWORKFIREWALLCLUSTERLISTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBENETWORKFIREWALLCLUSTERLISTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeNetworkFirewallClusterListRequest : public AbstractModel
                {
                public:
                    DescribeNetworkFirewallClusterListRequest();
                    ~DescribeNetworkFirewallClusterListRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBENETWORKFIREWALLCLUSTERLISTREQUEST_H_
