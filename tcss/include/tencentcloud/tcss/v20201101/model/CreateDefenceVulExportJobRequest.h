...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEDEFENCEVULEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEDEFENCEVULEXPORTJOBREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class CreateDefenceVulExportJobRequest : public AbstractModel
                {
                public:
                    CreateDefenceVulExportJobRequest();
                    ~CreateDefenceVulExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_CREATEDEFENCEVULEXPORTJOBREQUEST_H_
