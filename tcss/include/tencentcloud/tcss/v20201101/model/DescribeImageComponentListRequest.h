...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEIMAGECOMPONENTLISTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEIMAGECOMPONENTLISTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeImageComponentListRequest : public AbstractModel
                {
                public:
                    DescribeImageComponentListRequest();
                    ~DescribeImageComponentListRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEIMAGECOMPONENTLISTREQUEST_H_
