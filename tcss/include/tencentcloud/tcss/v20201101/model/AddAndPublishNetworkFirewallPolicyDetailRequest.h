...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_ADDANDPUBLISHNETWORKFIREWALLPOLICYDETAILREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_ADDANDPUBLISHNETWORKFIREWALLPOLICYDETAILREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class AddAndPublishNetworkFirewallPolicyDetailRequest : public AbstractModel
                {
                public:
                    AddAndPublishNetworkFirewallPolicyDetailRequest();
                    ~AddAndPublishNetworkFirewallPolicyDetailRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_ADDANDPUBLISHNETWORKFIREWALLPOLICYDETAILREQUEST_H_
