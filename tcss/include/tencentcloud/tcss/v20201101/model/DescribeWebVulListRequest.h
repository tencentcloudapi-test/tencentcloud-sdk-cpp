...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEWEBVULLISTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEWEBVULLISTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeWebVulListRequest : public AbstractModel
                {
                public:
                    DescribeWebVulListRequest();
                    ~DescribeWebVulListRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEWEBVULLISTREQUEST_H_
