...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_CARAIRESULTINFO_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_CARAIRESULTINFO_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 车辆车牌识别结果信息
                */
                class CarAIResultInfo : public AbstractModel
                {
                public:
                    CarAIResultInfo();
                     ...
                     * 
                     */
                    PlateContent GetPlateContent() const;
                     ...
                     * 
                     */
                    void SetPlateContent(const PlateContent& _plateContent);
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_CARAIRESULTINFO_H_
