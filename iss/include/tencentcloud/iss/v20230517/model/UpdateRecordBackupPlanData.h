...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_UPDATERECORDBACKUPPLANDATA_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_UPDATERECORDBACKUPPLANDATA_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 修改录像上云计划返回数据
                */
                class UpdateRecordBackupPlanData : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_UPDATERECORDBACKUPPLANDATA_H_
