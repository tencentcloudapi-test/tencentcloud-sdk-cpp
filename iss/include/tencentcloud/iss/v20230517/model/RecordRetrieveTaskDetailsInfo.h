...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_RECORDRETRIEVETASKDETAILSINFO_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_RECORDRETRIEVETASKDETAILSINFO_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 录像取回任务详情基础信息
                */
                class RecordRetrieveTaskDetailsInfo : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_RECORDRETRIEVETASKDETAILSINFO_H_
