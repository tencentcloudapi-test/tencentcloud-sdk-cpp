...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_RECORDPLANOPTDATA_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_RECORDPLANOPTDATA_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 实时上云计划添加和修改的返回数据
                */
                class RecordPlanOptData : public AbstractModel
                {
                public:
                    RecordPlanOptData();
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_RECORDPLANOPTDATA_H_
