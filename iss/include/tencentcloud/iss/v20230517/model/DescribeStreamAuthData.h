...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_DESCRIBESTREAMAUTHDATA_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_DESCRIBESTREAMAUTHDATA_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 查询推拉流鉴权返回数据结构
                */
                class DescribeStreamAuthData : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_DESCRIBESTREAMAUTHDATA_H_
