...
#ifndef TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDBACKUPPLANDATA_H_
#define TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDBACKUPPLANDATA_H_
    ...
    namespace Iss
    {
        namespace V20230517
        {
            namespace Model
            {
                ...
                * 查询录像上云计划列表返回数据
                */
                class ListRecordBackupPlanData : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_ISS_V20230517_MODEL_LISTRECORDBACKUPPLANDATA_H_
