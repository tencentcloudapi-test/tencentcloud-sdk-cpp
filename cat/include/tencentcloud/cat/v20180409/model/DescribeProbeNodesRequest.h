...
#ifndef TENCENTCLOUD_CAT_V20180409_MODEL_DESCRIBEPROBENODESREQUEST_H_
#define TENCENTCLOUD_CAT_V20180409_MODEL_DESCRIBEPROBENODESREQUEST_H_
    ...
    namespace Cat
    {
        namespace V20180409
        {
            namespace Model
            {
                ...
                */
                class DescribeProbeNodesRequest : public AbstractModel
                {
                public:
                    DescribeProbeNodesRequest();
                    ~DescribeProbeNodesRequest() = default;
...
#endif // !TENCENTCLOUD_CAT_V20180409_MODEL_DESCRIBEPROBENODESREQUEST_H_
