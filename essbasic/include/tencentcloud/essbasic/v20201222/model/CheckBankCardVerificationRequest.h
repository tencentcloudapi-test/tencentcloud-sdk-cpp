...
#ifndef TENCENTCLOUD_ESSBASIC_V20201222_MODEL_CHECKBANKCARDVERIFICATIONREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20201222_MODEL_CHECKBANKCARDVERIFICATIONREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20201222
        {
            namespace Model
            {
                ...
                */
                class CheckBankCardVerificationRequest : public AbstractModel
                {
                public:
                    CheckBankCardVerificationRequest();
                    ~CheckBankCardVerificationRequest() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20201222_MODEL_CHECKBANKCARDVERIFICATIONREQUEST_H_
