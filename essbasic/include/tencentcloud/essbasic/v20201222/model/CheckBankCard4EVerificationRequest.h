...
#ifndef TENCENTCLOUD_ESSBASIC_V20201222_MODEL_CHECKBANKCARD4EVERIFICATIONREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20201222_MODEL_CHECKBANKCARD4EVERIFICATIONREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20201222
        {
            namespace Model
            {
                ...
                */
                class CheckBankCard4EVerificationRequest : public AbstractModel
                {
                public:
                    CheckBankCard4EVerificationRequest();
                    ~CheckBankCard4EVerificationRequest() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20201222_MODEL_CHECKBANKCARD4EVERIFICATIONREQUEST_H_
