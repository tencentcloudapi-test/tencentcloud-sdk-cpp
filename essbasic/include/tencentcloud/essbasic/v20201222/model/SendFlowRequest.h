...
#ifndef TENCENTCLOUD_ESSBASIC_V20201222_MODEL_SENDFLOWREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20201222_MODEL_SENDFLOWREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20201222
        {
            namespace Model
            {
                ...
                * SendFlow请求参数结构体
                */
                class SendFlowRequest : public AbstractModel
                {
                public:
                    SendFlowRequest();
                    ~SendFlowRequest() = default;
...
5. THIRD - 第三方 (暂不支持)
                    ...
                    /**
                     * 获取短信模板。默认使用腾讯电子签官方短信模板，如有自定义需求，请通过客户经理或邮件至e-contract@tencent.com与我们联系。
                     * @return SmsTemplate 短信模板。默认使用腾讯电子签官方短信模板，如有自定义需求，请通过客户经理或邮件至e-contract@tencent.com与我们联系。
                     * 
                     */
                    SmsTemplate GetSmsTemplate() const;

                    /**
                     * 设置短信模板。默认使用腾讯电子签官方短信模板，如有自定义需求，请通过客户经理或邮件至e-contract@tencent.com与我们联系。
...
#endif // !TENCENTCLOUD_ESSBASIC_V20201222_MODEL_SENDFLOWREQUEST_H_
