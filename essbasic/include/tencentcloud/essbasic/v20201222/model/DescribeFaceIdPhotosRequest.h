...
#ifndef TENCENTCLOUD_ESSBASIC_V20201222_MODEL_DESCRIBEFACEIDPHOTOSREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20201222_MODEL_DESCRIBEFACEIDPHOTOSREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20201222
        {
            namespace Model
            {
                ...
                */
                class DescribeFaceIdPhotosRequest : public AbstractModel
                {
                public:
                    DescribeFaceIdPhotosRequest();
                    ~DescribeFaceIdPhotosRequest() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20201222_MODEL_DESCRIBEFACEIDPHOTOSREQUEST_H_
