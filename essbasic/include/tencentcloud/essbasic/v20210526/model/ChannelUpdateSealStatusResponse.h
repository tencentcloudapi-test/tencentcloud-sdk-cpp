...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELUPDATESEALSTATUSRESPONSE_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELUPDATESEALSTATUSRESPONSE_H_
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class ChannelUpdateSealStatusResponse : public AbstractModel
                {
                public:
                    ChannelUpdateSealStatusResponse();
                    ~ChannelUpdateSealStatusResponse() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELUPDATESEALSTATUSRESPONSE_H_
