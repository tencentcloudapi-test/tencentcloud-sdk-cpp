...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_DELETEORGANIZATIONAUTHORIZATIONSRESPONSE_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_DELETEORGANIZATIONAUTHORIZATIONSRESPONSE_H_
...
namespace TencentCloud
{
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                class DeleteOrganizationAuthorizationInfo;
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取清理认证流的详细信息，包括企业名称、认证流唯一 ID 以及清理认证流过程中产生的错误信息。
                     * @return DeleteOrganizationAuthorizationInfos 清理认证流的详细信息，包括企业名称、认证流唯一 ID 以及清理认证流过程中产生的错误信息。
                     * 
                     */
                    ...
                    /**
                     * 获取批量清理认证流返回的状态值其中包括- 1 全部成功- 2 部分成功- 3 全部失败
                     * @return Status 批量清理认证流返回的状态值其中包括- 1 全部成功- 2 部分成功- 3 全部失败
                     * 
                     */
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_DELETEORGANIZATIONAUTHORIZATIONSRESPONSE_H_
