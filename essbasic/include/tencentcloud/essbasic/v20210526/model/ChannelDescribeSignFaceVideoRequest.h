...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBESIGNFACEVIDEOREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBESIGNFACEVIDEOREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class ChannelDescribeSignFaceVideoRequest : public AbstractModel
                {
                public:
                    ChannelDescribeSignFaceVideoRequest();
                    ~ChannelDescribeSignFaceVideoRequest() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBESIGNFACEVIDEOREQUEST_H_
