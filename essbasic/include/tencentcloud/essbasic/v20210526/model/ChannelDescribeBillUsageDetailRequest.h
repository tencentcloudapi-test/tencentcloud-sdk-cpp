...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBEBILLUSAGEDETAILREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBEBILLUSAGEDETAILREQUEST_H_
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class ChannelDescribeBillUsageDetailRequest : public AbstractModel
                {
                public:
                    ChannelDescribeBillUsageDetailRequest();
                    ~ChannelDescribeBillUsageDetailRequest() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBEBILLUSAGEDETAILREQUEST_H_
