...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEUSERAUTOSIGNSEALURLREQUEST_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEUSERAUTOSIGNSEALURLREQUEST_H_
...
namespace TencentCloud
{
    namespace Essbasic
    {
        namespace V20210526
        {
            ...
            {
                class Agent;
                class UserThreeFactor;
                class UserInfo;

                /**
                * ChannelCreateUserAutoSignSealUrl请求参数结构体
                */
                class ChannelCreateUserAutoSignSealUrlRequest : public AbstractModel
                {
                public:
                    ChannelCreateUserAutoSignSealUrlRequest();
                    ~ChannelCreateUserAutoSignSealUrlRequest() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEUSERAUTOSIGNSEALURLREQUEST_H_
