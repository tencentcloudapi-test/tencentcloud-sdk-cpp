...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBESIGNFACEVIDEORESPONSE_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBESIGNFACEVIDEORESPONSE_H_

#include <string>
#include <vector>
#include <map>
#include <tencentcloud/core/AbstractModel.h>
#include <tencentcloud/essbasic/v20210526/model/DetectInfoVideoData.h>
#include <tencentcloud/essbasic/v20210526/model/IntentionQuestionResult.h>
#include <tencentcloud/essbasic/v20210526/model/IntentionActionResult.h>
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class ChannelDescribeSignFaceVideoResponse : public AbstractModel
                {
                public:
                    ChannelDescribeSignFaceVideoResponse();
                    ~ChannelDescribeSignFaceVideoResponse() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELDESCRIBESIGNFACEVIDEORESPONSE_H_
