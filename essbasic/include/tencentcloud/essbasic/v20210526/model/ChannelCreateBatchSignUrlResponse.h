...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEBATCHSIGNURLRESPONSE_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEBATCHSIGNURLRESPONSE_H_
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class ChannelCreateBatchSignUrlResponse : public AbstractModel
                {
                public:
                    ChannelCreateBatchSignUrlResponse();
                    ~ChannelCreateBatchSignUrlResponse() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_CHANNELCREATEBATCHSIGNURLRESPONSE_H_
