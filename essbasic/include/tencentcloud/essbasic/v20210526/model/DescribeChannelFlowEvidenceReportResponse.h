...
#ifndef TENCENTCLOUD_ESSBASIC_V20210526_MODEL_DESCRIBECHANNELFLOWEVIDENCEREPORTRESPONSE_H_
#define TENCENTCLOUD_ESSBASIC_V20210526_MODEL_DESCRIBECHANNELFLOWEVIDENCEREPORTRESPONSE_H_
    ...
    namespace Essbasic
    {
        namespace V20210526
        {
            namespace Model
            {
                ...
                */
                class DescribeChannelFlowEvidenceReportResponse : public AbstractModel
                {
                public:
                    DescribeChannelFlowEvidenceReportResponse();
                    ~DescribeChannelFlowEvidenceReportResponse() = default;
...
#endif // !TENCENTCLOUD_ESSBASIC_V20210526_MODEL_DESCRIBECHANNELFLOWEVIDENCEREPORTRESPONSE_H_
