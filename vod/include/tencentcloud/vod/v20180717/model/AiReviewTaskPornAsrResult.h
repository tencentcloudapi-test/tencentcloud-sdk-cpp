...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_AIREVIEWTASKPORNASRRESULT_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_AIREVIEWTASKPORNASRRESULT_H_
...
#include <tencentcloud/vod/v20180717/model/AiReviewPornAsrTaskInput.h>
...
namespace TencentCloud
{
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                class AiReviewPornAsrTaskInput;
                class AiReviewPornAsrTaskOutput;
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取音视频审核 Asr 文字涉及令人反感的信息的任务输入。
                     * @return Input 音视频审核 Asr 文字涉及令人反感的信息的任务输入。
                     * 
                     */
                    AiReviewPornAsrTaskInput GetInput() const;

                    /**
                     * 设置音视频审核 Asr 文字涉及令人反感的信息的任务输入。
                    ...
                    /**
                     * 获取音视频审核 Asr 文字涉及令人反感的信息的任务进度，取值范围 [0-100] 。
                     * @return Progress 音视频审核 Asr 文字涉及令人反感的信息的任务进度，取值范围 [0-100] 。
                     * 
                     */
                    int64_t GetProgress() const;

                    /**
                     * 设置音视频审核 Asr 文字涉及令人反感的信息的任务进度，取值范围 [0-100] 。
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_AIREVIEWTASKPORNASRRESULT_H_
