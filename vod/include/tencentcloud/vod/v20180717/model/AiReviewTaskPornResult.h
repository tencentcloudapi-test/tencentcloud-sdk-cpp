...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_AIREVIEWTASKPORNRESULT_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_AIREVIEWTASKPORNRESULT_H_
...
#include <tencentcloud/vod/v20180717/model/AiReviewPornTaskInput.h>
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取音视频审核涉及令人反感的信息的任务输入。
                     * @return Input 音视频审核涉及令人反感的信息的任务输入。
                     * 
                     */
                    AiReviewPornTaskInput GetInput() const;

                    /**
                     * 设置音视频审核涉及令人反感的信息的任务输入。
                    ...
                    /**
                     * 获取音视频审核涉及令人反感的信息的任务输出。
                     * @return Output 音视频审核涉及令人反感的信息的任务输出。
                     * 
                     */
                    AiReviewPornTaskOutput GetOutput() const;

                    /**
                     * 设置音视频审核涉及令人反感的信息的任务输出。
                    ...
                    /**
                     * 获取音视频审核涉及令人反感的信息的任务进度，取值范围 [0-100] 。
                     * @return Progress 音视频审核涉及令人反感的信息的任务进度，取值范围 [0-100] 。
                     * 
                     */
                    int64_t GetProgress() const;

                    /**
                     * 设置音视频审核涉及令人反感的信息的任务进度，取值范围 [0-100] 。
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_AIREVIEWTASKPORNRESULT_H_
