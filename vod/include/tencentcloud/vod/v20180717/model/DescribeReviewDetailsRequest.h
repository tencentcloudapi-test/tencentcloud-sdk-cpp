...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEREVIEWDETAILSREQUEST_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEREVIEWDETAILSREQUEST_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class DescribeReviewDetailsRequest : public AbstractModel
                {
                public:
                    DescribeReviewDetailsRequest();
                    ~DescribeReviewDetailsRequest() = default;
                    ...
                    /**
                     * 获取结束日期，需大于起始日期。使用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
                    ...
                    /**
                     * 设置结束日期，需大于起始日期。使用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEREVIEWDETAILSREQUEST_H_
