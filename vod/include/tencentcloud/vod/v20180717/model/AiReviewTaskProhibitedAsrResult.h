            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取音视频审核 Asr 文字鉴违禁任务输入。
                     * @return Input 音视频审核 Asr 文字鉴违禁任务输入。
                     * 
                     */
                    AiReviewProhibitedAsrTaskInput GetInput() const;

                    /**
                     * 设置音视频审核 Asr 文字鉴违禁任务输入。
                    ...
                    /**
                     * 获取音视频审核 Asr 文字鉴违禁任务进度，取值范围 [0-100] 。
                     * @return Progress 音视频审核 Asr 文字鉴违禁任务进度，取值范围 [0-100] 。
                     * 
                     */
                    int64_t GetProgress() const;

                    /**
                     * 设置音视频审核 Asr 文字鉴违禁任务进度，取值范围 [0-100] 。
