...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_AIRECOGNITIONTASKSEGMENTRESULT_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_AIRECOGNITIONTASKSEGMENTRESULT_H_
...
namespace TencentCloud
{
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                class AiRecognitionTaskSegmentResultInput;
                class AiRecognitionTaskSegmentResultOutput;

                /**
                * 视频拆条结果。
                */
                class AiRecognitionTaskSegmentResult : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_AIRECOGNITIONTASKSEGMENTRESULT_H_
