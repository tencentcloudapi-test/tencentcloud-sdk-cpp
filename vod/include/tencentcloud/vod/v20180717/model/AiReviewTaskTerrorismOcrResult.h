...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_AIREVIEWTASKTERRORISMOCRRESULT_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_AIREVIEWTASKTERRORISMOCRRESULT_H_
...
namespace TencentCloud
{
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                class AiReviewTerrorismOcrTaskInput;
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取音视频审核 Ocr 文字涉及令人不安全的信息的任务输入。
                     * @return Input 音视频审核 Ocr 文字涉及令人不安全的信息的任务输入。
                     * 
                     */
                    AiReviewTerrorismOcrTaskInput GetInput() const;

                    /**
                     * 设置音视频审核 Ocr 文字涉及令人不安全的信息的任务输入。
                    ...
                    /**
                     * 获取音视频审核 Ocr 文字涉及令人不安全的信息的任务输出。
                     * @return Output 音视频审核 Ocr 文字涉及令人不安全的信息的任务输出。
                     * 
                     */
                    AiReviewTerrorismOcrTaskOutput GetOutput() const;

                    /**
                     * 设置音视频审核 Ocr 文字涉及令人不安全的信息的任务输出。
                    ...
                    /**
                     * 获取音视频审核 Ocr 文字涉及令人不安全的信息的任务进度，取值范围 [0-100] 。
                     * @return Progress 音视频审核 Ocr 文字涉及令人不安全的信息的任务进度，取值范围 [0-100] 。
                     * 
                     */
                    int64_t GetProgress() const;

                    /**
                     * 设置音视频审核 Ocr 文字涉及令人不安全的信息的任务进度，取值范围 [0-100] 。
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_AIREVIEWTASKTERRORISMOCRRESULT_H_
