            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取音视频审核涉及令人不适宜信息的任务输入。
                     * @return Input 音视频审核涉及令人不适宜信息的任务输入。
                     * 
                     */
                    AiReviewPoliticalTaskInput GetInput() const;

                    /**
                     * 设置音视频审核涉及令人不适宜信息的任务输入。
                    ...
                    /**
                     * 获取音视频审核涉及令人不适宜信息的任务输出。
                     * @return Output 音视频审核涉及令人不适宜信息的任务输出。
                     * 
                     */
                    AiReviewPoliticalTaskOutput GetOutput() const;

                    /**
                     * 设置音视频审核涉及令人不适宜信息的任务输出。
                    ...
                    /**
                     * 获取音视频审核涉及令人不适宜信息的任务进度，取值范围 [0-100] 。
                     * @return Progress 音视频审核涉及令人不适宜信息的任务进度，取值范围 [0-100] 。
                     * 
                     */
                    int64_t GetProgress() const;

                    /**
                     * 设置音视频审核涉及令人不适宜信息的任务进度，取值范围 [0-100] 。
