...
namespace TencentCloud
{
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                class AiRecognitionTaskAsrTranslateResultInput;
                class AiRecognitionTaskAsrTranslateResultOutput;
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取语音翻译任务进度，取值范围 [0-100] 。
                     * @return Progress 语音翻译任务进度，取值范围 [0-100] 。
                     * 
                     */
                    int64_t GetProgress() const;

                    /**
                     * 设置语音翻译任务进度，取值范围 [0-100] 。
                    ...
                    /**
                     * 获取语音翻译任务开始执行的时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
                     * @return BeginProcessTime 语音翻译任务开始执行的时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
                     * 
                     */
                    std::string GetBeginProcessTime() const;

                    /**
                     * 设置语音翻译任务开始执行的时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
                    ...
                    /**
                     * 获取语音翻译任务执行完毕的时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
                     * @return FinishTime 语音翻译任务执行完毕的时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
                     * 
                     */
                    std::string GetFinishTime() const;

                    /**
                     * 设置语音翻译任务执行完毕的时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
