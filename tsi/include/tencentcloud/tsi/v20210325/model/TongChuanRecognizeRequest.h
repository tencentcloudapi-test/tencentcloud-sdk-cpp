...
#ifndef TENCENTCLOUD_TSI_V20210325_MODEL_TONGCHUANRECOGNIZEREQUEST_H_
#define TENCENTCLOUD_TSI_V20210325_MODEL_TONGCHUANRECOGNIZEREQUEST_H_
    ...
    namespace Tsi
    {
        namespace V20210325
        {
            namespace Model
            {
                ...
                */
                class TongChuanRecognizeRequest : public AbstractModel
                {
                public:
                    TongChuanRecognizeRequest();
                    ~TongChuanRecognizeRequest() = default;
...
#endif // !TENCENTCLOUD_TSI_V20210325_MODEL_TONGCHUANRECOGNIZEREQUEST_H_
