...
#ifndef TENCENTCLOUD_TCR_V20190924_MODEL_CREATEIMMUTABLETAGRULESREQUEST_H_
#define TENCENTCLOUD_TCR_V20190924_MODEL_CREATEIMMUTABLETAGRULESREQUEST_H_
    ...
    namespace Tcr
    {
        namespace V20190924
        {
            namespace Model
            {
                ...
                */
                class CreateImmutableTagRulesRequest : public AbstractModel
                {
                public:
                    CreateImmutableTagRulesRequest();
                    ~CreateImmutableTagRulesRequest() = default;
...
#endif // !TENCENTCLOUD_TCR_V20190924_MODEL_CREATEIMMUTABLETAGRULESREQUEST_H_
