...
#ifndef TENCENTCLOUD_IAI_V20200303_MODEL_GETUPGRADEGROUPFACEMODELVERSIONRESULTRESPONSE_H_
#define TENCENTCLOUD_IAI_V20200303_MODEL_GETUPGRADEGROUPFACEMODELVERSIONRESULTRESPONSE_H_
...
有关更多信息，请参阅 Unix 时间。
                    ...
                    /**
                     * 获取无法升级的人脸Id信息，文件格式为json。内容参见下方示例。url有效期为半小时。
                     * @return FailedFacesUrl 无法升级的人脸Id信息，文件格式为json。内容参见下方示例。url有效期为半小时。
                     * 
                     */
...
#endif // !TENCENTCLOUD_IAI_V20200303_MODEL_GETUPGRADEGROUPFACEMODELVERSIONRESULTRESPONSE_H_
