...
#ifndef TENCENTCLOUD_CFS_V20190719_MODEL_DESCRIBECFSRULESREQUEST_H_
#define TENCENTCLOUD_CFS_V20190719_MODEL_DESCRIBECFSRULESREQUEST_H_
    ...
    namespace Cfs
    {
        namespace V20190719
        {
            namespace Model
            {
                ...
                */
                class DescribeCfsRulesRequest : public AbstractModel
                {
                public:
                    DescribeCfsRulesRequest();
                    ~DescribeCfsRulesRequest() = default;
...
#endif // !TENCENTCLOUD_CFS_V20190719_MODEL_DESCRIBECFSRULESREQUEST_H_
