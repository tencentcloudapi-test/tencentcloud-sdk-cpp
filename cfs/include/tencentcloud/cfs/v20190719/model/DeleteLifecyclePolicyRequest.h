...
#ifndef TENCENTCLOUD_CFS_V20190719_MODEL_DELETELIFECYCLEPOLICYREQUEST_H_
#define TENCENTCLOUD_CFS_V20190719_MODEL_DELETELIFECYCLEPOLICYREQUEST_H_
    ...
    namespace Cfs
    {
        namespace V20190719
        {
            namespace Model
            {
                ...
                */
                class DeleteLifecyclePolicyRequest : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_CFS_V20190719_MODEL_DELETELIFECYCLEPOLICYREQUEST_H_
