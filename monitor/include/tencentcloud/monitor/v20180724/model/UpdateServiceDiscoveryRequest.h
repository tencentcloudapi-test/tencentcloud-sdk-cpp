...
#ifndef TENCENTCLOUD_MONITOR_V20180724_MODEL_UPDATESERVICEDISCOVERYREQUEST_H_
#define TENCENTCLOUD_MONITOR_V20180724_MODEL_UPDATESERVICEDISCOVERYREQUEST_H_
    ...
    namespace Monitor
    {
        namespace V20180724
        {
            namespace Model
            {
                ...
                */
                class UpdateServiceDiscoveryRequest : public AbstractModel
                {
                public:
                    UpdateServiceDiscoveryRequest();
                    ~UpdateServiceDiscoveryRequest() = default;
...
#endif // !TENCENTCLOUD_MONITOR_V20180724_MODEL_UPDATESERVICEDISCOVERYREQUEST_H_
