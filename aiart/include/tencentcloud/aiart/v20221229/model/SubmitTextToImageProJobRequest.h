...
#ifndef TENCENTCLOUD_AIART_V20221229_MODEL_SUBMITTEXTTOIMAGEPROJOBREQUEST_H_
#define TENCENTCLOUD_AIART_V20221229_MODEL_SUBMITTEXTTOIMAGEPROJOBREQUEST_H_
    ...
    namespace Aiart
    {
        namespace V20221229
        {
            namespace Model
            {
                ...
                */
                class SubmitTextToImageProJobRequest : public AbstractModel
                {
                public:
                    SubmitTextToImageProJobRequest();
                    ~SubmitTextToImageProJobRequest() = default;
...
#endif // !TENCENTCLOUD_AIART_V20221229_MODEL_SUBMITTEXTTOIMAGEPROJOBREQUEST_H_
