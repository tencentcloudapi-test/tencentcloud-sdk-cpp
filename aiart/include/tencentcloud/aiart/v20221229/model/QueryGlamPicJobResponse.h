...
#ifndef TENCENTCLOUD_AIART_V20221229_MODEL_QUERYGLAMPICJOBRESPONSE_H_
#define TENCENTCLOUD_AIART_V20221229_MODEL_QUERYGLAMPICJOBRESPONSE_H_
    ...
    namespace Aiart
    {
        namespace V20221229
        {
            namespace Model
            {
                ...
                */
                class QueryGlamPicJobResponse : public AbstractModel
                {
                public:
                    QueryGlamPicJobResponse();
                    ~QueryGlamPicJobResponse() = default;
...
#endif // !TENCENTCLOUD_AIART_V20221229_MODEL_QUERYGLAMPICJOBRESPONSE_H_
