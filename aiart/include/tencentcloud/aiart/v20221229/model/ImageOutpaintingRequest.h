...
#ifndef TENCENTCLOUD_AIART_V20221229_MODEL_IMAGEOUTPAINTINGREQUEST_H_
#define TENCENTCLOUD_AIART_V20221229_MODEL_IMAGEOUTPAINTINGREQUEST_H_
    ...
    namespace Aiart
    {
        namespace V20221229
        {
            namespace Model
            {
                ...
                */
                class ImageOutpaintingRequest : public AbstractModel
                {
                public:
                    ImageOutpaintingRequest();
                    ~ImageOutpaintingRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取扩展后的比例（宽:高），需要不等于原图比例。
...
#endif // !TENCENTCLOUD_AIART_V20221229_MODEL_IMAGEOUTPAINTINGREQUEST_H_
