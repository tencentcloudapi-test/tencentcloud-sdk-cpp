...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAEVENTURLREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAEVENTURLREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataEventUrlRequest : public AbstractModel
                {
                public:
                    DescribeDataEventUrlRequest();
                    ~DescribeDataEventUrlRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAEVENTURLREQUEST_H_
