...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAPVURLSTATISTICSREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAPVURLSTATISTICSREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataPvUrlStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeDataPvUrlStatisticsRequest();
                    ~DescribeDataPvUrlStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAPVURLSTATISTICSREQUEST_H_
