...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASETURLSTATISTICSREQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASETURLSTATISTICSREQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataSetUrlStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeDataSetUrlStatisticsRequest();
                    ~DescribeDataSetUrlStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASETURLSTATISTICSREQUEST_H_
