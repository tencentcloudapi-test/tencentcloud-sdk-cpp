...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DELETECLOUDMODERATIONREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DELETECLOUDMODERATIONREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DeleteCloudModerationRequest : public AbstractModel
                {
                public:
                    DeleteCloudModerationRequest();
                    ~DeleteCloudModerationRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DELETECLOUDMODERATIONREQUEST_H_
