...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEMIXTRANSCODINGUSAGEREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEMIXTRANSCODINGUSAGEREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeMixTranscodingUsageRequest : public AbstractModel
                {
                public:
                    DescribeMixTranscodingUsageRequest();
                    ~DescribeMixTranscodingUsageRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEMIXTRANSCODINGUSAGEREQUEST_H_
