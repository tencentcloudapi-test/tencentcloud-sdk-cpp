...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEMIXTRANSCODINGUSAGERESPONSE_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEMIXTRANSCODINGUSAGERESPONSE_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeMixTranscodingUsageResponse : public AbstractModel
                {
                public:
                    DescribeMixTranscodingUsageResponse();
                    ~DescribeMixTranscodingUsageResponse() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBEMIXTRANSCODINGUSAGERESPONSE_H_
