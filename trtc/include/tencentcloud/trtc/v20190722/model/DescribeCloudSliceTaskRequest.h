...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBECLOUDSLICETASKREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBECLOUDSLICETASKREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeCloudSliceTaskRequest : public AbstractModel
                {
                public:
                    DescribeCloudSliceTaskRequest();
                    ~DescribeCloudSliceTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBECLOUDSLICETASKREQUEST_H_
