...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_MODIFYCLOUDSLICETASKREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_MODIFYCLOUDSLICETASKREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class ModifyCloudSliceTaskRequest : public AbstractModel
                {
                public:
                    ModifyCloudSliceTaskRequest();
                    ~ModifyCloudSliceTaskRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_MODIFYCLOUDSLICETASKREQUEST_H_
