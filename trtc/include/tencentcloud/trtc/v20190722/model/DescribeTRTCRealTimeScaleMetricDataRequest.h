...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCREALTIMESCALEMETRICDATAREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCREALTIMESCALEMETRICDATAREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeTRTCRealTimeScaleMetricDataRequest : public AbstractModel
                {
                public:
                    DescribeTRTCRealTimeScaleMetricDataRequest();
                    ~DescribeTRTCRealTimeScaleMetricDataRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCREALTIMESCALEMETRICDATAREQUEST_H_
