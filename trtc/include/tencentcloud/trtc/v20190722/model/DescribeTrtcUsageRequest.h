...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCUSAGEREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCUSAGEREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DescribeTrtcUsageRequest : public AbstractModel
                {
                public:
                    DescribeTrtcUsageRequest();
                    ~DescribeTrtcUsageRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DESCRIBETRTCUSAGEREQUEST_H_
