...
#ifndef TENCENTCLOUD_TRTC_V20190722_MODEL_DELETEVOICEPRINTREQUEST_H_
#define TENCENTCLOUD_TRTC_V20190722_MODEL_DELETEVOICEPRINTREQUEST_H_
    ...
    namespace Trtc
    {
        namespace V20190722
        {
            namespace Model
            {
                ...
                */
                class DeleteVoicePrintRequest : public AbstractModel
                {
                public:
                    DeleteVoicePrintRequest();
                    ~DeleteVoicePrintRequest() = default;
...
#endif // !TENCENTCLOUD_TRTC_V20190722_MODEL_DELETEVOICEPRINTREQUEST_H_
