...
#ifndef TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEREBATEINFOSREQUEST_H_
#define TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEREBATEINFOSREQUEST_H_
    ...
    namespace Partners
    {
        namespace V20180321
        {
            namespace Model
            {
                ...
                */
                class DescribeRebateInfosRequest : public AbstractModel
                {
                public:
                    DescribeRebateInfosRequest();
                    ~DescribeRebateInfosRequest() = default;
...
#endif // !TENCENTCLOUD_PARTNERS_V20180321_MODEL_DESCRIBEREBATEINFOSREQUEST_H_
