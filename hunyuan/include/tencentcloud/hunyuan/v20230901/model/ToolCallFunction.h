...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_TOOLCALLFUNCTION_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_TOOLCALLFUNCTION_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                * 具体的function调用
                */
                class ToolCallFunction : public AbstractModel
                {
                public:
                    ToolCallFunction();
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_TOOLCALLFUNCTION_H_
