...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GETTHREADRESPONSE_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GETTHREADRESPONSE_H_
...
namespace TencentCloud
{
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                class ThreadToolResources;

                /**
                * GetThread返回参数结构体
                */
                class GetThreadResponse : public AbstractModel
                {
                public:
                    GetThreadResponse();
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_GETTHREADRESPONSE_H_
