...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_LISTSCIMCREDENTIALSREQUEST_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_LISTSCIMCREDENTIALSREQUEST_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                */
                class ListSCIMCredentialsRequest : public AbstractModel
                {
                public:
                    ListSCIMCredentialsRequest();
                    ~ListSCIMCredentialsRequest() = default;
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_LISTSCIMCREDENTIALSREQUEST_H_
