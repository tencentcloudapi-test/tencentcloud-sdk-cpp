...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETEROLECONFIGURATIONREQUEST_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETEROLECONFIGURATIONREQUEST_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                */
                class DeleteRoleConfigurationRequest : public AbstractModel
                {
                public:
                    DeleteRoleConfigurationRequest();
                    ~DeleteRoleConfigurationRequest() = default;
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETEROLECONFIGURATIONREQUEST_H_
