...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DISMANTLEROLECONFIGURATIONREQUEST_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DISMANTLEROLECONFIGURATIONREQUEST_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                */
                class DismantleRoleConfigurationRequest : public AbstractModel
                {
                public:
                    DismantleRoleConfigurationRequest();
                    ~DismantleRoleConfigurationRequest() = default;
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DISMANTLEROLECONFIGURATIONREQUEST_H_
