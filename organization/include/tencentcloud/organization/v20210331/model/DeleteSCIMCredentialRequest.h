...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETESCIMCREDENTIALREQUEST_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETESCIMCREDENTIALREQUEST_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                */
                class DeleteSCIMCredentialRequest : public AbstractModel
                {
                public:
                    DeleteSCIMCredentialRequest();
                    ~DeleteSCIMCredentialRequest() = default;
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETESCIMCREDENTIALREQUEST_H_
