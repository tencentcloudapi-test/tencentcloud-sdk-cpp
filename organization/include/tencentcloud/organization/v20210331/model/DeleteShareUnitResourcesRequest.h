...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETESHAREUNITRESOURCESREQUEST_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETESHAREUNITRESOURCESREQUEST_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                */
                class DeleteShareUnitResourcesRequest : public AbstractModel
                {
                public:
                    DeleteShareUnitResourcesRequest();
                    ~DeleteShareUnitResourcesRequest() = default;
                     ...
                     * 
                     */
                    std::vector<ShareResource> GetResources() const;
                     ...
                     * 
                     */
                    void SetResources(const std::vector<ShareResource>& _resources);
                ...
                private:
                     ...
                     * 共享资源列表。最大10个。
                     */
                    std::vector<ShareResource> m_resources;
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETESHAREUNITRESOURCESREQUEST_H_
