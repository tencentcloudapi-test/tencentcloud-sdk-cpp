...
#ifndef TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETESHAREUNITMEMBERSREQUEST_H_
#define TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETESHAREUNITMEMBERSREQUEST_H_
    ...
    namespace Organization
    {
        namespace V20210331
        {
            namespace Model
            {
                ...
                */
                class DeleteShareUnitMembersRequest : public AbstractModel
                {
                public:
                    DeleteShareUnitMembersRequest();
                    ~DeleteShareUnitMembersRequest() = default;
...
#endif // !TENCENTCLOUD_ORGANIZATION_V20210331_MODEL_DELETESHAREUNITMEMBERSREQUEST_H_
