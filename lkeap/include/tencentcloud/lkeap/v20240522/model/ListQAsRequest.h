...
#ifndef TENCENTCLOUD_LKEAP_V20240522_MODEL_LISTQASREQUEST_H_
#define TENCENTCLOUD_LKEAP_V20240522_MODEL_LISTQASREQUEST_H_
    ...
    namespace Lkeap
    {
        namespace V20240522
        {
            namespace Model
            {
                ...
                * ListQAs请求参数结构体
                */
                class ListQAsRequest : public AbstractModel
                {
                public:
                    ListQAsRequest();
                    ~ListQAsRequest() = default;
...
#endif // !TENCENTCLOUD_LKEAP_V20240522_MODEL_LISTQASREQUEST_H_
