...
#ifndef TENCENTCLOUD_LKEAP_V20240522_MODEL_LISTDOCSREQUEST_H_
#define TENCENTCLOUD_LKEAP_V20240522_MODEL_LISTDOCSREQUEST_H_
    ...
    namespace Lkeap
    {
        namespace V20240522
        {
            namespace Model
            {
                ...
                * ListDocs请求参数结构体
                */
                class ListDocsRequest : public AbstractModel
                {
                public:
                    ListDocsRequest();
...
#endif // !TENCENTCLOUD_LKEAP_V20240522_MODEL_LISTDOCSREQUEST_H_
