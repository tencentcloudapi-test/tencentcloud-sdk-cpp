...
#ifndef TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEFWGROUPINSTANCEINFOREQUEST_H_
#define TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEFWGROUPINSTANCEINFOREQUEST_H_
    ...
    namespace Cfw
    {
        namespace V20190904
        {
            namespace Model
            {
                ...
                */
                class DescribeFwGroupInstanceInfoRequest : public AbstractModel
                {
                public:
                    DescribeFwGroupInstanceInfoRequest();
                    ~DescribeFwGroupInstanceInfoRequest() = default;
...
#endif // !TENCENTCLOUD_CFW_V20190904_MODEL_DESCRIBEFWGROUPINSTANCEINFOREQUEST_H_
