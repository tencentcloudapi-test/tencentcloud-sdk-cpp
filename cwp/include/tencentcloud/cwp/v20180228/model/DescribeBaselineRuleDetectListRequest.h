...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEBASELINERULEDETECTLISTREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEBASELINERULEDETECTLISTREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeBaselineRuleDetectListRequest : public AbstractModel
                {
                public:
                    DescribeBaselineRuleDetectListRequest();
                    ~DescribeBaselineRuleDetectListRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEBASELINERULEDETECTLISTREQUEST_H_
