...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTASSETPLANTASKLISTREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTASSETPLANTASKLISTREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class ExportAssetPlanTaskListRequest : public AbstractModel
                {
                public:
                    ExportAssetPlanTaskListRequest();
                    ~ExportAssetPlanTaskListRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTASSETPLANTASKLISTREQUEST_H_
