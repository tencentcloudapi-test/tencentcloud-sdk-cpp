...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEBASELINEFIXLISTREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEBASELINEFIXLISTREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeBaselineFixListRequest : public AbstractModel
                {
                public:
                    DescribeBaselineFixListRequest();
                    ~DescribeBaselineFixListRequest() = default;
                    ...
                    /**
                     * 获取可选排序列: [CreateTime|MoifyTime|FixTime]
                    ...
                    /**
                     * 设置可选排序列: [CreateTime|MoifyTime|FixTime]
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEBASELINEFIXLISTREQUEST_H_
