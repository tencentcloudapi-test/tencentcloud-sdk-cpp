...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEBASELINESTRATEGYLISTRESPONSE_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEBASELINESTRATEGYLISTRESPONSE_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeBaselineStrategyListResponse : public AbstractModel
                {
                public:
                    DescribeBaselineStrategyListResponse();
                    ~DescribeBaselineStrategyListResponse() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEBASELINESTRATEGYLISTRESPONSE_H_
