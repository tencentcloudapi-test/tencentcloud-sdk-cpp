...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEASSETAPPLISTREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEASSETAPPLISTREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeAssetAppListRequest : public AbstractModel
                {
                public:
                    DescribeAssetAppListRequest();
                    ~DescribeAssetAppListRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBEASSETAPPLISTREQUEST_H_
