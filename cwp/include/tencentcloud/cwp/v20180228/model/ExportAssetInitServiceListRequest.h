...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTASSETINITSERVICELISTREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTASSETINITSERVICELISTREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class ExportAssetInitServiceListRequest : public AbstractModel
                {
                public:
                    ExportAssetInitServiceListRequest();
                    ~ExportAssetInitServiceListRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_EXPORTASSETINITSERVICELISTREQUEST_H_
