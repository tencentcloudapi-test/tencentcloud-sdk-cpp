            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取过滤条件。支持ApiAppId、ApiAppName、KeyWord（ 可以匹配name或者ID）。
                     * @return Filters 过滤条件。支持ApiAppId、ApiAppName、KeyWord（ 可以匹配name或者ID）。
                     * 
                     */
                    std::vector<Filter> GetFilters() const;

                    /**
                     * 设置过滤条件。支持ApiAppId、ApiAppName、KeyWord（ 可以匹配name或者ID）。
