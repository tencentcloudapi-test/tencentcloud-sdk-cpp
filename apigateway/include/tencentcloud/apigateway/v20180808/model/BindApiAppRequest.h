...
#ifndef TENCENTCLOUD_APIGATEWAY_V20180808_MODEL_BINDAPIAPPREQUEST_H_
    ...
    namespace Apigateway
    {
        namespace V20180808
        {
            namespace Model
            {
                ...
                * BindApiApp请求参数结构体
                */
                class BindApiAppRequest : public AbstractModel
                {
                public:
                    BindApiAppRequest();
                    ~BindApiAppRequest() = default;
...
#endif // !TENCENTCLOUD_APIGATEWAY_V20180808_MODEL_BINDAPIAPPREQUEST_H_
