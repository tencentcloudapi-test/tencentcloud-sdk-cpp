...
#ifndef TENCENTCLOUD_GOOSEFS_V20220519_MODEL_GOOSEFSXBUILDELEMENT_H_
#define TENCENTCLOUD_GOOSEFS_V20220519_MODEL_GOOSEFSXBUILDELEMENT_H_
    ...
    namespace Goosefs
    {
        namespace V20220519
        {
            namespace Model
            {
                ...
                * GooseFSx创建时候的属性
                */
                class GooseFSxBuildElement : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_GOOSEFS_V20220519_MODEL_GOOSEFSXBUILDELEMENT_H_
