...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBEINPUTRISTSETTINGS_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBEINPUTRISTSETTINGS_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 查询输入的RIST配置信息。
                */
                class DescribeInputRISTSettings : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBEINPUTRISTSETTINGS_H_
