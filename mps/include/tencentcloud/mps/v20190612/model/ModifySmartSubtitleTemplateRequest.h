...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_MODIFYSMARTSUBTITLETEMPLATEREQUEST_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_MODIFYSMARTSUBTITLETEMPLATEREQUEST_H_
...
namespace TencentCloud
{
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                class AsrHotWordsConfigure;

                /**
                * ModifySmartSubtitleTemplate请求参数结构体
                */
                class ModifySmartSubtitleTemplateRequest : public AbstractModel
                {
                public:
                    ModifySmartSubtitleTemplateRequest();
                    ~ModifySmartSubtitleTemplateRequest() = default;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_MODIFYSMARTSUBTITLETEMPLATEREQUEST_H_
