...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_DELETESCHEDULEREQUEST_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_DELETESCHEDULEREQUEST_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                */
                class DeleteScheduleRequest : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_DELETESCHEDULEREQUEST_H_
