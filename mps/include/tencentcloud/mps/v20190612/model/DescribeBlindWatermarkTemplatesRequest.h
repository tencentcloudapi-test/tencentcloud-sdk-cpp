            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取数字水印模板唯一标识过滤条件，数组长度限制：100。
                     * @return Definitions 数字水印模板唯一标识过滤条件，数组长度限制：100。
                     * 
                     */
                    std::vector<int64_t> GetDefinitions() const;

                    /**
                     * 设置数字水印模板唯一标识过滤条件，数组长度限制：100。
                    ...
                    /**
                     * 获取数字水印模板标识过滤条件，长度限制：64 个字符。
                     * @return Name 数字水印模板标识过滤条件，长度限制：64 个字符。
                     * 
                     */
                    std::string GetName() const;

                    /**
                     * 设置数字水印模板标识过滤条件，长度限制：64 个字符。
