...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_FACEENHANCECONFIG_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_FACEENHANCECONFIG_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                * 人脸增强配置
                */
                class FaceEnhanceConfig : public AbstractModel
                {
                public:
                    FaceEnhanceConfig();
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_FACEENHANCECONFIG_H_
