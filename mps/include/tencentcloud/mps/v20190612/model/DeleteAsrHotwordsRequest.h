...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_DELETEASRHOTWORDSREQUEST_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_DELETEASRHOTWORDSREQUEST_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                */
                class DeleteAsrHotwordsRequest : public AbstractModel
                {
                public:
                    DeleteAsrHotwordsRequest();
                    ~DeleteAsrHotwordsRequest() = default;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_DELETEASRHOTWORDSREQUEST_H_
