...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBESTREAMLINKFLOWSTATISTICSREQUEST_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBESTREAMLINKFLOWSTATISTICSREQUEST_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                */
                class DescribeStreamLinkFlowStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeStreamLinkFlowStatisticsRequest();
                    ~DescribeStreamLinkFlowStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBESTREAMLINKFLOWSTATISTICSREQUEST_H_
