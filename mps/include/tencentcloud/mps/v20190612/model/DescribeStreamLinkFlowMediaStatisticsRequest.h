...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBESTREAMLINKFLOWMEDIASTATISTICSREQUEST_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBESTREAMLINKFLOWMEDIASTATISTICSREQUEST_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                */
                class DescribeStreamLinkFlowMediaStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeStreamLinkFlowMediaStatisticsRequest();
                    ~DescribeStreamLinkFlowMediaStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_DESCRIBESTREAMLINKFLOWMEDIASTATISTICSREQUEST_H_
