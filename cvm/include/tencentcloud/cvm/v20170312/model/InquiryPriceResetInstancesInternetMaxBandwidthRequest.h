...
#ifndef TENCENTCLOUD_CVM_V20170312_MODEL_INQUIRYPRICERESETINSTANCESINTERNETMAXBANDWIDTHREQUEST_H_
#define TENCENTCLOUD_CVM_V20170312_MODEL_INQUIRYPRICERESETINSTANCESINTERNETMAXBANDWIDTHREQUEST_H_
    ...
    namespace Cvm
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class InquiryPriceResetInstancesInternetMaxBandwidthRequest : public AbstractModel
                {
                public:
                    InquiryPriceResetInstancesInternetMaxBandwidthRequest();
                    ~InquiryPriceResetInstancesInternetMaxBandwidthRequest() = default;
...
#endif // !TENCENTCLOUD_CVM_V20170312_MODEL_INQUIRYPRICERESETINSTANCESINTERNETMAXBANDWIDTHREQUEST_H_
