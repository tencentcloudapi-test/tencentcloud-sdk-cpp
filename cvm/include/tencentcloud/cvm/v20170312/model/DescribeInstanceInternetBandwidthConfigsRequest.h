...
#ifndef TENCENTCLOUD_CVM_V20170312_MODEL_DESCRIBEINSTANCEINTERNETBANDWIDTHCONFIGSREQUEST_H_
#define TENCENTCLOUD_CVM_V20170312_MODEL_DESCRIBEINSTANCEINTERNETBANDWIDTHCONFIGSREQUEST_H_
    ...
    namespace Cvm
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeInstanceInternetBandwidthConfigsRequest : public AbstractModel
                {
                public:
                    DescribeInstanceInternetBandwidthConfigsRequest();
                    ~DescribeInstanceInternetBandwidthConfigsRequest() = default;
...
#endif // !TENCENTCLOUD_CVM_V20170312_MODEL_DESCRIBEINSTANCEINTERNETBANDWIDTHCONFIGSREQUEST_H_
