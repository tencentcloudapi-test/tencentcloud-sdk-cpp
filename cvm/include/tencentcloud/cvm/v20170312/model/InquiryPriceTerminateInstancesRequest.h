...
#ifndef TENCENTCLOUD_CVM_V20170312_MODEL_INQUIRYPRICETERMINATEINSTANCESREQUEST_H_
#define TENCENTCLOUD_CVM_V20170312_MODEL_INQUIRYPRICETERMINATEINSTANCESREQUEST_H_
    ...
    namespace Cvm
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class InquiryPriceTerminateInstancesRequest : public AbstractModel
                {
                public:
                    InquiryPriceTerminateInstancesRequest();
                    ~InquiryPriceTerminateInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_CVM_V20170312_MODEL_INQUIRYPRICETERMINATEINSTANCESREQUEST_H_
