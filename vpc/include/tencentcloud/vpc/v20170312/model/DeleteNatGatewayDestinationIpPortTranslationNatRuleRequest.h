...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DELETENATGATEWAYDESTINATIONIPPORTTRANSLATIONNATRULEREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DELETENATGATEWAYDESTINATIONIPPORTTRANSLATIONNATRULEREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest : public AbstractModel
                {
                public:
                    DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest();
                    ~DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DELETENATGATEWAYDESTINATIONIPPORTTRANSLATIONNATRULEREQUEST_H_
