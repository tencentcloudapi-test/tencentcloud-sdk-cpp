...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_REJECTVPCPEERINGCONNECTIONREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_REJECTVPCPEERINGCONNECTIONREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class RejectVpcPeeringConnectionRequest : public AbstractModel
                {
                public:
                    RejectVpcPeeringConnectionRequest();
                    ~RejectVpcPeeringConnectionRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_REJECTVPCPEERINGCONNECTIONREQUEST_H_
