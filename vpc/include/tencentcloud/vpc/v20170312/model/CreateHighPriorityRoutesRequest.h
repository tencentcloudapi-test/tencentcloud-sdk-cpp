...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_CREATEHIGHPRIORITYROUTESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_CREATEHIGHPRIORITYROUTESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class CreateHighPriorityRoutesRequest : public AbstractModel
                {
                public:
                    CreateHighPriorityRoutesRequest();
                    ~CreateHighPriorityRoutesRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_CREATEHIGHPRIORITYROUTESREQUEST_H_
