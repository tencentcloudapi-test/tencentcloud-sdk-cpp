...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DELETEHIGHPRIORITYROUTESRESPONSE_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DELETEHIGHPRIORITYROUTESRESPONSE_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DeleteHighPriorityRoutesResponse : public AbstractModel
                {
                public:
                    DeleteHighPriorityRoutesResponse();
                    ~DeleteHighPriorityRoutesResponse() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DELETEHIGHPRIORITYROUTESRESPONSE_H_
