...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_ENABLECCNROUTESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_ENABLECCNROUTESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class EnableCcnRoutesRequest : public AbstractModel
                {
                public:
                    EnableCcnRoutesRequest();
                    ~EnableCcnRoutesRequest() = default;
                    ...
                    /**
                     * 获取CCN路由策略唯一ID。形如：ccnr-f49l6u0z。可通过DescribeCcnRoutes接口获取。
                     * @return RouteIds CCN路由策略唯一ID。形如：ccnr-f49l6u0z。可通过DescribeCcnRoutes接口获取。
                     * 
                     */
                    std::vector<std::string> GetRouteIds() const;

                    /**
                     * 设置CCN路由策略唯一ID。形如：ccnr-f49l6u0z。可通过DescribeCcnRoutes接口获取。
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_ENABLECCNROUTESREQUEST_H_
