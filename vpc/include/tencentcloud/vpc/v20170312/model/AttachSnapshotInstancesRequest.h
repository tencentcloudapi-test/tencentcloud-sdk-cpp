...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_ATTACHSNAPSHOTINSTANCESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_ATTACHSNAPSHOTINSTANCESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class AttachSnapshotInstancesRequest : public AbstractModel
                {
                public:
                    AttachSnapshotInstancesRequest();
                    ~AttachSnapshotInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_ATTACHSNAPSHOTINSTANCESREQUEST_H_
