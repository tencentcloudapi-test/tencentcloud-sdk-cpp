...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYPRIVATENATGATEWAYTRANSLATIONACLRULEREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYPRIVATENATGATEWAYTRANSLATIONACLRULEREQUEST_H_
...
namespace TencentCloud
{
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                class TranslationAclRule;

                /**
                * ModifyPrivateNatGatewayTranslationAclRule请求参数结构体
                */
                class ModifyPrivateNatGatewayTranslationAclRuleRequest : public AbstractModel
                {
                public:
                    ModifyPrivateNatGatewayTranslationAclRuleRequest();
                    ~ModifyPrivateNatGatewayTranslationAclRuleRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYPRIVATENATGATEWAYTRANSLATIONACLRULEREQUEST_H_
