...
<li>service-port- 协议端口。</li>
                    ...
                    /**
                     * 获取排序字段。支持：`ServiceTemplateId ` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
                    ...
                    /**
                     * 设置排序字段。支持：`ServiceTemplateId ` `CreatedTime` `UpdateTime`。注意：该字段没有默认值。
                    ...
                    /**
                     * 获取协议端口排序字段。支持：`Service ` `UpdateTime`。注意：该字段没有默认值。
                    ...
                    /**
                     * 设置协议端口排序字段。支持：`Service ` `UpdateTime`。注意：该字段没有默认值。
                    ...
                    /**
                     * 获取协议端口排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
                    ...
                    /**
                     * 设置协议端口排序方法。升序：`ASC`，倒序：`DESC`。注意：该字段没有默认值。
