...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_ALLOCATEIP6ADDRESSESBANDWIDTHRESPONSE_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_ALLOCATEIP6ADDRESSESBANDWIDTHRESPONSE_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class AllocateIp6AddressesBandwidthResponse : public AbstractModel
                {
                public:
                    AllocateIp6AddressesBandwidthResponse();
                    ~AllocateIp6AddressesBandwidthResponse() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_ALLOCATEIP6ADDRESSESBANDWIDTHRESPONSE_H_
