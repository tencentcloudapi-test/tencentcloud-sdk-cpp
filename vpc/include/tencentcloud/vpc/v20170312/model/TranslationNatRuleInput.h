...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_TRANSLATIONNATRULEINPUT_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_TRANSLATIONNATRULEINPUT_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                * 私网网关Snat转发规则入参
                */
                class TranslationNatRuleInput : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_TRANSLATIONNATRULEINPUT_H_
