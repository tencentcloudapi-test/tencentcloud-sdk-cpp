...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEROUTESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEROUTESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeRoutesRequest : public AbstractModel
                {
                public:
                    DescribeRoutesRequest();
                    ~DescribeRoutesRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEROUTESREQUEST_H_
