...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEVPNGATEWAYSSLCLIENTSRESPONSE_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEVPNGATEWAYSSLCLIENTSRESPONSE_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeVpnGatewaySslClientsResponse : public AbstractModel
                {
                public:
                    DescribeVpnGatewaySslClientsResponse();
                    ~DescribeVpnGatewaySslClientsResponse() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBEVPNGATEWAYSSLCLIENTSRESPONSE_H_
