...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DELETEPRIVATENATGATEWAYDESTINATIONIPPORTTRANSLATIONNATRULEREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DELETEPRIVATENATGATEWAYDESTINATIONIPPORTTRANSLATIONNATRULEREQUEST_H_
...
namespace TencentCloud
{
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                class LocalDestinationIpPortTranslationNatRule;

                /**
                * DeletePrivateNatGatewayDestinationIpPortTranslationNatRule请求参数结构体
                */
                class DeletePrivateNatGatewayDestinationIpPortTranslationNatRuleRequest : public AbstractModel
                {
                public:
                    DeletePrivateNatGatewayDestinationIpPortTranslationNatRuleRequest();
                    ~DeletePrivateNatGatewayDestinationIpPortTranslationNatRuleRequest() = default;
                    ...
                    /**
                     * 获取目的端口转换规则数组。
                     * @return LocalDestinationIpPortTranslationNatRules 目的端口转换规则数组。
                     * 
                     */
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DELETEPRIVATENATGATEWAYDESTINATIONIPPORTTRANSLATIONNATRULEREQUEST_H_
