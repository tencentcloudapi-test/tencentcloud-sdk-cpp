...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYNETWORKACLQUINTUPLEENTRIESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYNETWORKACLQUINTUPLEENTRIESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class ModifyNetworkAclQuintupleEntriesRequest : public AbstractModel
                {
                public:
                    ModifyNetworkAclQuintupleEntriesRequest();
                    ~ModifyNetworkAclQuintupleEntriesRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_MODIFYNETWORKACLQUINTUPLEENTRIESREQUEST_H_
