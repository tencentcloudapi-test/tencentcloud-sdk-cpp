...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESTINATIONIPPORTTRANSLATIONNATRULEDIFF_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESTINATIONIPPORTTRANSLATIONNATRULEDIFF_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                * 本端目的IP端口转换复杂结构
                */
                class DestinationIpPortTranslationNatRuleDiff : public AbstractModel
                {
                public:
                     ...
                     * 
                     */
                    std::string GetOldProtocol() const;
                     ...
                     * 
                     */
                    void SetOldProtocol(const std::string& _oldProtocol);

                    /**
                     * 判断参数 OldProtocol 是否已赋值
                     * @return OldProtocol 是否已赋值
                     * 
                     */
                    bool OldProtocolHasBeenSet() const;
                     ...
                     * 
                     */
                    int64_t GetOldOriginalPort() const;
                     ...
                     * 
                     */
                    void SetOldOriginalPort(const int64_t& _oldOriginalPort);

                    /**
                     * 判断参数 OldOriginalPort 是否已赋值
                     * @return OldOriginalPort 是否已赋值
                     * 
                     */
                    bool OldOriginalPortHasBeenSet() const;
                     ...
                     * 
                     */
                    int64_t GetOldTranslationPort() const;
                     ...
                     * 
                     */
                    void SetOldTranslationPort(const int64_t& _oldTranslationPort);

                    /**
                     * 判断参数 OldTranslationPort 是否已赋值
                     * @return OldTranslationPort 是否已赋值
                     * 
                     */
                    bool OldTranslationPortHasBeenSet() const;
                ...
                private:
                     ...
                     * 旧协议。
                     */
                    std::string m_oldProtocol;
                    bool m_oldProtocolHasBeenSet;

                    /**
                     * 旧映射前端口
                     */
                    int64_t m_oldOriginalPort;
                    bool m_oldOriginalPortHasBeenSet;
                     ...
                     * 旧映射后端口
                     */
                    int64_t m_oldTranslationPort;
                    bool m_oldTranslationPortHasBeenSet;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESTINATIONIPPORTTRANSLATIONNATRULEDIFF_H_
