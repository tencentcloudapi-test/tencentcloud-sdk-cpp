...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DELETEVPCPEERINGCONNECTIONREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DELETEVPCPEERINGCONNECTIONREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DeleteVpcPeeringConnectionRequest : public AbstractModel
                {
                public:
                    DeleteVpcPeeringConnectionRequest();
                    ~DeleteVpcPeeringConnectionRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DELETEVPCPEERINGCONNECTIONREQUEST_H_
