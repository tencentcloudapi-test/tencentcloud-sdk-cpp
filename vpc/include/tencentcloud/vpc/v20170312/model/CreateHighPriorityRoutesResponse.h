...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_CREATEHIGHPRIORITYROUTESRESPONSE_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_CREATEHIGHPRIORITYROUTESRESPONSE_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class CreateHighPriorityRoutesResponse : public AbstractModel
                {
                public:
                    CreateHighPriorityRoutesResponse();
                    ~CreateHighPriorityRoutesResponse() = default;
                    ...
                    /**
                     * 获取高优路由表信息。
                     * @return HighPriorityRouteSet 高优路由表信息。
                     * 
                     */
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_CREATEHIGHPRIORITYROUTESRESPONSE_H_
