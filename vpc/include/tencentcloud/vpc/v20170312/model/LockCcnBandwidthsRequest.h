...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_LOCKCCNBANDWIDTHSREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_LOCKCCNBANDWIDTHSREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class LockCcnBandwidthsRequest : public AbstractModel
                {
                public:
                    LockCcnBandwidthsRequest();
                    ~LockCcnBandwidthsRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_LOCKCCNBANDWIDTHSREQUEST_H_
