...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DELETEROUTEPOLICYENTRIESREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DELETEROUTEPOLICYENTRIESREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DeleteRoutePolicyEntriesRequest : public AbstractModel
                {
                public:
                    DeleteRoutePolicyEntriesRequest();
                    ~DeleteRoutePolicyEntriesRequest() = default;
                    ...
                    /**
                     * 获取路由接收策略条目列表，删除路由策略规则时，仅需使用RoutePolicyEntry的RoutePolicyEntryIdId字段。
                    ...
                    /**
                     * 设置路由接收策略条目列表，删除路由策略规则时，仅需使用RoutePolicyEntry的RoutePolicyEntryIdId字段。
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DELETEROUTEPOLICYENTRIESREQUEST_H_
