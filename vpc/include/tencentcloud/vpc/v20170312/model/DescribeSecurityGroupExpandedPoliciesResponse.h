...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBESECURITYGROUPEXPANDEDPOLICIESRESPONSE_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBESECURITYGROUPEXPANDEDPOLICIESRESPONSE_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DescribeSecurityGroupExpandedPoliciesResponse : public AbstractModel
                {
                public:
                    DescribeSecurityGroupExpandedPoliciesResponse();
                    ~DescribeSecurityGroupExpandedPoliciesResponse() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DESCRIBESECURITYGROUPEXPANDEDPOLICIESRESPONSE_H_
