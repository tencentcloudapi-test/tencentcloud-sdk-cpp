...
#ifndef TENCENTCLOUD_VPC_V20170312_MODEL_DELETETEMPLATEMEMBERREQUEST_H_
#define TENCENTCLOUD_VPC_V20170312_MODEL_DELETETEMPLATEMEMBERREQUEST_H_
    ...
    namespace Vpc
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class DeleteTemplateMemberRequest : public AbstractModel
                {
                public:
                    DeleteTemplateMemberRequest();
                    ~DeleteTemplateMemberRequest() = default;
...
#endif // !TENCENTCLOUD_VPC_V20170312_MODEL_DELETETEMPLATEMEMBERREQUEST_H_
