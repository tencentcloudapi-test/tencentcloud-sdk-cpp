...
#ifndef TENCENTCLOUD_MNA_V20210119_MODEL_GETFLOWSTATISTICRESPONSE_H_
#define TENCENTCLOUD_MNA_V20210119_MODEL_GETFLOWSTATISTICRESPONSE_H_
    ...
    namespace Mna
    {
        namespace V20210119
        {
            namespace Model
            {
                ...
                */
                class GetFlowStatisticResponse : public AbstractModel
                {
                public:
                    GetFlowStatisticResponse();
                    ~GetFlowStatisticResponse() = default;
...
#endif // !TENCENTCLOUD_MNA_V20210119_MODEL_GETFLOWSTATISTICRESPONSE_H_
