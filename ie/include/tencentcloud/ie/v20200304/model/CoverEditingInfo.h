...
#ifndef TENCENTCLOUD_IE_V20200304_MODEL_COVEREDITINGINFO_H_
#define TENCENTCLOUD_IE_V20200304_MODEL_COVEREDITINGINFO_H_
    ...
    namespace Ie
    {
        namespace V20200304
        {
            namespace Model
            {
                ...
                * 智能封面任务参数信息
                */
                class CoverEditingInfo : public AbstractModel
                {
                public:
                    CoverEditingInfo();
...
#endif // !TENCENTCLOUD_IE_V20200304_MODEL_COVEREDITINGINFO_H_
