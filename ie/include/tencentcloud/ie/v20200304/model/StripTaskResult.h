...
#ifndef TENCENTCLOUD_IE_V20200304_MODEL_STRIPTASKRESULT_H_
#define TENCENTCLOUD_IE_V20200304_MODEL_STRIPTASKRESULT_H_
    ...
    namespace Ie
    {
        namespace V20200304
        {
            namespace Model
            {
                ...
                * 智能拆条结果信息
                */
                class StripTaskResult : public AbstractModel
                {
                public:
                    StripTaskResult();
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<StripTaskResultItem> m_itemSet;
...
#endif // !TENCENTCLOUD_IE_V20200304_MODEL_STRIPTASKRESULT_H_
