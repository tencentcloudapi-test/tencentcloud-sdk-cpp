...
#ifndef TENCENTCLOUD_IE_V20200304_MODEL_CLASSIFICATIONEDITINGINFO_H_
#define TENCENTCLOUD_IE_V20200304_MODEL_CLASSIFICATIONEDITINGINFO_H_
    ...
    namespace Ie
    {
        namespace V20200304
        {
            namespace Model
            {
                ...
                * 视频分类识别任务参数信息
                */
                class ClassificationEditingInfo : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_IE_V20200304_MODEL_CLASSIFICATIONEDITINGINFO_H_
