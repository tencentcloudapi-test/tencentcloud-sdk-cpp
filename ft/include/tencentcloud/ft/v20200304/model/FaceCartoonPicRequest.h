...
#ifndef TENCENTCLOUD_FT_V20200304_MODEL_FACECARTOONPICREQUEST_H_
#define TENCENTCLOUD_FT_V20200304_MODEL_FACECARTOONPICREQUEST_H_
    ...
    namespace Ft
    {
        namespace V20200304
        {
            namespace Model
            {
                ...
                */
                class FaceCartoonPicRequest : public AbstractModel
                {
                public:
                    FaceCartoonPicRequest();
                    ~FaceCartoonPicRequest() = default;
...
支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。
                    ...
                    /**
                     * 判断参数 DisableGlobalEffect 是否已赋值
                     * @return DisableGlobalEffect 是否已赋值
                     * 
                     */
                    bool DisableGlobalEffectHasBeenSet() const;
...
#endif // !TENCENTCLOUD_FT_V20200304_MODEL_FACECARTOONPICREQUEST_H_
