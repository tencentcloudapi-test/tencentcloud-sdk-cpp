...
#ifndef TENCENTCLOUD_CHDFS_V20201112_MODEL_DESCRIBEACCESSGROUPREQUEST_H_
#define TENCENTCLOUD_CHDFS_V20201112_MODEL_DESCRIBEACCESSGROUPREQUEST_H_
    ...
    namespace Chdfs
    {
        namespace V20201112
        {
            namespace Model
            {
                ...
                */
                class DescribeAccessGroupRequest : public AbstractModel
                {
                public:
                    DescribeAccessGroupRequest();
                    ~DescribeAccessGroupRequest() = default;
...
#endif // !TENCENTCLOUD_CHDFS_V20201112_MODEL_DESCRIBEACCESSGROUPREQUEST_H_
