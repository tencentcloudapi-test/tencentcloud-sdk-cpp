...
#ifndef TENCENTCLOUD_EIAM_V20210420_MODEL_REMOVEUSERFROMUSERGROUPREQUEST_H_
#define TENCENTCLOUD_EIAM_V20210420_MODEL_REMOVEUSERFROMUSERGROUPREQUEST_H_
    ...
    namespace Eiam
    {
        namespace V20210420
        {
            namespace Model
            {
                ...
                */
                class RemoveUserFromUserGroupRequest : public AbstractModel
                {
                public:
                    RemoveUserFromUserGroupRequest();
                    ~RemoveUserFromUserGroupRequest() = default;
...
#endif // !TENCENTCLOUD_EIAM_V20210420_MODEL_REMOVEUSERFROMUSERGROUPREQUEST_H_
