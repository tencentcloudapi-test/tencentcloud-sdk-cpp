...
#ifndef TENCENTCLOUD_EIAM_V20210420_MODEL_LISTUSERSINORGNODESEARCHCRITERIA_H_
#define TENCENTCLOUD_EIAM_V20210420_MODEL_LISTUSERSINORGNODESEARCHCRITERIA_H_
    ...
    namespace Eiam
    {
        namespace V20210420
        {
            namespace Model
            {
                ...
                * 展示机构下用户的属性搜索条件。
                */
                class ListUsersInOrgNodeSearchCriteria : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_EIAM_V20210420_MODEL_LISTUSERSINORGNODESEARCHCRITERIA_H_
