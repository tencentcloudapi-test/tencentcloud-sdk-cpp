...
#ifndef TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDLICENSEREQUEST_H_
#define TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDLICENSEREQUEST_H_
    ...
    namespace Vcube
    {
        namespace V20220410
        {
            namespace Model
            {
                ...
                */
                class DescribeVcubeApplicationAndLicenseRequest : public AbstractModel
                {
                public:
                    DescribeVcubeApplicationAndLicenseRequest();
                    ~DescribeVcubeApplicationAndLicenseRequest() = default;
...
#endif // !TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDLICENSEREQUEST_H_
