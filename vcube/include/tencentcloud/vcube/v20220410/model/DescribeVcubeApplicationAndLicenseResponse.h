...
#ifndef TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDLICENSERESPONSE_H_
#define TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDLICENSERESPONSE_H_
    ...
    namespace Vcube
    {
        namespace V20220410
        {
            namespace Model
            {
                ...
                */
                class DescribeVcubeApplicationAndLicenseResponse : public AbstractModel
                {
                public:
                    DescribeVcubeApplicationAndLicenseResponse();
                    ~DescribeVcubeApplicationAndLicenseResponse() = default;
...
#endif // !TENCENTCLOUD_VCUBE_V20220410_MODEL_DESCRIBEVCUBEAPPLICATIONANDLICENSERESPONSE_H_
