...
#ifndef TENCENTCLOUD_VCUBE_V20220410_MODEL_LICENSERESOURCESIMPLEINFO_H_
#define TENCENTCLOUD_VCUBE_V20220410_MODEL_LICENSERESOURCESIMPLEINFO_H_
    ...
    namespace Vcube
    {
        namespace V20220410
        {
            namespace Model
            {
                ...
                * license 资源信息
                */
                class LicenseResourceSimpleInfo : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_VCUBE_V20220410_MODEL_LICENSERESOURCESIMPLEINFO_H_
