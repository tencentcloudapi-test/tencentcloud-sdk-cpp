...
#ifndef TENCENTCLOUD_LCIC_V20220817_MODEL_DELETEDOCUMENTREQUEST_H_
#define TENCENTCLOUD_LCIC_V20220817_MODEL_DELETEDOCUMENTREQUEST_H_
    ...
    namespace Lcic
    {
        namespace V20220817
        {
            namespace Model
            {
                ...
                */
                class DeleteDocumentRequest : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_LCIC_V20220817_MODEL_DELETEDOCUMENTREQUEST_H_
