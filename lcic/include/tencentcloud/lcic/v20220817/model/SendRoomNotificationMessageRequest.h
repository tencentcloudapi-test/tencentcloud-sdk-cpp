...
#ifndef TENCENTCLOUD_LCIC_V20220817_MODEL_SENDROOMNOTIFICATIONMESSAGEREQUEST_H_
#define TENCENTCLOUD_LCIC_V20220817_MODEL_SENDROOMNOTIFICATIONMESSAGEREQUEST_H_
    ...
    namespace Lcic
    {
        namespace V20220817
        {
            namespace Model
            {
                ...
                */
                class SendRoomNotificationMessageRequest : public AbstractModel
                {
                public:
                    SendRoomNotificationMessageRequest();
                    ~SendRoomNotificationMessageRequest() = default;
...
#endif // !TENCENTCLOUD_LCIC_V20220817_MODEL_SENDROOMNOTIFICATIONMESSAGEREQUEST_H_
