...
#ifndef TENCENTCLOUD_LCIC_V20220817_MODEL_CUSTOMRECORDINFO_H_
#define TENCENTCLOUD_LCIC_V20220817_MODEL_CUSTOMRECORDINFO_H_
    ...
    namespace Lcic
    {
        namespace V20220817
        {
            namespace Model
            {
                ...
                * 自定义录制信息
                */
                class CustomRecordInfo : public AbstractModel
                {
                public:
                    CustomRecordInfo();
...
#endif // !TENCENTCLOUD_LCIC_V20220817_MODEL_CUSTOMRECORDINFO_H_
