...
#ifndef TENCENTCLOUD_CME_V20191029_MODEL_FLATTENLISTMEDIARESPONSE_H_
#define TENCENTCLOUD_CME_V20191029_MODEL_FLATTENLISTMEDIARESPONSE_H_
    ...
    namespace Cme
    {
        namespace V20191029
        {
            namespace Model
            {
                ...
                */
                class FlattenListMediaResponse : public AbstractModel
                {
                public:
                    FlattenListMediaResponse();
                    ~FlattenListMediaResponse() = default;
...
#endif // !TENCENTCLOUD_CME_V20191029_MODEL_FLATTENLISTMEDIARESPONSE_H_
