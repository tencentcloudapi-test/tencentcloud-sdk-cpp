...
#ifndef TENCENTCLOUD_CME_V20191029_MODEL_DESCRIBEJOINTEAMSREQUEST_H_
#define TENCENTCLOUD_CME_V20191029_MODEL_DESCRIBEJOINTEAMSREQUEST_H_
    ...
    namespace Cme
    {
        namespace V20191029
        {
            namespace Model
            {
                ...
                */
                class DescribeJoinTeamsRequest : public AbstractModel
                {
                public:
                    DescribeJoinTeamsRequest();
                    ~DescribeJoinTeamsRequest() = default;
...
#endif // !TENCENTCLOUD_CME_V20191029_MODEL_DESCRIBEJOINTEAMSREQUEST_H_
