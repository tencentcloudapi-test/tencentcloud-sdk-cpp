...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_RECOVERRECYCLETABLESRESPONSE_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_RECOVERRECYCLETABLESRESPONSE_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                */
                class RecoverRecycleTablesResponse : public AbstractModel
                {
                public:
                    RecoverRecycleTablesResponse();
                    ~RecoverRecycleTablesResponse() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_RECOVERRECYCLETABLESRESPONSE_H_
