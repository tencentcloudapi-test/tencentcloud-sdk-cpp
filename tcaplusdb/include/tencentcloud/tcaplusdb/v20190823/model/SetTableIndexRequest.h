...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_SETTABLEINDEXREQUEST_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_SETTABLEINDEXREQUEST_H_
...
namespace TencentCloud
{
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                class SelectedTableWithField;

                /**
                * SetTableIndex请求参数结构体
                */
                class SetTableIndexRequest : public AbstractModel
                {
                public:
                    SetTableIndexRequest();
                    ~SetTableIndexRequest() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_SETTABLEINDEXREQUEST_H_
