...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DESCRIBETABLESINRECYCLERESPONSE_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DESCRIBETABLESINRECYCLERESPONSE_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                */
                class DescribeTablesInRecycleResponse : public AbstractModel
                {
                public:
                    DescribeTablesInRecycleResponse();
                    ~DescribeTablesInRecycleResponse() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DESCRIBETABLESINRECYCLERESPONSE_H_
