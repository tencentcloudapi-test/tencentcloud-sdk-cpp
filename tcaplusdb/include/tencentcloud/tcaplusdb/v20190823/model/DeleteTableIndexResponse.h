...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DELETETABLEINDEXRESPONSE_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DELETETABLEINDEXRESPONSE_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                */
                class DeleteTableIndexResponse : public AbstractModel
                {
                public:
                    DeleteTableIndexResponse();
                    ~DeleteTableIndexResponse() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_DELETETABLEINDEXRESPONSE_H_
