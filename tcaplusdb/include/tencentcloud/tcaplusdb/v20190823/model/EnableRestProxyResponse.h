...
#ifndef TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_ENABLERESTPROXYRESPONSE_H_
#define TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_ENABLERESTPROXYRESPONSE_H_
    ...
    namespace Tcaplusdb
    {
        namespace V20190823
        {
            namespace Model
            {
                ...
                */
                class EnableRestProxyResponse : public AbstractModel
                {
                public:
                    EnableRestProxyResponse();
                    ~EnableRestProxyResponse() = default;
...
#endif // !TENCENTCLOUD_TCAPLUSDB_V20190823_MODEL_ENABLERESTPROXYRESPONSE_H_
