...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_EXECUTECOMMANDONANDROIDINSTANCESREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_EXECUTECOMMANDONANDROIDINSTANCESREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class ExecuteCommandOnAndroidInstancesRequest : public AbstractModel
                {
                public:
                    ExecuteCommandOnAndroidInstancesRequest();
                    ~ExecuteCommandOnAndroidInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_EXECUTECOMMANDONANDROIDINSTANCESREQUEST_H_
