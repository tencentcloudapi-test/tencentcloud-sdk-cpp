...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCEADBRESPONSE_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCEADBRESPONSE_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class CreateAndroidInstanceADBResponse : public AbstractModel
                {
                public:
                    CreateAndroidInstanceADBResponse();
                    ~CreateAndroidInstanceADBResponse() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCEADBRESPONSE_H_
