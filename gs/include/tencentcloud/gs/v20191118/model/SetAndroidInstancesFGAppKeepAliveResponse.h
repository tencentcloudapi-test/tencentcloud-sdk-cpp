...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_SETANDROIDINSTANCESFGAPPKEEPALIVERESPONSE_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_SETANDROIDINSTANCESFGAPPKEEPALIVERESPONSE_H_
...
namespace TencentCloud
{
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                class AndroidInstanceError;

                /**
                * SetAndroidInstancesFGAppKeepAlive返回参数结构体
                */
                class SetAndroidInstancesFGAppKeepAliveResponse : public AbstractModel
                {
                public:
                    SetAndroidInstancesFGAppKeepAliveResponse();
                    ~SetAndroidInstancesFGAppKeepAliveResponse() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_SETANDROIDINSTANCESFGAPPKEEPALIVERESPONSE_H_
