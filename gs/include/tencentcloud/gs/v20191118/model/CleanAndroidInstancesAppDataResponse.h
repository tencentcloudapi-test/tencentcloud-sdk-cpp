...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_CLEANANDROIDINSTANCESAPPDATARESPONSE_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_CLEANANDROIDINSTANCESAPPDATARESPONSE_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class CleanAndroidInstancesAppDataResponse : public AbstractModel
                {
                public:
                    CleanAndroidInstancesAppDataResponse();
                    ~CleanAndroidInstancesAppDataResponse() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_CLEANANDROIDINSTANCESAPPDATARESPONSE_H_
