...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_MODIFYANDROIDINSTANCESPROPERTIESRESPONSE_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_MODIFYANDROIDINSTANCESPROPERTIESRESPONSE_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class ModifyAndroidInstancesPropertiesResponse : public AbstractModel
                {
                public:
                    ModifyAndroidInstancesPropertiesResponse();
                    ~ModifyAndroidInstancesPropertiesResponse() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_MODIFYANDROIDINSTANCESPROPERTIESRESPONSE_H_
