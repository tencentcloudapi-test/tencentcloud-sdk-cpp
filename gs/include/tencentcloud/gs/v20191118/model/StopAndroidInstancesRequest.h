...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_STOPANDROIDINSTANCESREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_STOPANDROIDINSTANCESREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class StopAndroidInstancesRequest : public AbstractModel
                {
                public:
                    StopAndroidInstancesRequest();
                    ~StopAndroidInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_STOPANDROIDINSTANCESREQUEST_H_
