...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_DISTRIBUTEPHOTOTOANDROIDINSTANCESREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_DISTRIBUTEPHOTOTOANDROIDINSTANCESREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class DistributePhotoToAndroidInstancesRequest : public AbstractModel
                {
                public:
                    DistributePhotoToAndroidInstancesRequest();
                    ~DistributePhotoToAndroidInstancesRequest() = default;
                     ...
                     * 
                     */
                    void SetPhotoURL(const std::string& _photoURL);

                    /**
                     * 判断参数 PhotoURL 是否已赋值
                     * @return PhotoURL 是否已赋值
                     * 
                     */
                    bool PhotoURLHasBeenSet() const;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_DISTRIBUTEPHOTOTOANDROIDINSTANCESREQUEST_H_
