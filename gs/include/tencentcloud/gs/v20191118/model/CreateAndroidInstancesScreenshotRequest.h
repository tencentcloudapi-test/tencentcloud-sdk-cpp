...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCESSCREENSHOTREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCESSCREENSHOTREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class CreateAndroidInstancesScreenshotRequest : public AbstractModel
                {
                public:
                    CreateAndroidInstancesScreenshotRequest();
                    ~CreateAndroidInstancesScreenshotRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCESSCREENSHOTREQUEST_H_
