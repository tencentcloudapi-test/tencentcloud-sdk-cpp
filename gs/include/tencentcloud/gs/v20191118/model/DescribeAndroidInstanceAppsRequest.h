...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_DESCRIBEANDROIDINSTANCEAPPSREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_DESCRIBEANDROIDINSTANCEAPPSREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class DescribeAndroidInstanceAppsRequest : public AbstractModel
                {
                public:
                    DescribeAndroidInstanceAppsRequest();
                    ~DescribeAndroidInstanceAppsRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_DESCRIBEANDROIDINSTANCEAPPSREQUEST_H_
