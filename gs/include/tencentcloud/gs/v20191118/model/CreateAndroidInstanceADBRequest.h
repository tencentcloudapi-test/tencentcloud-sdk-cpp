...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCEADBREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCEADBREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class CreateAndroidInstanceADBRequest : public AbstractModel
                {
                public:
                    CreateAndroidInstanceADBRequest();
                    ~CreateAndroidInstanceADBRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCEADBREQUEST_H_
