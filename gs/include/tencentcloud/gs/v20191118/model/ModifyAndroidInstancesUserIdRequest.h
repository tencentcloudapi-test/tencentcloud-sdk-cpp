...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_MODIFYANDROIDINSTANCESUSERIDREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_MODIFYANDROIDINSTANCESUSERIDREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class ModifyAndroidInstancesUserIdRequest : public AbstractModel
                {
                public:
                    ModifyAndroidInstancesUserIdRequest();
                    ~ModifyAndroidInstancesUserIdRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_MODIFYANDROIDINSTANCESUSERIDREQUEST_H_
