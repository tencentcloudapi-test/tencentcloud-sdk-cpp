...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_STARTANDROIDINSTANCESREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_STARTANDROIDINSTANCESREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class StartAndroidInstancesRequest : public AbstractModel
                {
                public:
                    StartAndroidInstancesRequest();
                    ~StartAndroidInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_STARTANDROIDINSTANCESREQUEST_H_
