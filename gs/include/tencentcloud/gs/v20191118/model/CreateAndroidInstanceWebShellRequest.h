...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCEWEBSHELLREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCEWEBSHELLREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class CreateAndroidInstanceWebShellRequest : public AbstractModel
                {
                public:
                    CreateAndroidInstanceWebShellRequest();
                    ~CreateAndroidInstanceWebShellRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_CREATEANDROIDINSTANCEWEBSHELLREQUEST_H_
