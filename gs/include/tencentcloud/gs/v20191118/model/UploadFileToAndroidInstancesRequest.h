...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_UPLOADFILETOANDROIDINSTANCESREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_UPLOADFILETOANDROIDINSTANCESREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class UploadFileToAndroidInstancesRequest : public AbstractModel
                {
                public:
                    UploadFileToAndroidInstancesRequest();
                    ~UploadFileToAndroidInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_UPLOADFILETOANDROIDINSTANCESREQUEST_H_
