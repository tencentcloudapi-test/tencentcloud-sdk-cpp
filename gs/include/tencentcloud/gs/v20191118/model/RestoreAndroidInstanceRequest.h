...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_RESTOREANDROIDINSTANCEREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_RESTOREANDROIDINSTANCEREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class RestoreAndroidInstanceRequest : public AbstractModel
                {
                public:
                    RestoreAndroidInstanceRequest();
                    ~RestoreAndroidInstanceRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_RESTOREANDROIDINSTANCEREQUEST_H_
