...
#ifndef TENCENTCLOUD_GS_V20191118_MODEL_REBOOTANDROIDINSTANCESREQUEST_H_
#define TENCENTCLOUD_GS_V20191118_MODEL_REBOOTANDROIDINSTANCESREQUEST_H_
    ...
    namespace Gs
    {
        namespace V20191118
        {
            namespace Model
            {
                ...
                */
                class RebootAndroidInstancesRequest : public AbstractModel
                {
                public:
                    RebootAndroidInstancesRequest();
                    ~RebootAndroidInstancesRequest() = default;
...
#endif // !TENCENTCLOUD_GS_V20191118_MODEL_REBOOTANDROIDINSTANCESREQUEST_H_
