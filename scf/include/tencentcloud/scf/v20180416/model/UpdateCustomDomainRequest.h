...
#ifndef TENCENTCLOUD_SCF_V20180416_MODEL_UPDATECUSTOMDOMAINREQUEST_H_
#define TENCENTCLOUD_SCF_V20180416_MODEL_UPDATECUSTOMDOMAINREQUEST_H_
    ...
    namespace Scf
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class UpdateCustomDomainRequest : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_SCF_V20180416_MODEL_UPDATECUSTOMDOMAINREQUEST_H_
