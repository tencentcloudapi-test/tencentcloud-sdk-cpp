...
#ifndef TENCENTCLOUD_SCF_V20180416_MODEL_GETLAYERVERSIONREQUEST_H_
#define TENCENTCLOUD_SCF_V20180416_MODEL_GETLAYERVERSIONREQUEST_H_
    ...
    namespace Scf
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class GetLayerVersionRequest : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_SCF_V20180416_MODEL_GETLAYERVERSIONREQUEST_H_
