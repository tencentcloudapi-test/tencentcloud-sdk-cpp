...
#ifndef TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBEDBINSTANCEURLREQUEST_H_
#define TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBEDBINSTANCEURLREQUEST_H_
    ...
    namespace Mongodb
    {
        namespace V20190725
        {
            namespace Model
            {
                ...
                */
                class DescribeDBInstanceURLRequest : public AbstractModel
                {
                public:
                    DescribeDBInstanceURLRequest();
                    ~DescribeDBInstanceURLRequest() = default;
...
#endif // !TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBEDBINSTANCEURLREQUEST_H_
