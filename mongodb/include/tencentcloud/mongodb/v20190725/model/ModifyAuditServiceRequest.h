...
#ifndef TENCENTCLOUD_MONGODB_V20190725_MODEL_MODIFYAUDITSERVICEREQUEST_H_
#define TENCENTCLOUD_MONGODB_V20190725_MODEL_MODIFYAUDITSERVICEREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取实例ID，格式如：cmgo-xfts****，与云数据库控制台页面中显示的实例 ID 相同。
                     * @return InstanceId 实例ID，格式如：cmgo-xfts****，与云数据库控制台页面中显示的实例 ID 相同。
                     * 
                     */
                    std::string GetInstanceId() const;

                    /**
                     * 设置实例ID，格式如：cmgo-xfts****，与云数据库控制台页面中显示的实例 ID 相同。
...
#endif // !TENCENTCLOUD_MONGODB_V20190725_MODEL_MODIFYAUDITSERVICEREQUEST_H_
