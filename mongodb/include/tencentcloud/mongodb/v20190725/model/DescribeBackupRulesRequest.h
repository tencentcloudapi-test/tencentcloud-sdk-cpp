...
#ifndef TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBEBACKUPRULESREQUEST_H_
#define TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBEBACKUPRULESREQUEST_H_
    ...
    namespace Mongodb
    {
        namespace V20190725
        {
            namespace Model
            {
                ...
                */
                class DescribeBackupRulesRequest : public AbstractModel
                {
                public:
                    DescribeBackupRulesRequest();
                    ~DescribeBackupRulesRequest() = default;
...
#endif // !TENCENTCLOUD_MONGODB_V20190725_MODEL_DESCRIBEBACKUPRULESREQUEST_H_
