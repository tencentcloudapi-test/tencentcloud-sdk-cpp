...
#ifndef TENCENTCLOUD_MONGODB_V20180408_MODEL_MONGODBSHARDINFO_H_
#define TENCENTCLOUD_MONGODB_V20180408_MODEL_MONGODBSHARDINFO_H_
    ...
    namespace Mongodb
    {
        namespace V20180408
        {
            namespace Model
            {
                ...
                * 实例分片详情
                */
                class MongodbShardInfo : public AbstractModel
                {
                public:
                    MongodbShardInfo();
...
#endif // !TENCENTCLOUD_MONGODB_V20180408_MODEL_MONGODBSHARDINFO_H_
