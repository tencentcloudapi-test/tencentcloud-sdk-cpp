...
#ifndef TENCENTCLOUD_MONGODB_V20180408_MODEL_UPGRADEDBINSTANCEHOURREQUEST_H_
#define TENCENTCLOUD_MONGODB_V20180408_MODEL_UPGRADEDBINSTANCEHOURREQUEST_H_
    ...
    namespace Mongodb
    {
        namespace V20180408
        {
            namespace Model
            {
                ...
                */
                class UpgradeDBInstanceHourRequest : public AbstractModel
                {
                public:
                    UpgradeDBInstanceHourRequest();
                    ~UpgradeDBInstanceHourRequest() = default;
...
#endif // !TENCENTCLOUD_MONGODB_V20180408_MODEL_UPGRADEDBINSTANCEHOURREQUEST_H_
