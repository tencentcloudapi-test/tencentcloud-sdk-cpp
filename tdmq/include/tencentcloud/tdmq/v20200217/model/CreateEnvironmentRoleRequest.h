...
#ifndef TENCENTCLOUD_TDMQ_V20200217_MODEL_CREATEENVIRONMENTROLEREQUEST_H_
#define TENCENTCLOUD_TDMQ_V20200217_MODEL_CREATEENVIRONMENTROLEREQUEST_H_
    ...
    namespace Tdmq
    {
        namespace V20200217
        {
            namespace Model
            {
                ...
                */
                class CreateEnvironmentRoleRequest : public AbstractModel
                {
                public:
                    CreateEnvironmentRoleRequest();
                    ~CreateEnvironmentRoleRequest() = default;
...
#endif // !TENCENTCLOUD_TDMQ_V20200217_MODEL_CREATEENVIRONMENTROLEREQUEST_H_
