...
#ifndef TENCENTCLOUD_TDMQ_V20200217_MODEL_DELETERABBITMQPERMISSIONREQUEST_H_
#define TENCENTCLOUD_TDMQ_V20200217_MODEL_DELETERABBITMQPERMISSIONREQUEST_H_
    ...
    namespace Tdmq
    {
        namespace V20200217
        {
            namespace Model
            {
                ...
                */
                class DeleteRabbitMQPermissionRequest : public AbstractModel
                {
                public:
                    DeleteRabbitMQPermissionRequest();
                    ~DeleteRabbitMQPermissionRequest() = default;
...
#endif // !TENCENTCLOUD_TDMQ_V20200217_MODEL_DELETERABBITMQPERMISSIONREQUEST_H_
