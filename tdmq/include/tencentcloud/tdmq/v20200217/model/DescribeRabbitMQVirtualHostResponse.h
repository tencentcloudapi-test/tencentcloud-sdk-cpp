...
#ifndef TENCENTCLOUD_TDMQ_V20200217_MODEL_DESCRIBERABBITMQVIRTUALHOSTRESPONSE_H_
#define TENCENTCLOUD_TDMQ_V20200217_MODEL_DESCRIBERABBITMQVIRTUALHOSTRESPONSE_H_
...
namespace TencentCloud
{
    namespace Tdmq
    {
        namespace V20200217
        {
            namespace Model
            {
                class RabbitMQVirtualHostInfo;

                /**
                * DescribeRabbitMQVirtualHost返回参数结构体
                */
                class DescribeRabbitMQVirtualHostResponse : public AbstractModel
                {
                public:
                    DescribeRabbitMQVirtualHostResponse();
                    ~DescribeRabbitMQVirtualHostResponse() = default;
...
#endif // !TENCENTCLOUD_TDMQ_V20200217_MODEL_DESCRIBERABBITMQVIRTUALHOSTRESPONSE_H_
