...
#ifndef TENCENTCLOUD_YINSUDA_V20220527_MODEL_SETPLAYMODECOMMANDINPUT_H_
#define TENCENTCLOUD_YINSUDA_V20220527_MODEL_SETPLAYMODECOMMANDINPUT_H_
    ...
    namespace Yinsuda
    {
        namespace V20220527
        {
            namespace Model
            {
                ...
                * 设置播放模式
                */
                class SetPlayModeCommandInput : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_YINSUDA_V20220527_MODEL_SETPLAYMODECOMMANDINPUT_H_
