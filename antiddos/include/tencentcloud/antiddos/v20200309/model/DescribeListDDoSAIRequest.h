...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTDDOSAIREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTDDOSAIREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DescribeListDDoSAIRequest : public AbstractModel
                {
                public:
                    DescribeListDDoSAIRequest();
                    ~DescribeListDDoSAIRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DESCRIBELISTDDOSAIREQUEST_H_
