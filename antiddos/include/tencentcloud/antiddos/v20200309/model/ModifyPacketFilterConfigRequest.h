...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_MODIFYPACKETFILTERCONFIGREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_MODIFYPACKETFILTERCONFIGREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class ModifyPacketFilterConfigRequest : public AbstractModel
                {
                public:
                    ModifyPacketFilterConfigRequest();
                    ~ModifyPacketFilterConfigRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_MODIFYPACKETFILTERCONFIGREQUEST_H_
