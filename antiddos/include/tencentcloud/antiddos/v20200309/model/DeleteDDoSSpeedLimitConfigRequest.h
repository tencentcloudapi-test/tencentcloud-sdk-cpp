...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEDDOSSPEEDLIMITCONFIGREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEDDOSSPEEDLIMITCONFIGREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DeleteDDoSSpeedLimitConfigRequest : public AbstractModel
                {
                public:
                    DeleteDDoSSpeedLimitConfigRequest();
                    ~DeleteDDoSSpeedLimitConfigRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEDDOSSPEEDLIMITCONFIGREQUEST_H_
