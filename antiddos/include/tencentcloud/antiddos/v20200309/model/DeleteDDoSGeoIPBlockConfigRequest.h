...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEDDOSGEOIPBLOCKCONFIGREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEDDOSGEOIPBLOCKCONFIGREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DeleteDDoSGeoIPBlockConfigRequest : public AbstractModel
                {
                public:
                    DeleteDDoSGeoIPBlockConfigRequest();
                    ~DeleteDDoSGeoIPBlockConfigRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEDDOSGEOIPBLOCKCONFIGREQUEST_H_
