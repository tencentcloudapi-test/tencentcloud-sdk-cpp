...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_CREATEPORTACLCONFIGREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_CREATEPORTACLCONFIGREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class CreatePortAclConfigRequest : public AbstractModel
                {
                public:
                    CreatePortAclConfigRequest();
                    ~CreatePortAclConfigRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_CREATEPORTACLCONFIGREQUEST_H_
