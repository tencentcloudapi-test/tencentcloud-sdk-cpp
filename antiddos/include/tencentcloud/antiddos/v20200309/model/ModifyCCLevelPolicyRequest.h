...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_MODIFYCCLEVELPOLICYREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_MODIFYCCLEVELPOLICYREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class ModifyCCLevelPolicyRequest : public AbstractModel
                {
                public:
                    ModifyCCLevelPolicyRequest();
                    ~ModifyCCLevelPolicyRequest() = default;
                    ...
                    /**
                     * 设置CC防护等级，可取值loose表示宽松，strict表示严格，normal表示适中， emergency表示攻击紧急， sup_loose表示超级宽松，default表示默认策略（无频控配置下发），customized表示自定义策略
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_MODIFYCCLEVELPOLICYREQUEST_H_
