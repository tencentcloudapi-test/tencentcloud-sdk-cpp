...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEPORTACLCONFIGREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEPORTACLCONFIGREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class DeletePortAclConfigRequest : public AbstractModel
                {
                public:
                    DeletePortAclConfigRequest();
                    ~DeletePortAclConfigRequest() = default;
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_DELETEPORTACLCONFIGREQUEST_H_
