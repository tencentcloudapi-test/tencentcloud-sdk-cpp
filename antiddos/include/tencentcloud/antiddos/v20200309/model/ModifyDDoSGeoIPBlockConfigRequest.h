...
#ifndef TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_MODIFYDDOSGEOIPBLOCKCONFIGREQUEST_H_
#define TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_MODIFYDDOSGEOIPBLOCKCONFIGREQUEST_H_
    ...
    namespace Antiddos
    {
        namespace V20200309
        {
            namespace Model
            {
                ...
                */
                class ModifyDDoSGeoIPBlockConfigRequest : public AbstractModel
                {
                public:
                    ModifyDDoSGeoIPBlockConfigRequest();
                    ~ModifyDDoSGeoIPBlockConfigRequest() = default;
                    ...
                    /**
                     * 获取DDoS区域封禁配置，填写参数时配置ID不能为空
                     * @return DDoSGeoIPBlockConfig DDoS区域封禁配置，填写参数时配置ID不能为空
                     * 
                     */
                    DDoSGeoIPBlockConfig GetDDoSGeoIPBlockConfig() const;

                    /**
                     * 设置DDoS区域封禁配置，填写参数时配置ID不能为空
...
#endif // !TENCENTCLOUD_ANTIDDOS_V20200309_MODEL_MODIFYDDOSGEOIPBLOCKCONFIGREQUEST_H_
