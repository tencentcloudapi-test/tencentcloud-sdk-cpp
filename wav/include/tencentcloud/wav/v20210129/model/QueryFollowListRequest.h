...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYFOLLOWLISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYFOLLOWLISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryFollowListRequest : public AbstractModel
                {
                public:
                    QueryFollowListRequest();
                    ~QueryFollowListRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYFOLLOWLISTREQUEST_H_
