...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYARRIVALLISTRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYARRIVALLISTRESPONSE_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryArrivalListResponse : public AbstractModel
                {
                public:
                    QueryArrivalListResponse();
                    ~QueryArrivalListResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ArrivalInfo> GetPageData() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ArrivalInfo> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYARRIVALLISTRESPONSE_H_
