...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYMINIAPPCODELISTRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYMINIAPPCODELISTRESPONSE_H_
...
namespace TencentCloud
{
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                class MiniAppCodeInfo;

                /**
                * QueryMiniAppCodeList返回参数结构体
                */
                class QueryMiniAppCodeListResponse : public AbstractModel
                {
                public:
                    QueryMiniAppCodeListResponse();
                    ~QueryMiniAppCodeListResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<MiniAppCodeInfo> GetPageData() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<MiniAppCodeInfo> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYMINIAPPCODELISTRESPONSE_H_
