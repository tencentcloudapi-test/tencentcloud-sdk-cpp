...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYARRIVALLISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYARRIVALLISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryArrivalListRequest : public AbstractModel
                {
                public:
                    QueryArrivalListRequest();
                    ~QueryArrivalListRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYARRIVALLISTREQUEST_H_
