...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHATARCHIVINGLISTRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHATARCHIVINGLISTRESPONSE_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryChatArchivingListResponse : public AbstractModel
                {
                public:
                    QueryChatArchivingListResponse();
                    ~QueryChatArchivingListResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 获取会话存档列表响应参数
注意：此字段可能返回 null，表示取不到有效值。
                     * @return PageData 会话存档列表响应参数
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ChatArchivingDetail> GetPageData() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ChatArchivingDetail> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHATARCHIVINGLISTRESPONSE_H_
