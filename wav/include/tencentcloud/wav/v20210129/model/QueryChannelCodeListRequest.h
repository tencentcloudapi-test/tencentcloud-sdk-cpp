...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHANNELCODELISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHANNELCODELISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryChannelCodeListRequest : public AbstractModel
                {
                public:
                    QueryChannelCodeListRequest();
                    ~QueryChannelCodeListRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHANNELCODELISTREQUEST_H_
