...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYUSERINFOLISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYUSERINFOLISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryUserInfoListRequest : public AbstractModel
                {
                public:
                    QueryUserInfoListRequest();
                    ~QueryUserInfoListRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYUSERINFOLISTREQUEST_H_
