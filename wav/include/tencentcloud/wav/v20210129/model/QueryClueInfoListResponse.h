...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCLUEINFOLISTRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCLUEINFOLISTRESPONSE_H_
...
namespace TencentCloud
{
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                class ClueInfoDetail;

                /**
                * QueryClueInfoList返回参数结构体
                */
                class QueryClueInfoListResponse : public AbstractModel
                {
                public:
                    QueryClueInfoListResponse();
                    ~QueryClueInfoListResponse() = default;
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ClueInfoDetail> GetPageData() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ClueInfoDetail> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCLUEINFOLISTRESPONSE_H_
