...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHANNELCODELISTRESPONSE_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHANNELCODELISTRESPONSE_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryChannelCodeListResponse : public AbstractModel
                {
                public:
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<ChannelCodeInnerDetail> GetPageData() const;
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<ChannelCodeInnerDetail> m_pageData;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHANNELCODELISTRESPONSE_H_
