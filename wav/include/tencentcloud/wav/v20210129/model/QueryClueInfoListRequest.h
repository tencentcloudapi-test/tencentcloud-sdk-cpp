...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCLUEINFOLISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCLUEINFOLISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryClueInfoListRequest : public AbstractModel
                {
                public:
                    QueryClueInfoListRequest();
                    ~QueryClueInfoListRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCLUEINFOLISTREQUEST_H_
