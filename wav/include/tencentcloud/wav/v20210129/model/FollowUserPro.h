...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_FOLLOWUSERPRO_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_FOLLOWUSERPRO_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class FollowUserPro : public AbstractModel
                {
                public:
                    FollowUserPro();
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_FOLLOWUSERPRO_H_
