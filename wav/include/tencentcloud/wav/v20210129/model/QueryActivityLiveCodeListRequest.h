...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYACTIVITYLIVECODELISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYACTIVITYLIVECODELISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryActivityLiveCodeListRequest : public AbstractModel
                {
                public:
                    QueryActivityLiveCodeListRequest();
                    ~QueryActivityLiveCodeListRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYACTIVITYLIVECODELISTREQUEST_H_
