...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALCONTACTLISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALCONTACTLISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryExternalContactListRequest : public AbstractModel
                {
                public:
                    QueryExternalContactListRequest();
                    ~QueryExternalContactListRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYEXTERNALCONTACTLISTREQUEST_H_
