...
#ifndef TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHATARCHIVINGLISTREQUEST_H_
#define TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHATARCHIVINGLISTREQUEST_H_
    ...
    namespace Wav
    {
        namespace V20210129
        {
            namespace Model
            {
                ...
                */
                class QueryChatArchivingListRequest : public AbstractModel
                {
                public:
                    QueryChatArchivingListRequest();
                    ~QueryChatArchivingListRequest() = default;
...
#endif // !TENCENTCLOUD_WAV_V20210129_MODEL_QUERYCHATARCHIVINGLISTREQUEST_H_
