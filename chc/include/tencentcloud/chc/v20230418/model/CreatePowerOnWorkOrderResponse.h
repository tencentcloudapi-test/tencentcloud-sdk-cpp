...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_CREATEPOWERONWORKORDERRESPONSE_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_CREATEPOWERONWORKORDERRESPONSE_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreatePowerOnWorkOrderResponse : public AbstractModel
                {
                public:
                    CreatePowerOnWorkOrderResponse();
                    ~CreatePowerOnWorkOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_CREATEPOWERONWORKORDERRESPONSE_H_
