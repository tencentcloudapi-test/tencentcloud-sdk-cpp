...
#ifndef TENCENTCLOUD_CHC_V20230418_MODEL_CREATEQUITWORKORDERRESPONSE_H_
#define TENCENTCLOUD_CHC_V20230418_MODEL_CREATEQUITWORKORDERRESPONSE_H_
    ...
    namespace Chc
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class CreateQuitWorkOrderResponse : public AbstractModel
                {
                public:
                    CreateQuitWorkOrderResponse();
                    ~CreateQuitWorkOrderResponse() = default;
...
#endif // !TENCENTCLOUD_CHC_V20230418_MODEL_CREATEQUITWORKORDERRESPONSE_H_
