...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_CREATEBATCHIPACCESSCONTROLREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_CREATEBATCHIPACCESSCONTROLREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class CreateBatchIpAccessControlRequest : public AbstractModel
                {
                public:
                    CreateBatchIpAccessControlRequest();
                    ~CreateBatchIpAccessControlRequest() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_CREATEBATCHIPACCESSCONTROLREQUEST_H_
