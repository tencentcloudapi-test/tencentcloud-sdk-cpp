...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_CREATEIPACCESSCONTROLREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_CREATEIPACCESSCONTROLREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class CreateIpAccessControlRequest : public AbstractModel
                {
                public:
                    CreateIpAccessControlRequest();
                    ~CreateIpAccessControlRequest() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_CREATEIPACCESSCONTROLREQUEST_H_
