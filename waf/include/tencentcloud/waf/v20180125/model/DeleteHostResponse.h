...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_DELETEHOSTRESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_DELETEHOSTRESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                * DeleteHost返回参数结构体
                */
                class DeleteHostResponse : public AbstractModel
                {
                public:
                    DeleteHostResponse();
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_DELETEHOSTRESPONSE_H_
