...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYCUSTOMWHITERULESTATUSRESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYCUSTOMWHITERULESTATUSRESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyCustomWhiteRuleStatusResponse : public AbstractModel
                {
                public:
                    ModifyCustomWhiteRuleStatusResponse();
                    ~ModifyCustomWhiteRuleStatusResponse() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYCUSTOMWHITERULESTATUSRESPONSE_H_
