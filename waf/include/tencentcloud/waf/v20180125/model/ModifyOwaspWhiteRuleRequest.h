...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYOWASPWHITERULEREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYOWASPWHITERULEREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyOwaspWhiteRuleRequest : public AbstractModel
                {
                public:
                    ModifyOwaspWhiteRuleRequest();
                    ~ModifyOwaspWhiteRuleRequest() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYOWASPWHITERULEREQUEST_H_
