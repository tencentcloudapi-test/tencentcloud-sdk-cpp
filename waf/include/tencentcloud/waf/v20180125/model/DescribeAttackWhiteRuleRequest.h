...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEATTACKWHITERULEREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEATTACKWHITERULEREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class DescribeAttackWhiteRuleRequest : public AbstractModel
                {
                public:
                    DescribeAttackWhiteRuleRequest();
                    ~DescribeAttackWhiteRuleRequest() = default;
                    ...
                    /**
                     * 获取筛选条件，支持SignatureId, MatchContent
                     * @return Filters 筛选条件，支持SignatureId, MatchContent
                     * 
                     */
                    std::vector<FiltersItemNew> GetFilters() const;

                    /**
                     * 设置筛选条件，支持SignatureId, MatchContent
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_DESCRIBEATTACKWHITERULEREQUEST_H_
