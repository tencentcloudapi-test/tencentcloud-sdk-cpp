...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_CREATERATELIMITV2REQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_CREATERATELIMITV2REQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class CreateRateLimitV2Request : public AbstractModel
                {
                public:
                    CreateRateLimitV2Request();
                    ~CreateRateLimitV2Request() = default;
                    ...
                    /**
                     * 获取支持API或Domain，如果是基于API，则LimitPaths不能为空，否则LimitPaths为空
                     * @return LimitObject 支持API或Domain，如果是基于API，则LimitPaths不能为空，否则LimitPaths为空
                     * 
                     */
                    std::string GetLimitObject() const;

                    /**
                     * 设置支持API或Domain，如果是基于API，则LimitPaths不能为空，否则LimitPaths为空
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_CREATERATELIMITV2REQUEST_H_
