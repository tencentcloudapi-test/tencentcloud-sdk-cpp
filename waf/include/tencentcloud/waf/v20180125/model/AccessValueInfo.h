...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_ACCESSVALUEINFO_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_ACCESSVALUEINFO_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class AccessValueInfo : public AbstractModel
                {
                public:
                    AccessValueInfo();
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_ACCESSVALUEINFO_H_
