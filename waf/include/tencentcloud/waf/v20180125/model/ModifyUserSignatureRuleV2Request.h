...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYUSERSIGNATURERULEV2REQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYUSERSIGNATURERULEV2REQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyUserSignatureRuleV2Request : public AbstractModel
                {
                public:
                    ModifyUserSignatureRuleV2Request();
                    ~ModifyUserSignatureRuleV2Request() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYUSERSIGNATURERULEV2REQUEST_H_
