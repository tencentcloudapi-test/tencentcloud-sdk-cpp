...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_ACCESSRULETAGINFO_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_ACCESSRULETAGINFO_H_
...
namespace TencentCloud
{
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                class AccessKeyValueInfo;

                /**
                * DescribeAccessIndex接口的出参
                */
                class AccessRuleTagInfo : public AbstractModel
                {
                public:
                    AccessRuleTagInfo();
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_ACCESSRULETAGINFO_H_
