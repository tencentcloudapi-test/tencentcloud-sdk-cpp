...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_CREATEDEALSRESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_CREATEDEALSRESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                * CreateDeals返回参数结构体
                */
                class CreateDealsResponse : public AbstractModel
                {
                public:
                    CreateDealsResponse();
                    ~CreateDealsResponse() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_CREATEDEALSRESPONSE_H_
