...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYWAFAUTODENYRULESRESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYWAFAUTODENYRULESRESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyWafAutoDenyRulesResponse : public AbstractModel
                {
                public:
                    ModifyWafAutoDenyRulesResponse();
                    ~ModifyWafAutoDenyRulesResponse() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYWAFAUTODENYRULESRESPONSE_H_
