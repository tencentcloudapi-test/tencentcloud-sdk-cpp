...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYHOSTMODERESPONSE_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYHOSTMODERESPONSE_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyHostModeResponse : public AbstractModel
                {
                public:
                    ModifyHostModeResponse();
                    ~ModifyHostModeResponse() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYHOSTMODERESPONSE_H_
