...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYAREABANRULEREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYAREABANRULEREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyAreaBanRuleRequest : public AbstractModel
                {
                public:
                    ModifyAreaBanRuleRequest();
                    ~ModifyAreaBanRuleRequest() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYAREABANRULEREQUEST_H_
