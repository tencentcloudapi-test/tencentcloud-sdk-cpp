...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYAREABANAREASREQUEST_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYAREABANAREASREQUEST_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                */
                class ModifyAreaBanAreasRequest : public AbstractModel
                {
                public:
                    ModifyAreaBanAreasRequest();
                    ~ModifyAreaBanAreasRequest() = default;
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_MODIFYAREABANAREASREQUEST_H_
