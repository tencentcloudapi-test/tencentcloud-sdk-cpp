...
#ifndef TENCENTCLOUD_WAF_V20180125_MODEL_LIMITHEADER_H_
#define TENCENTCLOUD_WAF_V20180125_MODEL_LIMITHEADER_H_
    ...
    namespace Waf
    {
        namespace V20180125
        {
            namespace Model
            {
                ...
                * 限流Header数据结构
                */
                class LimitHeader : public AbstractModel
                {
                public:
                    LimitHeader();
...
#endif // !TENCENTCLOUD_WAF_V20180125_MODEL_LIMITHEADER_H_
