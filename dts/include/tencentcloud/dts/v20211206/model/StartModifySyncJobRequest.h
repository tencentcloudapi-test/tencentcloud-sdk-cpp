...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_STARTMODIFYSYNCJOBREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_STARTMODIFYSYNCJOBREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class StartModifySyncJobRequest : public AbstractModel
                {
                public:
                    StartModifySyncJobRequest();
                    ~StartModifySyncJobRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_STARTMODIFYSYNCJOBREQUEST_H_
