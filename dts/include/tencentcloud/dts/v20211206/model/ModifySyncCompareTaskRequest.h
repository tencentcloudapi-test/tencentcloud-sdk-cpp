...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_MODIFYSYNCCOMPARETASKREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_MODIFYSYNCCOMPARETASKREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class ModifySyncCompareTaskRequest : public AbstractModel
                {
                public:
                    ModifySyncCompareTaskRequest();
                    ~ModifySyncCompareTaskRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_MODIFYSYNCCOMPARETASKREQUEST_H_
