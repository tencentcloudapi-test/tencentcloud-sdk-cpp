...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_RESUMESYNCJOBREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_RESUMESYNCJOBREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class ResumeSyncJobRequest : public AbstractModel
                {
                public:
                    ResumeSyncJobRequest();
                    ~ResumeSyncJobRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_RESUMESYNCJOBREQUEST_H_
