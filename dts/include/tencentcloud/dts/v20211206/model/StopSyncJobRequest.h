...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_STOPSYNCJOBREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_STOPSYNCJOBREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                * StopSyncJob请求参数结构体
                */
                class StopSyncJobRequest : public AbstractModel
                {
                public:
                    StopSyncJobRequest();
                    ~StopSyncJobRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_STOPSYNCJOBREQUEST_H_
