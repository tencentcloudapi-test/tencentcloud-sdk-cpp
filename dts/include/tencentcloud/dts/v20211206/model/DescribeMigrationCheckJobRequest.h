...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMIGRATIONCHECKJOBREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMIGRATIONCHECKJOBREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class DescribeMigrationCheckJobRequest : public AbstractModel
                {
                public:
                    DescribeMigrationCheckJobRequest();
                    ~DescribeMigrationCheckJobRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMIGRATIONCHECKJOBREQUEST_H_
