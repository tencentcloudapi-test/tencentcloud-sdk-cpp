...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMODIFYCHECKSYNCJOBRESULTREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMODIFYCHECKSYNCJOBRESULTREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class DescribeModifyCheckSyncJobResultRequest : public AbstractModel
                {
                public:
                    DescribeModifyCheckSyncJobResultRequest();
                    ~DescribeModifyCheckSyncJobResultRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_DESCRIBEMODIFYCHECKSYNCJOBRESULTREQUEST_H_
