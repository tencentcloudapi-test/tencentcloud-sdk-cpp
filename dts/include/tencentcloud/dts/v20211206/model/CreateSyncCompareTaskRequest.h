...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_CREATESYNCCOMPARETASKREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_CREATESYNCCOMPARETASKREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class CreateSyncCompareTaskRequest : public AbstractModel
                {
                public:
                    CreateSyncCompareTaskRequest();
                    ~CreateSyncCompareTaskRequest() = default;
                    ...
                    /**
                     * 获取对比对象，当ObjectMode值为custom时，此项需要填写
                     * @return Objects 对比对象，当ObjectMode值为custom时，此项需要填写
                     * 
                     */
                    CompareObject GetObjects() const;

                    /**
                     * 设置对比对象，当ObjectMode值为custom时，此项需要填写
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_CREATESYNCCOMPARETASKREQUEST_H_
