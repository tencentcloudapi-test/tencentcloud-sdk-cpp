...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_CREATESUBSCRIBECHECKJOBREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_CREATESUBSCRIBECHECKJOBREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class CreateSubscribeCheckJobRequest : public AbstractModel
                {
                public:
                    CreateSubscribeCheckJobRequest();
                    ~CreateSubscribeCheckJobRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_CREATESUBSCRIBECHECKJOBREQUEST_H_
