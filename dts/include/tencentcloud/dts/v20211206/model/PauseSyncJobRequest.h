...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_PAUSESYNCJOBREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_PAUSESYNCJOBREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                * PauseSyncJob请求参数结构体
                */
                class PauseSyncJobRequest : public AbstractModel
                {
                public:
                    PauseSyncJobRequest();
                    ~PauseSyncJobRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_PAUSESYNCJOBREQUEST_H_
