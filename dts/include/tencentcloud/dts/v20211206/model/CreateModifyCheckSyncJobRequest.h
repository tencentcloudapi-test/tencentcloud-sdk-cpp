...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_CREATEMODIFYCHECKSYNCJOBREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_CREATEMODIFYCHECKSYNCJOBREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class CreateModifyCheckSyncJobRequest : public AbstractModel
                {
                public:
                    CreateModifyCheckSyncJobRequest();
                    ~CreateModifyCheckSyncJobRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_CREATEMODIFYCHECKSYNCJOBREQUEST_H_
