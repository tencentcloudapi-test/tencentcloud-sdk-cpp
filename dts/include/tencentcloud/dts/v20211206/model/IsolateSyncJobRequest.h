...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_ISOLATESYNCJOBREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_ISOLATESYNCJOBREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class IsolateSyncJobRequest : public AbstractModel
                {
                public:
                    IsolateSyncJobRequest();
                    ~IsolateSyncJobRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_ISOLATESYNCJOBREQUEST_H_
