...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_CONTINUESYNCJOBREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_CONTINUESYNCJOBREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class ContinueSyncJobRequest : public AbstractModel
                {
                public:
                    ContinueSyncJobRequest();
                    ~ContinueSyncJobRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_CONTINUESYNCJOBREQUEST_H_
