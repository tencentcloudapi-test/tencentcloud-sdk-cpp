...
#ifndef TENCENTCLOUD_DTS_V20211206_MODEL_ISOLATEMIGRATEJOBREQUEST_H_
#define TENCENTCLOUD_DTS_V20211206_MODEL_ISOLATEMIGRATEJOBREQUEST_H_
    ...
    namespace Dts
    {
        namespace V20211206
        {
            namespace Model
            {
                ...
                */
                class IsolateMigrateJobRequest : public AbstractModel
                {
                public:
                    IsolateMigrateJobRequest();
                    ~IsolateMigrateJobRequest() = default;
...
#endif // !TENCENTCLOUD_DTS_V20211206_MODEL_ISOLATEMIGRATEJOBREQUEST_H_
