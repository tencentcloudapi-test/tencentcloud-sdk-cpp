...
#ifndef TENCENTCLOUD_SOE_V20180724_MODEL_TRANSMITORALPROCESSWITHINITRESPONSE_H_
#define TENCENTCLOUD_SOE_V20180724_MODEL_TRANSMITORALPROCESSWITHINITRESPONSE_H_
    ...
    namespace Soe
    {
        namespace V20180724
        {
            namespace Model
            {
                ...
                */
                class TransmitOralProcessWithInitResponse : public AbstractModel
                {
                public:
                    TransmitOralProcessWithInitResponse();
                    ~TransmitOralProcessWithInitResponse() = default;
...
#endif // !TENCENTCLOUD_SOE_V20180724_MODEL_TRANSMITORALPROCESSWITHINITRESPONSE_H_
