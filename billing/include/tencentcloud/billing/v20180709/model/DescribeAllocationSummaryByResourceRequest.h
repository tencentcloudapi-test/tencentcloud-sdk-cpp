...
#ifndef TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBEALLOCATIONSUMMARYBYRESOURCEREQUEST_H_
#define TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBEALLOCATIONSUMMARYBYRESOURCEREQUEST_H_
    ...
    namespace Billing
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeAllocationSummaryByResourceRequest : public AbstractModel
                {
                public:
                    DescribeAllocationSummaryByResourceRequest();
                    ~DescribeAllocationSummaryByResourceRequest() = default;
...
#endif // !TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBEALLOCATIONSUMMARYBYRESOURCEREQUEST_H_
