...
#ifndef TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBECOSTSUMMARYBYPROJECTREQUEST_H_
#define TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBECOSTSUMMARYBYPROJECTREQUEST_H_
    ...
    namespace Billing
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeCostSummaryByProjectRequest : public AbstractModel
                {
                public:
                    DescribeCostSummaryByProjectRequest();
                    ~DescribeCostSummaryByProjectRequest() = default;
...
#endif // !TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBECOSTSUMMARYBYPROJECTREQUEST_H_
