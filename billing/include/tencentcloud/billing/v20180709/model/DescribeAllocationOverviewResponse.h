...
#ifndef TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBEALLOCATIONOVERVIEWRESPONSE_H_
#define TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBEALLOCATIONOVERVIEWRESPONSE_H_
    ...
    namespace Billing
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                class AllocationOverviewDetail;

                /**
                * DescribeAllocationOverview返回参数结构体
                */
                class DescribeAllocationOverviewResponse : public AbstractModel
                {
                public:
                    DescribeAllocationOverviewResponse();
                    ~DescribeAllocationOverviewResponse() = default;
...
#endif // !TENCENTCLOUD_BILLING_V20180709_MODEL_DESCRIBEALLOCATIONOVERVIEWRESPONSE_H_
