...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_STOPCPUEXPANDREQUEST_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_STOPCPUEXPANDREQUEST_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                */
                class StopCpuExpandRequest : public AbstractModel
                {
                public:
                    StopCpuExpandRequest();
                    ~StopCpuExpandRequest() = default;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_STOPCPUEXPANDREQUEST_H_
