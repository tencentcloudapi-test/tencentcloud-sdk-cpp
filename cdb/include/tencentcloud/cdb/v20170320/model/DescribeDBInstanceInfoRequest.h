...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCEINFOREQUEST_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCEINFOREQUEST_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                */
                class DescribeDBInstanceInfoRequest : public AbstractModel
                {
                public:
                    DescribeDBInstanceInfoRequest();
                    ~DescribeDBInstanceInfoRequest() = default;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCEINFOREQUEST_H_
