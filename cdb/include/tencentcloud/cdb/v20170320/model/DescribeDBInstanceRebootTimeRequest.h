...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCEREBOOTTIMEREQUEST_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCEREBOOTTIMEREQUEST_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                */
                class DescribeDBInstanceRebootTimeRequest : public AbstractModel
                {
                public:
                    DescribeDBInstanceRebootTimeRequest();
                    ~DescribeDBInstanceRebootTimeRequest() = default;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCEREBOOTTIMEREQUEST_H_
