...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_DELETETIMEWINDOWREQUEST_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_DELETETIMEWINDOWREQUEST_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                */
                class DeleteTimeWindowRequest : public AbstractModel
                {
                public:
                    DeleteTimeWindowRequest();
                    ~DeleteTimeWindowRequest() = default;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_DELETETIMEWINDOWREQUEST_H_
