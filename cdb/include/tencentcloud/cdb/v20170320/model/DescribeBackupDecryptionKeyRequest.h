            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取实例 ID，格式如：cdb-fybaegd8。与云数据库控制台页面中显示的实例 ID 相同。
                    ...
                    /**
                     * 设置实例 ID，格式如：cdb-fybaegd8。与云数据库控制台页面中显示的实例 ID 相同。
                    ...
                    /**
                     * 获取实例的备份 ID，可通过 [DescribeBackups](https://cloud.tencent.com/document/api/236/15842) 接口查询备份的 ID。
                    ...
                    /**
                     * 设置实例的备份 ID，可通过 [DescribeBackups](https://cloud.tencent.com/document/api/236/15842) 接口查询备份的 ID。
                    ...
                    /**
                     * 获取备份类型。data-数据备份，binlog-日志备份，默认为 data。
                    ...
                    /**
                     * 设置备份类型。data-数据备份，binlog-日志备份，默认为 data。
