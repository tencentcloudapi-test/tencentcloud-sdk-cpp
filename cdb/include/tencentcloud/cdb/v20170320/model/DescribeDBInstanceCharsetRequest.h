...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCECHARSETREQUEST_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCECHARSETREQUEST_H_
    ...
    namespace Cdb
    {
        namespace V20170320
        {
            namespace Model
            {
                ...
                */
                class DescribeDBInstanceCharsetRequest : public AbstractModel
                {
                public:
                    DescribeDBInstanceCharsetRequest();
                    ~DescribeDBInstanceCharsetRequest() = default;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEDBINSTANCECHARSETREQUEST_H_
