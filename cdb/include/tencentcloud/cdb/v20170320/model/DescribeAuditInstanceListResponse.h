...
#ifndef TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEAUDITINSTANCELISTRESPONSE_H_
#define TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEAUDITINSTANCELISTRESPONSE_H_
...
注意：此字段可能返回 null，表示取不到有效值。
                     * 
                     */
                    std::vector<InstanceDbAuditStatus> GetItems() const;
...
#endif // !TENCENTCLOUD_CDB_V20170320_MODEL_DESCRIBEAUDITINSTANCELISTRESPONSE_H_
