...
#ifndef TENCENTCLOUD_BM_V20180423_MODEL_BINDPSATAGREQUEST_H_
#define TENCENTCLOUD_BM_V20180423_MODEL_BINDPSATAGREQUEST_H_
    ...
    namespace Bm
    {
        namespace V20180423
        {
            namespace Model
            {
                ...
                * BindPsaTag请求参数结构体
                */
                class BindPsaTagRequest : public AbstractModel
                {
                public:
                    BindPsaTagRequest();
                    ~BindPsaTagRequest() = default;
...
#endif // !TENCENTCLOUD_BM_V20180423_MODEL_BINDPSATAGREQUEST_H_
