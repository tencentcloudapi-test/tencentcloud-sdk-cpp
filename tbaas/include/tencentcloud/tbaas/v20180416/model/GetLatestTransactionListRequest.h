...
#ifndef TENCENTCLOUD_TBAAS_V20180416_MODEL_GETLATESTTRANSACTIONLISTREQUEST_H_
#define TENCENTCLOUD_TBAAS_V20180416_MODEL_GETLATESTTRANSACTIONLISTREQUEST_H_
    ...
    namespace Tbaas
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class GetLatestTransactionListRequest : public AbstractModel
                {
                public:
                    GetLatestTransactionListRequest();
                    ~GetLatestTransactionListRequest() = default;
                     ...
                     * 
                     */
                    void SetLatestBlockNumber(const uint64_t& _latestBlockNumber);

                    /**
                     * 判断参数 LatestBlockNumber 是否已赋值
                     * @return LatestBlockNumber 是否已赋值
                     * 
                     */
                    bool LatestBlockNumberHasBeenSet() const;
                ...
                private:
                    ...
                    bool m_latestBlockNumberHasBeenSet;
...
#endif // !TENCENTCLOUD_TBAAS_V20180416_MODEL_GETLATESTTRANSACTIONLISTREQUEST_H_
