...
#ifndef TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERTRANSACTIONREQUEST_H_
#define TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERTRANSACTIONREQUEST_H_
    ...
    namespace Tbaas
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class QueryChainMakerTransactionRequest : public AbstractModel
                {
                public:
                    QueryChainMakerTransactionRequest();
                    ~QueryChainMakerTransactionRequest() = default;
...
#endif // !TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERTRANSACTIONREQUEST_H_
