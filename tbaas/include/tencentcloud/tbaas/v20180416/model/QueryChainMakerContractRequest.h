...
#ifndef TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERCONTRACTREQUEST_H_
#define TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERCONTRACTREQUEST_H_
    ...
    namespace Tbaas
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class QueryChainMakerContractRequest : public AbstractModel
                {
                public:
                    QueryChainMakerContractRequest();
                    ~QueryChainMakerContractRequest() = default;
...
#endif // !TENCENTCLOUD_TBAAS_V20180416_MODEL_QUERYCHAINMAKERCONTRACTREQUEST_H_
