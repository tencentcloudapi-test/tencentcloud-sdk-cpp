...
#ifndef TENCENTCLOUD_TBAAS_V20180416_MODEL_GETBLOCKTRANSACTIONLISTFORUSERRESPONSE_H_
#define TENCENTCLOUD_TBAAS_V20180416_MODEL_GETBLOCKTRANSACTIONLISTFORUSERRESPONSE_H_
    ...
    namespace Tbaas
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class GetBlockTransactionListForUserResponse : public AbstractModel
                {
                public:
                    GetBlockTransactionListForUserResponse();
                    ~GetBlockTransactionListForUserResponse() = default;
...
#endif // !TENCENTCLOUD_TBAAS_V20180416_MODEL_GETBLOCKTRANSACTIONLISTFORUSERRESPONSE_H_
