...
#ifndef TENCENTCLOUD_TBAAS_V20180416_MODEL_INVOKECHAINMAKERDEMOCONTRACTREQUEST_H_
#define TENCENTCLOUD_TBAAS_V20180416_MODEL_INVOKECHAINMAKERDEMOCONTRACTREQUEST_H_
    ...
    namespace Tbaas
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class InvokeChainMakerDemoContractRequest : public AbstractModel
                {
                public:
                    InvokeChainMakerDemoContractRequest();
                    ~InvokeChainMakerDemoContractRequest() = default;
...
#endif // !TENCENTCLOUD_TBAAS_V20180416_MODEL_INVOKECHAINMAKERDEMOCONTRACTREQUEST_H_
