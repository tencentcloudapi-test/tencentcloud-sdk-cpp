...
#ifndef TENCENTCLOUD_PRIVATEDNS_V20201028_MODEL_RECORDSINFO_H_
#define TENCENTCLOUD_PRIVATEDNS_V20201028_MODEL_RECORDSINFO_H_
    ...
    namespace Privatedns
    {
        namespace V20201028
        {
            namespace Model
            {
                ...
                * 私有域解析记录信息
                */
                class RecordsInfo : public AbstractModel
                {
                public:
                    RecordsInfo();
...
#endif // !TENCENTCLOUD_PRIVATEDNS_V20201028_MODEL_RECORDSINFO_H_
