...
#ifndef TENCENTCLOUD_PRIVATEDNS_V20201028_MODEL_CREATEPRIVATEDNSACCOUNTREQUEST_H_
#define TENCENTCLOUD_PRIVATEDNS_V20201028_MODEL_CREATEPRIVATEDNSACCOUNTREQUEST_H_
    ...
    namespace Privatedns
    {
        namespace V20201028
        {
            namespace Model
            {
                ...
                */
                class CreatePrivateDNSAccountRequest : public AbstractModel
                {
                public:
                    CreatePrivateDNSAccountRequest();
                    ~CreatePrivateDNSAccountRequest() = default;
...
#endif // !TENCENTCLOUD_PRIVATEDNS_V20201028_MODEL_CREATEPRIVATEDNSACCOUNTREQUEST_H_
