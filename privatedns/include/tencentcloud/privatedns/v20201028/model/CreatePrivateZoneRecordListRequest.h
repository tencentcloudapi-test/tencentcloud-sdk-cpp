...
#ifndef TENCENTCLOUD_PRIVATEDNS_V20201028_MODEL_CREATEPRIVATEZONERECORDLISTREQUEST_H_
#define TENCENTCLOUD_PRIVATEDNS_V20201028_MODEL_CREATEPRIVATEZONERECORDLISTREQUEST_H_
    ...
    namespace Privatedns
    {
        namespace V20201028
        {
            namespace Model
            {
                ...
                */
                class CreatePrivateZoneRecordListRequest : public AbstractModel
                {
                public:
                    CreatePrivateZoneRecordListRequest();
                    ~CreatePrivateZoneRecordListRequest() = default;
...
#endif // !TENCENTCLOUD_PRIVATEDNS_V20201028_MODEL_CREATEPRIVATEZONERECORDLISTREQUEST_H_
