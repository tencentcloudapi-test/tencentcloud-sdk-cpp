...
#ifndef TENCENTCLOUD_SMS_V20190711_MODEL_PULLSMSSENDSTATUSRESPONSE_H_
#define TENCENTCLOUD_SMS_V20190711_MODEL_PULLSMSSENDSTATUSRESPONSE_H_
    ...
    namespace Sms
    {
        namespace V20190711
        {
            namespace Model
            {
                ...
                */
                class PullSmsSendStatusResponse : public AbstractModel
                {
                public:
                    PullSmsSendStatusResponse();
                    ~PullSmsSendStatusResponse() = default;
...
#endif // !TENCENTCLOUD_SMS_V20190711_MODEL_PULLSMSSENDSTATUSRESPONSE_H_
