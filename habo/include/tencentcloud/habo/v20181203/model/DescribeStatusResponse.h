...
#ifndef TENCENTCLOUD_HABO_V20181203_MODEL_DESCRIBESTATUSRESPONSE_H_
#define TENCENTCLOUD_HABO_V20181203_MODEL_DESCRIBESTATUSRESPONSE_H_
    ...
    namespace Habo
    {
        namespace V20181203
        {
            namespace Model
            {
                ...
                */
                class DescribeStatusResponse : public AbstractModel
                {
                public:
                    DescribeStatusResponse();
                    ~DescribeStatusResponse() = default;
...
#endif // !TENCENTCLOUD_HABO_V20181203_MODEL_DESCRIBESTATUSRESPONSE_H_
