...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DELETEFENCEBINDREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DELETEFENCEBINDREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class DeleteFenceBindRequest : public AbstractModel
                {
                public:
                    DeleteFenceBindRequest();
                    ~DeleteFenceBindRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DELETEFENCEBINDREQUEST_H_
