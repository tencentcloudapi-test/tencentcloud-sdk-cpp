...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATEEXTERNALSOURCEAISERVICETASKREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATEEXTERNALSOURCEAISERVICETASKREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class CreateExternalSourceAIServiceTaskRequest : public AbstractModel
                {
                public:
                    CreateExternalSourceAIServiceTaskRequest();
                    ~CreateExternalSourceAIServiceTaskRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATEEXTERNALSOURCEAISERVICETASKREQUEST_H_
