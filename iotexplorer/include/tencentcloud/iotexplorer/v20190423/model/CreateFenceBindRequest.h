...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATEFENCEBINDREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATEFENCEBINDREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class CreateFenceBindRequest : public AbstractModel
                {
                public:
                    CreateFenceBindRequest();
                    ~CreateFenceBindRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATEFENCEBINDREQUEST_H_
