...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_PAUSETWECALLDEVICEREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_PAUSETWECALLDEVICEREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class PauseTWeCallDeviceRequest : public AbstractModel
                {
                public:
                    PauseTWeCallDeviceRequest();
                    ~PauseTWeCallDeviceRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_PAUSETWECALLDEVICEREQUEST_H_
