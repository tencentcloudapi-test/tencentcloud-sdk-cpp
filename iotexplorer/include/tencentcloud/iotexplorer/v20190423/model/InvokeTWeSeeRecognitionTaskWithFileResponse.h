...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKWITHFILERESPONSE_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKWITHFILERESPONSE_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class InvokeTWeSeeRecognitionTaskWithFileResponse : public AbstractModel
                {
                public:
                    InvokeTWeSeeRecognitionTaskWithFileResponse();
                    ~InvokeTWeSeeRecognitionTaskWithFileResponse() = default;
                    ...
                    /**
                     * 获取语义理解任务结果（仅当 Completed 为 true 时包含该出参）
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKWITHFILERESPONSE_H_
