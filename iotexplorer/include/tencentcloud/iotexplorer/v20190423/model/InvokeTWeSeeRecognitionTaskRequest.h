...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class InvokeTWeSeeRecognitionTaskRequest : public AbstractModel
                {
                public:
                    InvokeTWeSeeRecognitionTaskRequest();
                    ~InvokeTWeSeeRecognitionTaskRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKREQUEST_H_
