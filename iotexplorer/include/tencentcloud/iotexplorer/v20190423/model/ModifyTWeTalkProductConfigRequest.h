...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_MODIFYTWETALKPRODUCTCONFIGREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_MODIFYTWETALKPRODUCTCONFIGREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class ModifyTWeTalkProductConfigRequest : public AbstractModel
                {
                public:
                    ModifyTWeTalkProductConfigRequest();
                    ~ModifyTWeTalkProductConfigRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_MODIFYTWETALKPRODUCTCONFIGREQUEST_H_
