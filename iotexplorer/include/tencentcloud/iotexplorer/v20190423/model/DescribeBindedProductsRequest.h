...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBEBINDEDPRODUCTSREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBEBINDEDPRODUCTSREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class DescribeBindedProductsRequest : public AbstractModel
                {
                public:
                    DescribeBindedProductsRequest();
                    ~DescribeBindedProductsRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBEBINDEDPRODUCTSREQUEST_H_
