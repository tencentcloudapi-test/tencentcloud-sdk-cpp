...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBETWESEERECOGNITIONTASKREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBETWESEERECOGNITIONTASKREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class DescribeTWeSeeRecognitionTaskRequest : public AbstractModel
                {
                public:
                    DescribeTWeSeeRecognitionTaskRequest();
                    ~DescribeTWeSeeRecognitionTaskRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBETWESEERECOGNITIONTASKREQUEST_H_
