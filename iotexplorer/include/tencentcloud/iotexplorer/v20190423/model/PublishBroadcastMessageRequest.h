...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_PUBLISHBROADCASTMESSAGEREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_PUBLISHBROADCASTMESSAGEREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取ayload内容的编码格式，取值为base64或空。base64表示云端将收到的请求数据进行base64解码后下发到设备，空则直接将原始内容下发到设备
                     * @return PayloadEncoding ayload内容的编码格式，取值为base64或空。base64表示云端将收到的请求数据进行base64解码后下发到设备，空则直接将原始内容下发到设备
                     * 
                     */
                    std::string GetPayloadEncoding() const;

                    /**
                     * 设置ayload内容的编码格式，取值为base64或空。base64表示云端将收到的请求数据进行base64解码后下发到设备，空则直接将原始内容下发到设备
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_PUBLISHBROADCASTMESSAGEREQUEST_H_
