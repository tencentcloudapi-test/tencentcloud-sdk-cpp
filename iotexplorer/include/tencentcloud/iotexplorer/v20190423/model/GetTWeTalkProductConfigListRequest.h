...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_GETTWETALKPRODUCTCONFIGLISTREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_GETTWETALKPRODUCTCONFIGLISTREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class GetTWeTalkProductConfigListRequest : public AbstractModel
                {
                public:
                    GetTWeTalkProductConfigListRequest();
                    ~GetTWeTalkProductConfigListRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_GETTWETALKPRODUCTCONFIGLISTREQUEST_H_
