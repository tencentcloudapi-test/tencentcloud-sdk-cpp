...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBETWETALKPRODUCTCONFIGREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBETWETALKPRODUCTCONFIGREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class DescribeTWeTalkProductConfigRequest : public AbstractModel
                {
                public:
                    DescribeTWeTalkProductConfigRequest();
                    ~DescribeTWeTalkProductConfigRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DESCRIBETWETALKPRODUCTCONFIGREQUEST_H_
