...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DELETETWETALKPRODUCTCONFIGV2REQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DELETETWETALKPRODUCTCONFIGV2REQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class DeleteTWeTalkProductConfigV2Request : public AbstractModel
                {
                public:
                    DeleteTWeTalkProductConfigV2Request();
                    ~DeleteTWeTalkProductConfigV2Request() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_DELETETWETALKPRODUCTCONFIGV2REQUEST_H_
