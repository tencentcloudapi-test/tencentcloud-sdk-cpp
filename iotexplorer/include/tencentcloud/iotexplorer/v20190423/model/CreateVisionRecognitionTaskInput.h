...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATEVISIONRECOGNITIONTASKINPUT_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATEVISIONRECOGNITIONTASKINPUT_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                * 批量创建的 TWeSee 语义理解任务
                */
                class CreateVisionRecognitionTaskInput : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CREATEVISIONRECOGNITIONTASKINPUT_H_
