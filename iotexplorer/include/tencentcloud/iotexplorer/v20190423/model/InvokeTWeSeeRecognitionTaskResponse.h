...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKRESPONSE_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKRESPONSE_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class InvokeTWeSeeRecognitionTaskResponse : public AbstractModel
                {
                public:
                    InvokeTWeSeeRecognitionTaskResponse();
                    ~InvokeTWeSeeRecognitionTaskResponse() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_INVOKETWESEERECOGNITIONTASKRESPONSE_H_
