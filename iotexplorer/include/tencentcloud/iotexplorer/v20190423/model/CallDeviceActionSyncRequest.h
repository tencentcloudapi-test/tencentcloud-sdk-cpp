...
#ifndef TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CALLDEVICEACTIONSYNCREQUEST_H_
#define TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CALLDEVICEACTIONSYNCREQUEST_H_
    ...
    namespace Iotexplorer
    {
        namespace V20190423
        {
            namespace Model
            {
                ...
                */
                class CallDeviceActionSyncRequest : public AbstractModel
                {
                public:
                    CallDeviceActionSyncRequest();
                    ~CallDeviceActionSyncRequest() = default;
...
#endif // !TENCENTCLOUD_IOTEXPLORER_V20190423_MODEL_CALLDEVICEACTIONSYNCREQUEST_H_
