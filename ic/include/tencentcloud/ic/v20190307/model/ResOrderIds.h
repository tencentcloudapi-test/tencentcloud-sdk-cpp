...
#ifndef TENCENTCLOUD_IC_V20190307_MODEL_RESORDERIDS_H_
#define TENCENTCLOUD_IC_V20190307_MODEL_RESORDERIDS_H_
    ...
    namespace Ic
    {
        namespace V20190307
        {
            namespace Model
            {
                ...
                * 订单ID集合
                */
                class ResOrderIds : public AbstractModel
                {
                public:
                    ResOrderIds();
...
#endif // !TENCENTCLOUD_IC_V20190307_MODEL_RESORDERIDS_H_
