...
#ifndef TENCENTCLOUD_SQLSERVER_V20180328_MODEL_RUNMIGRATIONREQUEST_H_
#define TENCENTCLOUD_SQLSERVER_V20180328_MODEL_RUNMIGRATIONREQUEST_H_
    ...
    namespace Sqlserver
    {
        namespace V20180328
        {
            namespace Model
            {
                ...
                * RunMigration请求参数结构体
                */
                class RunMigrationRequest : public AbstractModel
                {
                public:
                    RunMigrationRequest();
...
#endif // !TENCENTCLOUD_SQLSERVER_V20180328_MODEL_RUNMIGRATIONREQUEST_H_
