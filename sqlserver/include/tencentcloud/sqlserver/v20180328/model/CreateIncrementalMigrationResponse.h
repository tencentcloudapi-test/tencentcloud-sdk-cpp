...
#ifndef TENCENTCLOUD_SQLSERVER_V20180328_MODEL_CREATEINCREMENTALMIGRATIONRESPONSE_H_
#define TENCENTCLOUD_SQLSERVER_V20180328_MODEL_CREATEINCREMENTALMIGRATIONRESPONSE_H_
    ...
    namespace Sqlserver
    {
        namespace V20180328
        {
            namespace Model
            {
                ...
                */
                class CreateIncrementalMigrationResponse : public AbstractModel
                {
                public:
                    CreateIncrementalMigrationResponse();
                    ~CreateIncrementalMigrationResponse() = default;
