...
#ifndef TENCENTCLOUD_SQLSERVER_V20180328_MODEL_SLOWLOG_H_
#define TENCENTCLOUD_SQLSERVER_V20180328_MODEL_SLOWLOG_H_
    ...
    namespace Sqlserver
    {
        namespace V20180328
        {
            namespace Model
            {
                ...
                * 慢查询日志文件信息
                */
                class SlowLog : public AbstractModel
                {
                public:
                    SlowLog();
...
#endif // !TENCENTCLOUD_SQLSERVER_V20180328_MODEL_SLOWLOG_H_
