...
#ifndef TENCENTCLOUD_SQLSERVER_V20180328_MODEL_DESCRIBEUPLOADBACKUPINFOREQUEST_H_
#define TENCENTCLOUD_SQLSERVER_V20180328_MODEL_DESCRIBEUPLOADBACKUPINFOREQUEST_H_
    ...
    namespace Sqlserver
    {
        namespace V20180328
        {
            namespace Model
            {
                ...
                */
                class DescribeUploadBackupInfoRequest : public AbstractModel
                {
                public:
                    DescribeUploadBackupInfoRequest();
                    ~DescribeUploadBackupInfoRequest() = default;
...
#endif // !TENCENTCLOUD_SQLSERVER_V20180328_MODEL_DESCRIBEUPLOADBACKUPINFOREQUEST_H_
