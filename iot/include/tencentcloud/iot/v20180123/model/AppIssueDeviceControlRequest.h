...
#ifndef TENCENTCLOUD_IOT_V20180123_MODEL_APPISSUEDEVICECONTROLREQUEST_H_
#define TENCENTCLOUD_IOT_V20180123_MODEL_APPISSUEDEVICECONTROLREQUEST_H_
    ...
    namespace Iot
    {
        namespace V20180123
        {
            namespace Model
            {
                ...
                */
                class AppIssueDeviceControlRequest : public AbstractModel
                {
                public:
                    AppIssueDeviceControlRequest();
                    ~AppIssueDeviceControlRequest() = default;
...
#endif // !TENCENTCLOUD_IOT_V20180123_MODEL_APPISSUEDEVICECONTROLREQUEST_H_
