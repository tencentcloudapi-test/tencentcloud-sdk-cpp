...
#ifndef TENCENTCLOUD_IOT_V20180123_MODEL_ADDRULEREQUEST_H_
#define TENCENTCLOUD_IOT_V20180123_MODEL_ADDRULEREQUEST_H_
    ...
    namespace Iot
    {
        namespace V20180123
        {
            namespace Model
            {
                ...
                * AddRule请求参数结构体
                */
                class AddRuleRequest : public AbstractModel
                {
                public:
                    AddRuleRequest();
                    ~AddRuleRequest() = default;
...
#endif // !TENCENTCLOUD_IOT_V20180123_MODEL_ADDRULEREQUEST_H_
