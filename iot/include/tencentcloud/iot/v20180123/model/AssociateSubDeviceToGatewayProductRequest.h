...
#ifndef TENCENTCLOUD_IOT_V20180123_MODEL_ASSOCIATESUBDEVICETOGATEWAYPRODUCTREQUEST_H_
#define TENCENTCLOUD_IOT_V20180123_MODEL_ASSOCIATESUBDEVICETOGATEWAYPRODUCTREQUEST_H_
    ...
    namespace Iot
    {
        namespace V20180123
        {
            namespace Model
            {
                ...
                */
                class AssociateSubDeviceToGatewayProductRequest : public AbstractModel
                {
                public:
                    AssociateSubDeviceToGatewayProductRequest();
                    ~AssociateSubDeviceToGatewayProductRequest() = default;
...
#endif // !TENCENTCLOUD_IOT_V20180123_MODEL_ASSOCIATESUBDEVICETOGATEWAYPRODUCTREQUEST_H_
