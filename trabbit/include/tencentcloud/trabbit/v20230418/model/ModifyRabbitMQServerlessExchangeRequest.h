...
#ifndef TENCENTCLOUD_TRABBIT_V20230418_MODEL_MODIFYRABBITMQSERVERLESSEXCHANGEREQUEST_H_
#define TENCENTCLOUD_TRABBIT_V20230418_MODEL_MODIFYRABBITMQSERVERLESSEXCHANGEREQUEST_H_
    ...
    namespace Trabbit
    {
        namespace V20230418
        {
            namespace Model
            {
                ...
                */
                class ModifyRabbitMQServerlessExchangeRequest : public AbstractModel
                {
                public:
                    ModifyRabbitMQServerlessExchangeRequest();
                    ~ModifyRabbitMQServerlessExchangeRequest() = default;
...
#endif // !TENCENTCLOUD_TRABBIT_V20230418_MODEL_MODIFYRABBITMQSERVERLESSEXCHANGEREQUEST_H_
