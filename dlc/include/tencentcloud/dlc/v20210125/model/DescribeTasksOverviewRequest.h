...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBETASKSOVERVIEWREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBETASKSOVERVIEWREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class DescribeTasksOverviewRequest : public AbstractModel
                {
                public:
                    DescribeTasksOverviewRequest();
                    ~DescribeTasksOverviewRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_DESCRIBETASKSOVERVIEWREQUEST_H_
