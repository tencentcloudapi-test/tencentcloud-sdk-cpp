...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CREATEDMSTABLEREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CREATEDMSTABLEREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CreateDMSTableRequest : public AbstractModel
                {
                public:
                    CreateDMSTableRequest();
                    ~CreateDMSTableRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CREATEDMSTABLEREQUEST_H_
