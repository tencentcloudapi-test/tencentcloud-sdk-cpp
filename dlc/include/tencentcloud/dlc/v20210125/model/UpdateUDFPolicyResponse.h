...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEUDFPOLICYRESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEUDFPOLICYRESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class UpdateUDFPolicyResponse : public AbstractModel
                {
                public:
                    UpdateUDFPolicyResponse();
                    ~UpdateUDFPolicyResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_UPDATEUDFPOLICYRESPONSE_H_
