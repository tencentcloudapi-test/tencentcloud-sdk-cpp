...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_UPDATENETWORKCONNECTIONREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_UPDATENETWORKCONNECTIONREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class UpdateNetworkConnectionRequest : public AbstractModel
                {
                public:
                    UpdateNetworkConnectionRequest();
                    ~UpdateNetworkConnectionRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_UPDATENETWORKCONNECTIONREQUEST_H_
