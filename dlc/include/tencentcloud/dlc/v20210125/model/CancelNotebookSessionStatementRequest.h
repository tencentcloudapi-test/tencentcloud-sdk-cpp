...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CANCELNOTEBOOKSESSIONSTATEMENTREQUEST_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CANCELNOTEBOOKSESSIONSTATEMENTREQUEST_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CancelNotebookSessionStatementRequest : public AbstractModel
                {
                public:
                    CancelNotebookSessionStatementRequest();
                    ~CancelNotebookSessionStatementRequest() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CANCELNOTEBOOKSESSIONSTATEMENTREQUEST_H_
