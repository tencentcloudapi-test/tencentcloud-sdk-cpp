...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_CHECKLOCKMETADATARESPONSE_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_CHECKLOCKMETADATARESPONSE_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class CheckLockMetaDataResponse : public AbstractModel
                {
                public:
                    CheckLockMetaDataResponse();
                    ~CheckLockMetaDataResponse() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_CHECKLOCKMETADATARESPONSE_H_
