...
#ifndef TENCENTCLOUD_IGTM_V20231024_MODEL_CREATEADDRESSPOOLREQUEST_H_
#define TENCENTCLOUD_IGTM_V20231024_MODEL_CREATEADDRESSPOOLREQUEST_H_
    ...
    namespace Igtm
    {
        namespace V20231024
        {
            namespace Model
            {
                ...
                */
                class CreateAddressPoolRequest : public AbstractModel
                {
                public:
                    CreateAddressPoolRequest();
                    ~CreateAddressPoolRequest() = default;
...
#endif // !TENCENTCLOUD_IGTM_V20231024_MODEL_CREATEADDRESSPOOLREQUEST_H_
