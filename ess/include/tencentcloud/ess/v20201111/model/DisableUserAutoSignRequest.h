...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_DISABLEUSERAUTOSIGNREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_DISABLEUSERAUTOSIGNREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class DisableUserAutoSignRequest : public AbstractModel
                {
                public:
                    DisableUserAutoSignRequest();
                    ~DisableUserAutoSignRequest() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_DISABLEUSERAUTOSIGNREQUEST_H_
