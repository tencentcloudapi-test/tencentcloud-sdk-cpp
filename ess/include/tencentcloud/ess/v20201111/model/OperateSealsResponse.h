...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_OPERATESEALSRESPONSE_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_OPERATESEALSRESPONSE_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                * OperateSeals返回参数结构体
                */
                class OperateSealsResponse : public AbstractModel
                {
                public:
                    OperateSealsResponse();
                    ~OperateSealsResponse() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_OPERATESEALSRESPONSE_H_
