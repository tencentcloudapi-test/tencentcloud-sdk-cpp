...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBESIGNFACEVIDEOREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBESIGNFACEVIDEOREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class DescribeSignFaceVideoRequest : public AbstractModel
                {
                public:
                    DescribeSignFaceVideoRequest();
                    ~DescribeSignFaceVideoRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取执行本接口操作的员工信息。使用此接口时，必须填写userId。<br/>注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
                     * @return Operator 执行本接口操作的员工信息。使用此接口时，必须填写userId。<br/>注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
                     * 
                     */
                    UserInfo GetOperator() const;

                    /**
                     * 设置执行本接口操作的员工信息。使用此接口时，必须填写userId。<br/>注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBESIGNFACEVIDEOREQUEST_H_
