...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEFILECOUNTERSIGNRESULTREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEFILECOUNTERSIGNRESULTREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class DescribeFileCounterSignResultRequest : public AbstractModel
                {
                public:
                    DescribeFileCounterSignResultRequest();
                    ~DescribeFileCounterSignResultRequest() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_DESCRIBEFILECOUNTERSIGNRESULTREQUEST_H_
