...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_CREATEFLOWGROUPBYFILESRESPONSE_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_CREATEFLOWGROUPBYFILESRESPONSE_H_
...
namespace TencentCloud
{
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                class FlowGroupApprovers;

                /**
                * CreateFlowGroupByFiles返回参数结构体
                */
                class CreateFlowGroupByFilesResponse : public AbstractModel
                {
                public:
                    CreateFlowGroupByFilesResponse();
                    ~CreateFlowGroupByFilesResponse() = default;
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_CREATEFLOWGROUPBYFILESRESPONSE_H_
