...
#ifndef TENCENTCLOUD_ESS_V20201111_MODEL_CREATESINGLESIGNONEMPLOYEESREQUEST_H_
#define TENCENTCLOUD_ESS_V20201111_MODEL_CREATESINGLESIGNONEMPLOYEESREQUEST_H_
    ...
    namespace Ess
    {
        namespace V20201111
        {
            namespace Model
            {
                ...
                */
                class CreateSingleSignOnEmployeesRequest : public AbstractModel
                {
                public:
                    CreateSingleSignOnEmployeesRequest();
                    ~CreateSingleSignOnEmployeesRequest() = default;
...
3. 绑定的角色必须存在且不能超过 10 个。
                     * @return Employees 待创建员工的信息最多不超过200个。
...
3. 绑定的角色必须存在且不能超过 10 个。
                     * 
                     */
                    void SetEmployees(const std::vector<SingleSignOnEmployees>& _employees);
...
#endif // !TENCENTCLOUD_ESS_V20201111_MODEL_CREATESINGLESIGNONEMPLOYEESREQUEST_H_
