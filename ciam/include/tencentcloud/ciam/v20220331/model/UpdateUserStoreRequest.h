...
#ifndef TENCENTCLOUD_CIAM_V20220331_MODEL_UPDATEUSERSTOREREQUEST_H_
#define TENCENTCLOUD_CIAM_V20220331_MODEL_UPDATEUSERSTOREREQUEST_H_
    ...
    namespace Ciam
    {
        namespace V20220331
        {
            namespace Model
            {
                ...
                */
                class UpdateUserStoreRequest : public AbstractModel
                {
                public:
                    UpdateUserStoreRequest();
                    ~UpdateUserStoreRequest() = default;
...
#endif // !TENCENTCLOUD_CIAM_V20220331_MODEL_UPDATEUSERSTOREREQUEST_H_
