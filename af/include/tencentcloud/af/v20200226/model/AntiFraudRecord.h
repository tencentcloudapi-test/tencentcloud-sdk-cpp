...
#ifndef TENCENTCLOUD_AF_V20200226_MODEL_ANTIFRAUDRECORD_H_
#define TENCENTCLOUD_AF_V20200226_MODEL_ANTIFRAUDRECORD_H_
    ...
    namespace Af
    {
        namespace V20200226
        {
            namespace Model
            {
                ...
                class OtherModelScoresDetail;

                /**
                * 反欺诈查询结果
                */
                class AntiFraudRecord : public AbstractModel
                {
                public:
                    AntiFraudRecord();
...
注意：此字段可能返回 null，表示取不到有效值。
                     */
                    std::vector<OtherModelScoresDetail> m_otherModelScores;
...
#endif // !TENCENTCLOUD_AF_V20200226_MODEL_ANTIFRAUDRECORD_H_
