...
#ifndef TENCENTCLOUD_AF_V20200226_MODEL_FINANCEANTIFRAUDFILTER_H_
#define TENCENTCLOUD_AF_V20200226_MODEL_FINANCEANTIFRAUDFILTER_H_
    ...
    namespace Af
    {
        namespace V20200226
        {
            namespace Model
            {
                ...
                * 借贷反欺诈原始业务入参
                */
                class FinanceAntiFraudFilter : public AbstractModel
                {
                public:
                    ...
                    /**
                     * 获取身份证Id(五选二) 参数详细定义请加微信：TYXGJ-01
                     * @return IdNumber 身份证Id(五选二) 参数详细定义请加微信：TYXGJ-01
                     * 
                     */
                    std::string GetIdNumber() const;

                    /**
                     * 设置身份证Id(五选二) 参数详细定义请加微信：TYXGJ-01
                    ...
                    /**
                     * 获取1：关联的腾讯帐号QQ；2：开放帐号微信
                     * @return AccountType 1：关联的腾讯帐号QQ；2：开放帐号微信
                     * 
                     */
                    std::string GetAccountType() const;

                    /**
                     * 设置1：关联的腾讯帐号QQ；2：开放帐号微信
                    ...
                    /**
                     * 获取qq 或微信分配给网站或应用的 appid，用来唯一标识网站或应用
                     * @return AppIdU qq 或微信分配给网站或应用的 appid，用来唯一标识网站或应用
                     * 
                     */
                    std::string GetAppIdU() const;

                    /**
                     * 设置qq 或微信分配给网站或应用的 appid，用来唯一标识网站或应用
                    ...
                    /**
                     * 获取业务 ID，在多个业务中使用此服务，通过此ID 区分统计数据
                     * @return BusinessId 业务 ID，在多个业务中使用此服务，通过此ID 区分统计数据
                     * 
                     */
                    std::string GetBusinessId() const;

                    /**
                     * 设置业务 ID，在多个业务中使用此服务，通过此ID 区分统计数据
                    ...
                    /**
                     * 获取手机号加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
                     * @return PhoneCryptoType 手机号加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
                     * 
                     */
                    std::string GetPhoneCryptoType() const;

                    /**
                     * 设置手机号加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
                    ...
                    /**
                     * 获取身份证Id加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
                     * @return IdCryptoType 身份证Id加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
                     * 
                     */
                    std::string GetIdCryptoType() const;

                    /**
                     * 设置身份证Id加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
                    ...
                    /**
                     * 获取姓名加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
                     * @return NameCryptoType 姓名加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
                     * 
                     */
                    std::string GetNameCryptoType() const;

                    /**
                     * 设置姓名加密类型 0：不加密（默认值）；1：md5；2：sha256；3：SM3
...
#endif // !TENCENTCLOUD_AF_V20200226_MODEL_FINANCEANTIFRAUDFILTER_H_
