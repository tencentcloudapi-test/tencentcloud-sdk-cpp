...
#ifndef TENCENTCLOUD_ECM_V20190719_MODEL_DESCRIBEDISKSREQUEST_H_
#define TENCENTCLOUD_ECM_V20190719_MODEL_DESCRIBEDISKSREQUEST_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取云盘列表排序的依据字段。取值范围：<br><li>CREATE_TIME：依据云盘的创建时间排序<br><li>DEADLINE：依据云盘的到期时间排序<br>默认按云盘创建时间排序。
                     * @return OrderField 云盘列表排序的依据字段。取值范围：<br><li>CREATE_TIME：依据云盘的创建时间排序<br><li>DEADLINE：依据云盘的到期时间排序<br>默认按云盘创建时间排序。
                     * 
                     */
                    std::string GetOrderField() const;

                    /**
                     * 设置云盘列表排序的依据字段。取值范围：<br><li>CREATE_TIME：依据云盘的创建时间排序<br><li>DEADLINE：依据云盘的到期时间排序<br>默认按云盘创建时间排序。
...
#endif // !TENCENTCLOUD_ECM_V20190719_MODEL_DESCRIBEDISKSREQUEST_H_
