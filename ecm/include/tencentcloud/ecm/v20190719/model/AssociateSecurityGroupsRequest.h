            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取要绑定的安全组ID，类似esg-efil73jd，只支持绑定单个安全组。
                     * @return SecurityGroupIds 要绑定的安全组ID，类似esg-efil73jd，只支持绑定单个安全组。
                     * 
                     */
                    std::vector<std::string> GetSecurityGroupIds() const;

                    /**
                     * 设置要绑定的安全组ID，类似esg-efil73jd，只支持绑定单个安全组。
                    ...
                    /**
                     * 获取被绑定的实例ID，类似ein-lesecurk，支持指定多个实例，每次请求批量实例的上限为100。
                     * @return InstanceIds 被绑定的实例ID，类似ein-lesecurk，支持指定多个实例，每次请求批量实例的上限为100。
                     * 
                     */
                    std::vector<std::string> GetInstanceIds() const;

                    /**
                     * 设置被绑定的实例ID，类似ein-lesecurk，支持指定多个实例，每次请求批量实例的上限为100。
