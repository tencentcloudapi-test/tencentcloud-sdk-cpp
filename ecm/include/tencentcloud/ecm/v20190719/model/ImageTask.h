...
#ifndef TENCENTCLOUD_ECM_V20190719_MODEL_IMAGETASK_H_
#define TENCENTCLOUD_ECM_V20190719_MODEL_IMAGETASK_H_
    ...
    namespace Ecm
    {
        namespace V20190719
        {
            namespace Model
            {
                ...
                * 镜像任务
                */
                class ImageTask : public AbstractModel
                {
                public:
                    ImageTask();
...
#endif // !TENCENTCLOUD_ECM_V20190719_MODEL_IMAGETASK_H_
