...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_VALUEUNITITEM_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_VALUEUNITITEM_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 体检报告信息-包含单位
                */
                class ValueUnitItem : public AbstractModel
                {
                public:
                    ValueUnitItem();
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_VALUEUNITITEM_H_
