...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_IMAGEMASKASYNCREQUEST_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_IMAGEMASKASYNCREQUEST_H_
...
namespace TencentCloud
{
    namespace Mrs
    {
        namespace V20200910
        {
            ...
            {
                class ImageInfo;
                class ImageMaskFlags;

                /**
                * ImageMaskAsync请求参数结构体
                */
                class ImageMaskAsyncRequest : public AbstractModel
                {
                public:
                    ImageMaskAsyncRequest();
                    ~ImageMaskAsyncRequest() = default;
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_IMAGEMASKASYNCREQUEST_H_
