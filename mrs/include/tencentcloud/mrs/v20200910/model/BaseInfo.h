...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_BASEINFO_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_BASEINFO_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * 标准信息类
                */
                class BaseInfo : public AbstractModel
                {
                public:
                    BaseInfo();
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_BASEINFO_H_
