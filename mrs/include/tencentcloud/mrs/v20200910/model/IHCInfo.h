...
#ifndef TENCENTCLOUD_MRS_V20200910_MODEL_IHCINFO_H_
#define TENCENTCLOUD_MRS_V20200910_MODEL_IHCINFO_H_
    ...
    namespace Mrs
    {
        namespace V20200910
        {
            namespace Model
            {
                ...
                * Ihc信息
                */
                class IHCInfo : public AbstractModel
                {
                public:
                    IHCInfo();
...
#endif // !TENCENTCLOUD_MRS_V20200910_MODEL_IHCINFO_H_
