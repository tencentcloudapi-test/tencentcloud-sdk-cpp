...
#ifndef TENCENTCLOUD_BMLB_V20180625_MODEL_MODIFYL4BACKENDPORTREQUEST_H_
#define TENCENTCLOUD_BMLB_V20180625_MODEL_MODIFYL4BACKENDPORTREQUEST_H_
    ...
    namespace Bmlb
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class ModifyL4BackendPortRequest : public AbstractModel
                {
                public:
                    ModifyL4BackendPortRequest();
                    ~ModifyL4BackendPortRequest() = default;
...
#endif // !TENCENTCLOUD_BMLB_V20180625_MODEL_MODIFYL4BACKENDPORTREQUEST_H_
