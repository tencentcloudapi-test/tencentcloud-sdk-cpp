...
#ifndef TENCENTCLOUD_BMLB_V20180625_MODEL_DESCRIBEL4LISTENERSREQUEST_H_
#define TENCENTCLOUD_BMLB_V20180625_MODEL_DESCRIBEL4LISTENERSREQUEST_H_
    ...
    namespace Bmlb
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class DescribeL4ListenersRequest : public AbstractModel
                {
                public:
                    DescribeL4ListenersRequest();
                    ~DescribeL4ListenersRequest() = default;
...
#endif // !TENCENTCLOUD_BMLB_V20180625_MODEL_DESCRIBEL4LISTENERSREQUEST_H_
