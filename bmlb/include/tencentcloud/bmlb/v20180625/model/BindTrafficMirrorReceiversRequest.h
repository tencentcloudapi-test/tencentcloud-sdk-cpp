...
#ifndef TENCENTCLOUD_BMLB_V20180625_MODEL_BINDTRAFFICMIRRORRECEIVERSREQUEST_H_
#define TENCENTCLOUD_BMLB_V20180625_MODEL_BINDTRAFFICMIRRORRECEIVERSREQUEST_H_
    ...
    namespace Bmlb
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class BindTrafficMirrorReceiversRequest : public AbstractModel
                {
                public:
                    BindTrafficMirrorReceiversRequest();
                    ~BindTrafficMirrorReceiversRequest() = default;
                     ...
                     * 
                     */
                    std::vector<BindTrafficMirrorReceiver> GetReceiverSet() const;
                     ...
                     * 
                     */
                    void SetReceiverSet(const std::vector<BindTrafficMirrorReceiver>& _receiverSet);
                ...
                private:
                     ...
                     * 待绑定的黑石物理机信息数组。
                     */
                    std::vector<BindTrafficMirrorReceiver> m_receiverSet;
...
#endif // !TENCENTCLOUD_BMLB_V20180625_MODEL_BINDTRAFFICMIRRORRECEIVERSREQUEST_H_
