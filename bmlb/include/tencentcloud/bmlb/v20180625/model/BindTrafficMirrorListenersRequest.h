...
#ifndef TENCENTCLOUD_BMLB_V20180625_MODEL_BINDTRAFFICMIRRORLISTENERSREQUEST_H_
#define TENCENTCLOUD_BMLB_V20180625_MODEL_BINDTRAFFICMIRRORLISTENERSREQUEST_H_
    ...
    namespace Bmlb
    {
        namespace V20180625
        {
            namespace Model
            {
                ...
                */
                class BindTrafficMirrorListenersRequest : public AbstractModel
                {
                public:
                    BindTrafficMirrorListenersRequest();
                    ~BindTrafficMirrorListenersRequest() = default;
...
#endif // !TENCENTCLOUD_BMLB_V20180625_MODEL_BINDTRAFFICMIRRORLISTENERSREQUEST_H_
