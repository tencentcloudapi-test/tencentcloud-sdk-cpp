...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBEWXGATEWAYSREQUEST_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBEWXGATEWAYSREQUEST_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                */
                class DescribeWxGatewaysRequest : public AbstractModel
                {
                public:
                    DescribeWxGatewaysRequest();
                    ~DescribeWxGatewaysRequest() = default;
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_DESCRIBEWXGATEWAYSREQUEST_H_
