...
#ifndef TENCENTCLOUD_TCB_V20180608_MODEL_TURNONSTANDALONEGATEWAYREQUEST_H_
#define TENCENTCLOUD_TCB_V20180608_MODEL_TURNONSTANDALONEGATEWAYREQUEST_H_
    ...
    namespace Tcb
    {
        namespace V20180608
        {
            namespace Model
            {
                ...
                */
                class TurnOnStandaloneGatewayRequest : public AbstractModel
                {
                public:
                    TurnOnStandaloneGatewayRequest();
                    ~TurnOnStandaloneGatewayRequest() = default;
...
#endif // !TENCENTCLOUD_TCB_V20180608_MODEL_TURNONSTANDALONEGATEWAYREQUEST_H_
