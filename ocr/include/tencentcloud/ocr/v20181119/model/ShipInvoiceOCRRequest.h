...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_SHIPINVOICEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_SHIPINVOICEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class ShipInvoiceOCRRequest : public AbstractModel
                {
                public:
                    ShipInvoiceOCRRequest();
                    ~ShipInvoiceOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_SHIPINVOICEOCRREQUEST_H_
