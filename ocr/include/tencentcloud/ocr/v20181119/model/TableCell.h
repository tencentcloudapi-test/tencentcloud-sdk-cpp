...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_TABLECELL_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_TABLECELL_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 单元格数据
                */
                class TableCell : public AbstractModel
                {
                public:
                    TableCell();
...
注意：此字段可能返回 null，表示取不到有效值。
                     ...
                     * 
                     */
                    std::vector<CellContent> GetContents() const;
                     ...
                     * 
                     */
                    void SetContents(const std::vector<CellContent>& _contents);
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_TABLECELL_H_
