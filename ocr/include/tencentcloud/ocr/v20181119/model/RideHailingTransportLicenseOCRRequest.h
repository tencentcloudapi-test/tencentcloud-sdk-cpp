...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RIDEHAILINGTRANSPORTLICENSEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RIDEHAILINGTRANSPORTLICENSEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RideHailingTransportLicenseOCRRequest : public AbstractModel
                {
                public:
                    RideHailingTransportLicenseOCRRequest();
                    ~RideHailingTransportLicenseOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RIDEHAILINGTRANSPORTLICENSEOCRREQUEST_H_
