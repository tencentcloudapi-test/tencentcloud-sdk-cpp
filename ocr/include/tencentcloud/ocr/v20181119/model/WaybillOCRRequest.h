...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_WAYBILLOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_WAYBILLOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * WaybillOCR请求参数结构体
                */
                class WaybillOCRRequest : public AbstractModel
                {
                public:
                    WaybillOCRRequest();
                    ~WaybillOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_WAYBILLOCRREQUEST_H_
