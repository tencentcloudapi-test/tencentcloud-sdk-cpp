...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_CARINVOICEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_CARINVOICEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class CarInvoiceOCRRequest : public AbstractModel
                {
                public:
                    CarInvoiceOCRRequest();
                    ~CarInvoiceOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_CARINVOICEOCRREQUEST_H_
