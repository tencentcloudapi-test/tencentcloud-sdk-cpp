...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_CUSTOMSDECLARATION_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_CUSTOMSDECLARATION_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 海关进/出口货物报关单
                */
                class CustomsDeclaration : public AbstractModel
                {
                public:
                    CustomsDeclaration();
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_CUSTOMSDECLARATION_H_
