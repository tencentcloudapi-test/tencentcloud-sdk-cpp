...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_DRIVERLICENSEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_DRIVERLICENSEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class DriverLicenseOCRRequest : public AbstractModel
                {
                public:
                    DriverLicenseOCRRequest();
                    ~DriverLicenseOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_DRIVERLICENSEOCRREQUEST_H_
