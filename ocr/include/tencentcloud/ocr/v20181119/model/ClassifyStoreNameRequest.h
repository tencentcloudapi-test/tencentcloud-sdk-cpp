...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_CLASSIFYSTORENAMEREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_CLASSIFYSTORENAMEREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class ClassifyStoreNameRequest : public AbstractModel
                {
                public:
                    ClassifyStoreNameRequest();
                    ~ClassifyStoreNameRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_CLASSIFYSTORENAMEREQUEST_H_
