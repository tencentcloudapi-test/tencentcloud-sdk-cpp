...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEFORMULAOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEFORMULAOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizeFormulaOCRRequest : public AbstractModel
                {
                public:
                    RecognizeFormulaOCRRequest();
                    ~RecognizeFormulaOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEFORMULAOCRREQUEST_H_
