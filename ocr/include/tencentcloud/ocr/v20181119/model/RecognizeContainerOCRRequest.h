...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZECONTAINEROCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZECONTAINEROCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizeContainerOCRRequest : public AbstractModel
                {
                public:
                    RecognizeContainerOCRRequest();
                    ~RecognizeContainerOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZECONTAINEROCRREQUEST_H_
