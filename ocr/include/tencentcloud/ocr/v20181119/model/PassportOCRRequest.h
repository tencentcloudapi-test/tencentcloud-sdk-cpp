...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_PASSPORTOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_PASSPORTOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * PassportOCR请求参数结构体
                */
                class PassportOCRRequest : public AbstractModel
                {
                public:
                    PassportOCRRequest();
                    ~PassportOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_PASSPORTOCRREQUEST_H_
