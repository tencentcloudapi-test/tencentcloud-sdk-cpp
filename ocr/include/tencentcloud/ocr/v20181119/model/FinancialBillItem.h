...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_FINANCIALBILLITEM_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_FINANCIALBILLITEM_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 财务票据查验返回结果-项目明细
                */
                class FinancialBillItem : public AbstractModel
                {
                public:
                    FinancialBillItem();
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_FINANCIALBILLITEM_H_
