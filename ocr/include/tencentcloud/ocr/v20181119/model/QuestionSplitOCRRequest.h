...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_QUESTIONSPLITOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_QUESTIONSPLITOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class QuestionSplitOCRRequest : public AbstractModel
                {
                public:
                    QuestionSplitOCRRequest();
                    ~QuestionSplitOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_QUESTIONSPLITOCRREQUEST_H_
