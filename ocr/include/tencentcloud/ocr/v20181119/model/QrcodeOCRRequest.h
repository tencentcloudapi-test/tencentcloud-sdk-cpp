...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_QRCODEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_QRCODEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * QrcodeOCR请求参数结构体
                */
                class QrcodeOCRRequest : public AbstractModel
                {
                public:
                    QrcodeOCRRequest();
                    ~QrcodeOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_QRCODEOCRREQUEST_H_
