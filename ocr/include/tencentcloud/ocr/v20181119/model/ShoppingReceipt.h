...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_SHOPPINGRECEIPT_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_SHOPPINGRECEIPT_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 购物小票
                */
                class ShoppingReceipt : public AbstractModel
                {
                public:
                    ShoppingReceipt();
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_SHOPPINGRECEIPT_H_
