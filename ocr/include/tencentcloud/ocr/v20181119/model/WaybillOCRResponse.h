...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_WAYBILLOCRRESPONSE_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_WAYBILLOCRRESPONSE_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * WaybillOCR返回参数结构体
                */
                class WaybillOCRResponse : public AbstractModel
                {
                public:
                    WaybillOCRResponse();
                    ~WaybillOCRResponse() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_WAYBILLOCRRESPONSE_H_
