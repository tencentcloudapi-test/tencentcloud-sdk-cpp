...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_TRAINTICKETOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_TRAINTICKETOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class TrainTicketOCRRequest : public AbstractModel
                {
                public:
                    TrainTicketOCRRequest();
                    ~TrainTicketOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_TRAINTICKETOCRREQUEST_H_
