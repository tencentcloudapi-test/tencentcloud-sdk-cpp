...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_LICENSEPLATEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_LICENSEPLATEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class LicensePlateOCRRequest : public AbstractModel
                {
                public:
                    LicensePlateOCRRequest();
                    ~LicensePlateOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_LICENSEPLATEOCRREQUEST_H_
