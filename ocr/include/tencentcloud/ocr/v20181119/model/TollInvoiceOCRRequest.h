...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_TOLLINVOICEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_TOLLINVOICEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class TollInvoiceOCRRequest : public AbstractModel
                {
                public:
                    TollInvoiceOCRRequest();
                    ~TollInvoiceOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_TOLLINVOICEOCRREQUEST_H_
