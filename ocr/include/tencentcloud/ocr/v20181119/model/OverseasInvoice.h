...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_OVERSEASINVOICE_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_OVERSEASINVOICE_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 海外发票
                */
                class OverseasInvoice : public AbstractModel
                {
                public:
                    OverseasInvoice();
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_OVERSEASINVOICE_H_
