...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RESIDENCEBOOKLETOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RESIDENCEBOOKLETOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class ResidenceBookletOCRRequest : public AbstractModel
                {
                public:
                    ResidenceBookletOCRRequest();
                    ~ResidenceBookletOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RESIDENCEBOOKLETOCRREQUEST_H_
