...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEONLINETAXIITINERARYOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEONLINETAXIITINERARYOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizeOnlineTaxiItineraryOCRRequest : public AbstractModel
                {
                public:
                    RecognizeOnlineTaxiItineraryOCRRequest();
                    ~RecognizeOnlineTaxiItineraryOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEONLINETAXIITINERARYOCRREQUEST_H_
