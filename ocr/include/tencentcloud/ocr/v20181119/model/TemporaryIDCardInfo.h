...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_TEMPORARYIDCARDINFO_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_TEMPORARYIDCARDINFO_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 临时身份证信息返回
                */
                class TemporaryIDCardInfo : public AbstractModel
                {
                public:
                    TemporaryIDCardInfo();
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_TEMPORARYIDCARDINFO_H_
