...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_ADVERTISETEXTDETECTION_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_ADVERTISETEXTDETECTION_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * 广告文字识别结果
                */
                class AdvertiseTextDetection : public AbstractModel
                {
                public:
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_ADVERTISETEXTDETECTION_H_
