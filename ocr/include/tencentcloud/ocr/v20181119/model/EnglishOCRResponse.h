...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_ENGLISHOCRRESPONSE_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_ENGLISHOCRRESPONSE_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                * EnglishOCR返回参数结构体
                */
                class EnglishOCRResponse : public AbstractModel
                {
                public:
                    EnglishOCRResponse();
                    ~EnglishOCRResponse() = default;
                     ...
                     * 
                     */
                    std::vector<TextDetectionEn> GetTextDetections() const;
                ...
                private:
                     ...
                     */
                    std::vector<TextDetectionEn> m_textDetections;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_ENGLISHOCRRESPONSE_H_
