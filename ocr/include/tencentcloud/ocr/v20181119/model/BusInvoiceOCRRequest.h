...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_BUSINVOICEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_BUSINVOICEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class BusInvoiceOCRRequest : public AbstractModel
                {
                public:
                    BusInvoiceOCRRequest();
                    ~BusInvoiceOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_BUSINVOICEOCRREQUEST_H_
