...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_GENERALEFFICIENTOCRRESPONSE_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_GENERALEFFICIENTOCRRESPONSE_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class GeneralEfficientOCRResponse : public AbstractModel
                {
                public:
                    GeneralEfficientOCRResponse();
                    ~GeneralEfficientOCRResponse() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_GENERALEFFICIENTOCRRESPONSE_H_
