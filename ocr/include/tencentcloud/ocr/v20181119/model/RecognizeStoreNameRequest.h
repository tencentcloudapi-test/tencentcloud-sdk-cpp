...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZESTORENAMEREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZESTORENAMEREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizeStoreNameRequest : public AbstractModel
                {
                public:
                    RecognizeStoreNameRequest();
                    ~RecognizeStoreNameRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZESTORENAMEREQUEST_H_
