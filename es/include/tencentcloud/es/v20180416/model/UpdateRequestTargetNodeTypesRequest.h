...
#ifndef TENCENTCLOUD_ES_V20180416_MODEL_UPDATEREQUESTTARGETNODETYPESREQUEST_H_
#define TENCENTCLOUD_ES_V20180416_MODEL_UPDATEREQUESTTARGETNODETYPESREQUEST_H_
    ...
    namespace Es
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class UpdateRequestTargetNodeTypesRequest : public AbstractModel
                {
                public:
                    UpdateRequestTargetNodeTypesRequest();
                    ~UpdateRequestTargetNodeTypesRequest() = default;
...
#endif // !TENCENTCLOUD_ES_V20180416_MODEL_UPDATEREQUESTTARGETNODETYPESREQUEST_H_
