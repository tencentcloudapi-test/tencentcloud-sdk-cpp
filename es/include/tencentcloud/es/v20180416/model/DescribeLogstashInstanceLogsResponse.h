...
#ifndef TENCENTCLOUD_ES_V20180416_MODEL_DESCRIBELOGSTASHINSTANCELOGSRESPONSE_H_
#define TENCENTCLOUD_ES_V20180416_MODEL_DESCRIBELOGSTASHINSTANCELOGSRESPONSE_H_
    ...
    namespace Es
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class DescribeLogstashInstanceLogsResponse : public AbstractModel
                {
                public:
                    DescribeLogstashInstanceLogsResponse();
                    ~DescribeLogstashInstanceLogsResponse() = default;
...
#endif // !TENCENTCLOUD_ES_V20180416_MODEL_DESCRIBELOGSTASHINSTANCELOGSRESPONSE_H_
