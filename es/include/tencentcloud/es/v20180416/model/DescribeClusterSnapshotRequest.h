...
#ifndef TENCENTCLOUD_ES_V20180416_MODEL_DESCRIBECLUSTERSNAPSHOTREQUEST_H_
#define TENCENTCLOUD_ES_V20180416_MODEL_DESCRIBECLUSTERSNAPSHOTREQUEST_H_
    ...
    namespace Es
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class DescribeClusterSnapshotRequest : public AbstractModel
                {
                public:
                    DescribeClusterSnapshotRequest();
                    ~DescribeClusterSnapshotRequest() = default;
...
#endif // !TENCENTCLOUD_ES_V20180416_MODEL_DESCRIBECLUSTERSNAPSHOTREQUEST_H_
