...
#ifndef TENCENTCLOUD_ES_V20180416_MODEL_STOPLOGSTASHPIPELINESREQUEST_H_
#define TENCENTCLOUD_ES_V20180416_MODEL_STOPLOGSTASHPIPELINESREQUEST_H_
    ...
    namespace Es
    {
        namespace V20180416
        {
            namespace Model
            {
                ...
                */
                class StopLogstashPipelinesRequest : public AbstractModel
                {
                public:
                    StopLogstashPipelinesRequest();
                    ~StopLogstashPipelinesRequest() = default;
...
#endif // !TENCENTCLOUD_ES_V20180416_MODEL_STOPLOGSTASHPIPELINESREQUEST_H_
