...
#ifndef TENCENTCLOUD_HASIM_V20210716_MODEL_RENEWLINKINFOREQUEST_H_
#define TENCENTCLOUD_HASIM_V20210716_MODEL_RENEWLINKINFOREQUEST_H_
    ...
    namespace Hasim
    {
        namespace V20210716
        {
            namespace Model
            {
                ...
                */
                class RenewLinkInfoRequest : public AbstractModel
                {
                public:
                    RenewLinkInfoRequest();
                    ~RenewLinkInfoRequest() = default;
...
#endif // !TENCENTCLOUD_HASIM_V20210716_MODEL_RENEWLINKINFOREQUEST_H_
