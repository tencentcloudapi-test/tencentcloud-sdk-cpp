...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTWAFINSTANCELISTREQUEST_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTWAFINSTANCELISTREQUEST_H_
    ...
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                ...
                */
                class DescribeHostWafInstanceListRequest : public AbstractModel
                {
                public:
                    DescribeHostWafInstanceListRequest();
                    ~DescribeHostWafInstanceListRequest() = default;
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTWAFINSTANCELISTREQUEST_H_
