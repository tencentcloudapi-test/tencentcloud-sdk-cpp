...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_DEPLOYCERTIFICATERECORDROLLBACKREQUEST_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_DEPLOYCERTIFICATERECORDROLLBACKREQUEST_H_
    ...
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                ...
                */
                class DeployCertificateRecordRollbackRequest : public AbstractModel
                {
                public:
                    DeployCertificateRecordRollbackRequest();
                    ~DeployCertificateRecordRollbackRequest() = default;
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_DEPLOYCERTIFICATERECORDROLLBACKREQUEST_H_
