...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTCOSINSTANCELISTRESPONSE_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTCOSINSTANCELISTRESPONSE_H_
...
namespace TencentCloud
{
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                class CosInstanceDetail;

                /**
                * DescribeHostCosInstanceList返回参数结构体
                */
                class DescribeHostCosInstanceListResponse : public AbstractModel
                {
                public:
                    DescribeHostCosInstanceListResponse();
                    ~DescribeHostCosInstanceListResponse() = default;
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTCOSINSTANCELISTRESPONSE_H_
