...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTTKEINSTANCELISTRESPONSE_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTTKEINSTANCELISTRESPONSE_H_
    ...
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                ...
                */
                class DescribeHostTkeInstanceListResponse : public AbstractModel
                {
                public:
                    DescribeHostTkeInstanceListResponse();
                    ~DescribeHostTkeInstanceListResponse() = default;
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTTKEINSTANCELISTRESPONSE_H_
