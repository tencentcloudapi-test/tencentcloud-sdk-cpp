...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_UPLOADUPDATECERTIFICATERECORDRETRYREQUEST_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_UPLOADUPDATECERTIFICATERECORDRETRYREQUEST_H_
    ...
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                ...
                */
                class UploadUpdateCertificateRecordRetryRequest : public AbstractModel
                {
                public:
                    UploadUpdateCertificateRecordRetryRequest();
                    ~UploadUpdateCertificateRecordRetryRequest() = default;
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_UPLOADUPDATECERTIFICATERECORDRETRYREQUEST_H_
