...
#ifndef TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTAPIGATEWAYINSTANCELISTRESPONSE_H_
#define TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTAPIGATEWAYINSTANCELISTRESPONSE_H_
...
namespace TencentCloud
{
    namespace Ssl
    {
        namespace V20191205
        {
            namespace Model
            {
                class ApiGatewayInstanceDetail;

                /**
                * DescribeHostApiGatewayInstanceList返回参数结构体
                */
                class DescribeHostApiGatewayInstanceListResponse : public AbstractModel
                {
                public:
                    DescribeHostApiGatewayInstanceListResponse();
                    ~DescribeHostApiGatewayInstanceListResponse() = default;
...
#endif // !TENCENTCLOUD_SSL_V20191205_MODEL_DESCRIBEHOSTAPIGATEWAYINSTANCELISTRESPONSE_H_
