...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEDDOSEVINFOREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEDDOSEVINFOREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeDDoSEvInfoRequest : public AbstractModel
                {
                public:
                    DescribeDDoSEvInfoRequest();
                    ~DescribeDDoSEvInfoRequest() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEDDOSEVINFOREQUEST_H_
