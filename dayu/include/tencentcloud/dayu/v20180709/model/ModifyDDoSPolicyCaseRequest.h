...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYDDOSPOLICYCASEREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYDDOSPOLICYCASEREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class ModifyDDoSPolicyCaseRequest : public AbstractModel
                {
                public:
                    ModifyDDoSPolicyCaseRequest();
                    ~ModifyDDoSPolicyCaseRequest() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYDDOSPOLICYCASEREQUEST_H_
