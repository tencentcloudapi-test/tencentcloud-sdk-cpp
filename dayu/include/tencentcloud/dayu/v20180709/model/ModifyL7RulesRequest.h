...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYL7RULESREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYL7RULESREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class ModifyL7RulesRequest : public AbstractModel
                {
                public:
                    ModifyL7RulesRequest();
                    ~ModifyL7RulesRequest() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_MODIFYL7RULESREQUEST_H_
