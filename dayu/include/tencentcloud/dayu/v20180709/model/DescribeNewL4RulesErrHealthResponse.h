...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBENEWL4RULESERRHEALTHRESPONSE_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBENEWL4RULESERRHEALTHRESPONSE_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeNewL4RulesErrHealthResponse : public AbstractModel
                {
                public:
                    DescribeNewL4RulesErrHealthResponse();
                    ~DescribeNewL4RulesErrHealthResponse() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBENEWL4RULESERRHEALTHRESPONSE_H_
