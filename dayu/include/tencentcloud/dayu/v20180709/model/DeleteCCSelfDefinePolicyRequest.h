...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DELETECCSELFDEFINEPOLICYREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DELETECCSELFDEFINEPOLICYREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DeleteCCSelfDefinePolicyRequest : public AbstractModel
                {
                public:
                    DeleteCCSelfDefinePolicyRequest();
                    ~DeleteCCSelfDefinePolicyRequest() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DELETECCSELFDEFINEPOLICYREQUEST_H_
