...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEL7HEALTHCONFIGREQUEST_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEL7HEALTHCONFIGREQUEST_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeL7HealthConfigRequest : public AbstractModel
                {
                public:
                    DescribeL7HealthConfigRequest();
                    ~DescribeL7HealthConfigRequest() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEL7HEALTHCONFIGREQUEST_H_
