...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBLEL4RULESRESPONSE_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBLEL4RULESRESPONSE_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribleL4RulesResponse : public AbstractModel
                {
                public:
                    DescribleL4RulesResponse();
                    ~DescribleL4RulesResponse() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBLEL4RULESRESPONSE_H_
