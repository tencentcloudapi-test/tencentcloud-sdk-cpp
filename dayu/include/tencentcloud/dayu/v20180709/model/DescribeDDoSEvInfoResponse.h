...
#ifndef TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEDDOSEVINFORESPONSE_H_
#define TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEDDOSEVINFORESPONSE_H_
    ...
    namespace Dayu
    {
        namespace V20180709
        {
            namespace Model
            {
                ...
                */
                class DescribeDDoSEvInfoResponse : public AbstractModel
                {
                public:
                    DescribeDDoSEvInfoResponse();
                    ~DescribeDDoSEvInfoResponse() = default;
...
#endif // !TENCENTCLOUD_DAYU_V20180709_MODEL_DESCRIBEDDOSEVINFORESPONSE_H_
