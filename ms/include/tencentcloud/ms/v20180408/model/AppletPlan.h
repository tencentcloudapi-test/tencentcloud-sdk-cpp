...
#ifndef TENCENTCLOUD_MS_V20180408_MODEL_APPLETPLAN_H_
#define TENCENTCLOUD_MS_V20180408_MODEL_APPLETPLAN_H_
    ...
    namespace Ms
    {
        namespace V20180408
        {
            namespace Model
            {
                ...
                * 小程序加固配置
                */
                class AppletPlan : public AbstractModel
                {
                public:
                    AppletPlan();
...
#endif // !TENCENTCLOUD_MS_V20180408_MODEL_APPLETPLAN_H_
