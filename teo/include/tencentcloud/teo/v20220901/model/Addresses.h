...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_ADDRESSES_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_ADDRESSES_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                * IP 网段详情。
                */
                class Addresses : public AbstractModel
                {
                public:
                    Addresses();
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_ADDRESSES_H_
