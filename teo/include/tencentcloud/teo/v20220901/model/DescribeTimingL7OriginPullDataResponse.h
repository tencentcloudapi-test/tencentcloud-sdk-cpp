...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBETIMINGL7ORIGINPULLDATARESPONSE_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBETIMINGL7ORIGINPULLDATARESPONSE_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class DescribeTimingL7OriginPullDataResponse : public AbstractModel
                {
                public:
                    DescribeTimingL7OriginPullDataResponse();
                    ~DescribeTimingL7OriginPullDataResponse() = default;
                    ...
                    /**
                     * 获取回源时序数据列表。
                     * @return TimingDataRecords 回源时序数据列表。
                     * 
                     */
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBETIMINGL7ORIGINPULLDATARESPONSE_H_
