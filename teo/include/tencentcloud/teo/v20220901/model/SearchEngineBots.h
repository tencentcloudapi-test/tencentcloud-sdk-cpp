...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_SEARCHENGINEBOTS_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_SEARCHENGINEBOTS_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                * 搜索引擎规则配置。
                */
                class SearchEngineBots : public AbstractModel
                {
                public:
                    SearchEngineBots();
                    ...
                    /**
                     * 获取来自搜索引擎爬虫的请求的执行动作。 SecurityAction 的 Name 取值支持：<li>Deny：拦截；</li><li>Monitor：观察；</li><li>Disabled：未启用，不启用指定规则；</li><li>Challenge：挑战，其中 ChallengeActionParameters 中的 ChallengeOption 支持 JSChallenge 和 ManagedChallenge；</li><li>Allow：放行（待废弃）。</li> 
                    ...
                    /**
                     * 设置来自搜索引擎爬虫的请求的执行动作。 SecurityAction 的 Name 取值支持：<li>Deny：拦截；</li><li>Monitor：观察；</li><li>Disabled：未启用，不启用指定规则；</li><li>Challenge：挑战，其中 ChallengeActionParameters 中的 ChallengeOption 支持 JSChallenge 和 ManagedChallenge；</li><li>Allow：放行（待废弃）。</li> 
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_SEARCHENGINEBOTS_H_
