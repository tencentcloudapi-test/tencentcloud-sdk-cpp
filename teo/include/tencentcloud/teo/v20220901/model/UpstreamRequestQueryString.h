...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_UPSTREAMREQUESTQUERYSTRING_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_UPSTREAMREQUESTQUERYSTRING_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                * 回源请求参数查询字符串配置。
                */
                class UpstreamRequestQueryString : public AbstractModel
                {
                public:
...
<li>off：关闭。</li>
                    ...
                    /**
                     * 获取查询字符串模式。当 Switch 为 on 时，该参数必填。取值有：
<li>full：全部保留；</li>
<li>ignore：全部忽略；</li>
...
<li>excludeCustom：忽略部分参数。</li>
                    ...
                    /**
                     * 设置查询字符串模式。当 Switch 为 on 时，该参数必填。取值有：
<li>full：全部保留；</li>
<li>ignore：全部忽略；</li>
<li>includeCustom：保留部分参数；</li>
<li>excludeCustom：忽略部分参数。</li>
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_UPSTREAMREQUESTQUERYSTRING_H_
