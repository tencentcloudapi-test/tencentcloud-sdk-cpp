...
#ifndef TENCENTCLOUD_SES_V20201002_MODEL_CREATEADDRESSUNSUBSCRIBECONFIGREQUEST_H_
#define TENCENTCLOUD_SES_V20201002_MODEL_CREATEADDRESSUNSUBSCRIBECONFIGREQUEST_H_
    ...
    namespace Ses
    {
        namespace V20201002
        {
            namespace Model
            {
                ...
                */
                class CreateAddressUnsubscribeConfigRequest : public AbstractModel
                {
                public:
                    CreateAddressUnsubscribeConfigRequest();
                    ~CreateAddressUnsubscribeConfigRequest() = default;
...
#endif // !TENCENTCLOUD_SES_V20201002_MODEL_CREATEADDRESSUNSUBSCRIBECONFIGREQUEST_H_
