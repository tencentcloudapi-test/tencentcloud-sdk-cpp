...
#ifndef TENCENTCLOUD_SES_V20201002_MODEL_CREATERECEIVERDETAILRESPONSE_H_
#define TENCENTCLOUD_SES_V20201002_MODEL_CREATERECEIVERDETAILRESPONSE_H_
    ...
    namespace Ses
    {
        namespace V20201002
        {
            namespace Model
            {
                ...
                */
                class CreateReceiverDetailResponse : public AbstractModel
                {
                public:
                    CreateReceiverDetailResponse();
                    ~CreateReceiverDetailResponse() = default;
...
#endif // !TENCENTCLOUD_SES_V20201002_MODEL_CREATERECEIVERDETAILRESPONSE_H_
