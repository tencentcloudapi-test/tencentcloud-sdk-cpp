...
#ifndef TENCENTCLOUD_IOTCLOUD_V20210408_MODEL_LISTSDKLOGRESPONSE_H_
#define TENCENTCLOUD_IOTCLOUD_V20210408_MODEL_LISTSDKLOGRESPONSE_H_
    ...
    namespace Iotcloud
    {
        namespace V20210408
        {
            namespace Model
            {
                ...
                * ListSDKLog返回参数结构体
                */
                class ListSDKLogResponse : public AbstractModel
                {
                public:
                    ListSDKLogResponse();
                    ~ListSDKLogResponse() = default;
...
#endif // !TENCENTCLOUD_IOTCLOUD_V20210408_MODEL_LISTSDKLOGRESPONSE_H_
