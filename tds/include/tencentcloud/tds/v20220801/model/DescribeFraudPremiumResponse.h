...
#ifndef TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBEFRAUDPREMIUMRESPONSE_H_
#define TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBEFRAUDPREMIUMRESPONSE_H_
    ...
    namespace Tds
    {
        namespace V20220801
        {
            namespace Model
            {
                ...
                */
                class DescribeFraudPremiumResponse : public AbstractModel
                {
                public:
                    DescribeFraudPremiumResponse();
                    ~DescribeFraudPremiumResponse() = default;
...
#endif // !TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBEFRAUDPREMIUMRESPONSE_H_
