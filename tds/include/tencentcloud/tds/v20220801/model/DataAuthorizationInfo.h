...
#ifndef TENCENTCLOUD_TDS_V20220801_MODEL_DATAAUTHORIZATIONINFO_H_
#define TENCENTCLOUD_TDS_V20220801_MODEL_DATAAUTHORIZATIONINFO_H_
...
固定填：腾讯云计算（北京）有限责任公司
                    ...
                    /**
                     * 获取客户请求所涉及的用户个人信息类型，支持多选。实际以接口请求传参为准。
1-手机号；
2-微信开放账号；
3-QQ开放账号；
4-IP地址；
...
4-IP地址；
                    ...
                    /**
                     * 设置客户请求所涉及的用户个人信息类型，支持多选。实际以接口请求传参为准。
1-手机号；
2-微信开放账号；
3-QQ开放账号；
4-IP地址；
...
4-IP地址；
                    ...
                    /**
                     * 获取客户是否已按合规指南要求获取用户授权，同意客户委托腾讯云处理入参信息，结合已合法收集的用户数据进行必要处理得出服务结果，并返回给客户。
...
1-已授权；其它值为未授权。
                    ...
                    /**
                     * 设置客户是否已按合规指南要求获取用户授权，同意客户委托腾讯云处理入参信息，结合已合法收集的用户数据进行必要处理得出服务结果，并返回给客户。
...
#endif // !TENCENTCLOUD_TDS_V20220801_MODEL_DATAAUTHORIZATIONINFO_H_
