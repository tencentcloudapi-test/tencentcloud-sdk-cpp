...
#ifndef TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBEFRAUDBASEREQUEST_H_
#define TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBEFRAUDBASEREQUEST_H_
    ...
    namespace Tds
    {
        namespace V20220801
        {
            namespace Model
            {
                ...
                */
                class DescribeFraudBaseRequest : public AbstractModel
                {
                public:
                    DescribeFraudBaseRequest();
                    ~DescribeFraudBaseRequest() = default;
...
#endif // !TENCENTCLOUD_TDS_V20220801_MODEL_DESCRIBEFRAUDBASEREQUEST_H_
